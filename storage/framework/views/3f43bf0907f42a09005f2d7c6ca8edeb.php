...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4 relative overflow-hidden">
        ...
        <div class="flex items-center gap-4 relative z-10 w-full md:w-auto">
            ...
            <div class="h-14 w-14 flex-shrink-0 bg-white rounded-lg border border-indigo-100 shadow-sm flex items-center justify-center overflow-hidden p-1 group transition-transform hover:scale-105">
                <?php if($activeCustomer && $activeCustomer->logo_path): ?>
                    <img src="<?php echo e(asset('storage/' . $activeCustomer->logo_path)); ?>" 
                         alt="<?php echo e($activeCustomer->name); ?>" 
            ...
            <div class="flex flex-col">
                ...
                ?>
                <h2 class="text-lg font-bold text-gray-900 leading-tight">Sn. <?php echo e($user->name); ?> <span class="text-xs text-indigo-600/70 font-medium">(<?php echo e($activeTitle ?? 'Yetkili'); ?>)</span></h2>
                
                <?php if($activeCustomer): ?>
                    <div class="flex flex-wrap items-center gap-1 sm:gap-2 mt-0.5">
                        <span class="text-indigo-700 font-bold text-xs"><?php echo e($activeCustomer->name); ?></span>
                ...
                <div class="flex items-center mt-1 text-[10px] text-gray-400">
                    ...
                    Son Giriş: <?php echo e($user->last_seen_at ? \Carbon\Carbon::parse($user->last_seen_at)->format('d.m.Y H:i') : 'İlk Giriş'); ?>
            ...
            <a href="<?php echo e(route('iaa.hatirlatmalarim.index')); ?>" class="flex-1 md:flex-none justify-center px-4 py-2 bg-white border border-gray-200 hover:border-red-300 hover:bg-red-50 text-gray-700 hover:text-red-700 text-xs font-bold rounded-lg transition-all shadow-sm hover:shadow flex items-center gap-2 transform hover:-translate-y-0.5 relative">
                ...
                <?php if($pendingRemindersCount > 0): ?>
                    <span class="absolute -top-1.5 -right-1.5 flex h-4 w-4">
                        ...
                        <span class="relative inline-flex rounded-full h-4 w-4 bg-red-600 text-[9px] text-white items-center justify-center font-black"><?php echo e($pendingRemindersCount); ?></span>
                    </span>
                <?php endif; ?>
            </a>

            <?php if($activeCustomer): ?>
                <a href="<?php echo e(route('musteri.profil.show', $activeCustomer->id)); ?>" class="flex-1 md:flex-none justify-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-lg transition-all shadow-sm hover:shadow flex items-center gap-2 transform hover:-translate-y-0.5">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                    Firma Profili
                </a>
            <?php endif; ?>
            
            <a href="<?php echo e(route('iaa.sikayetler.create', ['musteri_id' => $activeCustomer ? $activeCustomer->id : null])); ?>" 
    ...
    <?php if(isset($userCustomers) && $userCustomers->count() > 1): ?>
        <div class="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl p-4 border border-indigo-100 shadow-sm animate-fade-in">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div class="flex flex-wrap gap-2">
                    <?php $__currentLoopData = $userCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($customer->id == $activeCustomerId): ?>
                        ...
                        <?php else: ?>
                            <form action="<?php echo e(route('dashboard.switch-customer')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
    ...
    <form method="GET" action="<?php echo e(route('dashboard')); ?>" class="bg-white rounded-xl p-3 shadow-sm border border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-2 w-full sm:w-auto">
            ...
            <?php if(request('start_date') || request('end_date')): ?>
                <a href="<?php echo e(route('dashboard')); ?>" class="px-4 py-2 bg-red-50 text-red-600 hover:bg-red-100 font-bold text-xs rounded-lg transition-colors border border-red-100 flex items-center gap-1 shadow-sm">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div class="bg-white p-3.5 rounded-xl shadow-sm border border-gray-200 relative overflow-hidden group hover:shadow-md transition-shadow">
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-2xl font-black text-gray-800 mt-0.5"><?php echo e($stats['toplam_sikayet'] ?? 0); ?></h3>
                    </div>
            ...
            <div class="bg-white p-3.5 rounded-xl shadow-sm border border-gray-200 relative overflow-hidden group hover:shadow-md transition-shadow">
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-2xl font-black text-gray-800 mt-0.5"><?php echo e($stats['aktif_sikayet'] ?? 0); ?></h3>
            ...
            <div class="bg-white p-3.5 rounded-xl shadow-sm border border-gray-200 relative overflow-hidden group hover:shadow-md transition-shadow">
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-2xl font-black text-gray-800 mt-0.5"><?php echo e($stats['cozulen_sikayet'] ?? 0); ?></h3>
                    </div>
            ...
            <div class="bg-white p-3.5 rounded-xl shadow-sm border border-gray-200 relative overflow-hidden group hover:shadow-md transition-shadow">
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-2xl font-black text-gray-800 mt-0.5"><?php echo e($stats['ortalama_sure'] ?? 0); ?> <span class="text-xs font-normal text-gray-400">Gün</span></h3>
                    </div>
        ...
        <div class="flex flex-col gap-3">
            ...
            <?php if($yillikIstatistikler->isNotEmpty()): ?>
                <div class="bg-white p-3 rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php $__currentLoopData = $yillikIstatistikler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between px-2 py-1.5 bg-gray-50 rounded-lg border border-gray-100 flex-1 min-w-[70px]">
                                <span class="text-[10px] font-bold text-gray-600"><?php echo e($stat->yil); ?></span>
                                <span class="text-xs font-black text-indigo-600"><?php echo e($stat->toplam); ?></span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
    ...
    <?php if($digerYetkililer->isNotEmpty()): ?>
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                <?php $__currentLoopData = $digerYetkililer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yetkili): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-start gap-3 p-2.5 rounded-lg border border-gray-100 bg-gray-50/50 hover:bg-white hover:shadow-sm hover:border-indigo-100 transition-all">
                        <div class="h-8 w-8 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-700 text-sm font-bold flex-shrink-0">
                            <?php echo e(substr($yetkili->name, 0, 1)); ?>

                        </div>
                        <div class="overflow-hidden">
                            <h4 class="text-xs font-bold text-gray-900 truncate" title="<?php echo e($yetkili->name); ?>"><?php echo e($yetkili->name); ?></h4>
                            <p class="text-[10px] text-gray-500 truncate"><?php echo e($yetkili->unvan ?? 'Yetkili'); ?></p>
                            <div class="mt-0.5 flex flex-col gap-0.5">
                                <a href="mailto:<?php echo e($yetkili->email); ?>" class="text-[9px] text-indigo-600 hover:underline truncate"><?php echo e($yetkili->email); ?></a>
                                <?php if($yetkili->telefon): ?>
                                    <span class="text-[9px] text-gray-400"><?php echo e($yetkili->telefon); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-2 bg-amber-50 px-4 py-2 rounded-lg border-2 border-amber-400 shadow-md relative overflow-hidden">
                        ...
                        <div class="relative z-10 flex flex-col">
                            ...
                            <span class="text-[10px] font-bold text-amber-700">
                                Sadece <span class="bg-amber-200 px-1 rounded text-amber-900"><?php echo e(request('start_date') ? \Carbon\Carbon::parse(request('start_date'))->format('d.m.Y') : 'Başlangıç'); ?> - <?php echo e(request('end_date') ? \Carbon\Carbon::parse(request('end_date'))->format('d.m.Y') : 'Günümüz'); ?></span> aralığındaki kayıtlar listeleniyor.
                            </span>
                        </div>
                    </div>
                <?php endif; ?>
                        ...
                        <?php $__currentLoopData = $stats['son_sikayetler']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sikayet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition-colors group">
                                ...
                                <td class="px-5 py-3 whitespace-nowrap">
                                    ...
                                    <div class="flex flex-col">
                                        <span class="text-xs font-bold text-gray-900"><?php echo e($creatorName); ?></span>
                                        <span class="text-[9px] <?php echo e($creatorColorClass); ?>"><?php echo e($creatorTitle); ?></span>
                                    </div>
                                </td>

                                
                                <td class="px-5 py-3">
                                    <div class="text-xs font-bold text-gray-900 line-clamp-1 max-w-[120px]" title="<?php echo e($sikayet->musteri_sikayet_konusu); ?>">
                                        <?php echo e(Str::limit($sikayet->musteri_sikayet_konusu, 40)); ?>

                                    </div>
                                    <div class="flex flex-wrap items-center gap-2 mt-1">
                                        <div class="text-[10px] text-gray-500"><?php echo e($sikayet->sikayetKategori->ad ?? 'Genel'); ?></div>
                                    ...
                                    <?php if($sikayet->iaaProjesi): ?>
                                        <div class="mt-2 w-full max-w-[120px]">
                                            <?php $ilerleme = $sikayet->iaaProjesi->ilerlemeVerisi; ?>
                                            <div class="flex justify-between items-center mb-1">
                                                <span class="text-[9px] font-bold text-gray-500 uppercase"><?php echo e($ilerleme['tamamlanan']); ?>/<?php echo e($ilerleme['toplam']); ?> Adım</span>
                                                <span class="text-[9px] font-black text-indigo-600">%<?php echo e($ilerleme['yuzde']); ?></span>
                                            </div>
                                            <div class="w-full bg-gray-100 rounded-full h-1 overflow-hidden border border-gray-200">
                                                <div class="bg-indigo-500 h-full transition-all duration-500" style="width: <?php echo e($ilerleme['yuzde']); ?>%"></div>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </td>
                                    ...
                                    <div class="flex flex-col items-center gap-1">
                                        ...
                                        <?php if($sikayet->iaaProjesi): ?>
                                            <?php
                                                ...
                                                // Eğer musteri_durum zaten proje durumuyla aynıysa mükerrerlik yapma
                                                $isSameStatus = ($sikayet->musteri_durum === $pDurum);
                                                
                                                // Sadece farklıysa ve bir onay sürecindeyse ek bilgi olarak göster
                                                $isApprovalPhase = in_array($pDurum, ['Bölüm Onayı Bekliyor', 'Direktör Onayı Bekliyor', 'Yönetici Onayı Bekliyor']);
                                            ?>
                                            
                                            <?php if(!$isSameStatus && $isApprovalPhase): ?>
                                                <?php
                                                    $bgClass = "bg-{$pRenk}-50";
                                                ...
                                                ?>
                                                <div class="text-[9px] font-bold <?php echo e($textClass); ?> animate-pulse flex items-center justify-center gap-1 <?php echo e($bgClass); ?> px-1.5 py-0.5 rounded border <?php echo e($borderClass); ?>">
                                                    <?php echo e($pDurum === 'Bölüm Onayı Bekliyor' ? 'Bölüm Kalite Yöneticisi Onayı Bekliyor' : $pDurum); ?>
                                ...
                                <td class="px-5 py-3 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex flex-col items-end gap-1.5" x-data="{ openReminderModal: false }">
                                        <div class="flex items-center justify-end gap-1.5">
                                            <?php if($sikayet->iaaProjesi): ?>
                                                <a href="<?php echo e(route('proje.workspace.show', $sikayet->iaaProjesi->id)); ?>" target="_blank" class="text-indigo-600 hover:text-indigo-900 bg-indigo-50 hover:bg-indigo-100 p-1.5 rounded-lg transition-colors border border-indigo-200" title="Proje Alanı">
                                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                                                </a>
                                            <?php endif; ?>
                                            <a href="<?php echo e(route('iaa.sikayetler.show', $sikayet->id)); ?>" class="text-gray-600 hover:text-gray-900 bg-gray-50 hover:bg-gray-100 px-3 py-1 rounded-lg transition-colors text-[10px] font-bold border border-gray-200">
                                                Detay
                                            </a>
                                        </div>

                                        
                                        <?php if(in_array($sikayet->musteri_durum, ['Yeni', 'İşlemde', 'Atandı', 'İnceleniyor', 'Devam Ediyor', 'Bölüm Onayı Bekliyor', 'Direktör Onayı Bekliyor', 'Yönetici Onayı Bekliyor'])): ?>
                                            <?php $hDurum = $sikayet->musteri_hatirlatma_durumu; ?>
                                                ...
                                                <template x-teleport="body">
                                                    <div x-show="openReminderModal" x-cloak class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm animate-fade-in" @keydown.escape.window="openReminderModal = false">
                                                        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden border border-gray-100 transform transition-all scale-100" @click.away="openReminderModal = false">
                                                            ...
                                                            <form action="<?php echo e(route('iaa.hatirlatmalarim.dashboardGonder', $sikayet->id)); ?>" method="POST" class="p-6">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="mb-4">
                                            ...
                                            <?php else: ?>
                                                ...
                                                <?php if($reminderId): ?>
                                                    ...
                                                    ?>
                                                    <a href="<?php echo e(route($targetRoute, $reminderId)); ?>" class="text-amber-700 bg-amber-50 hover:bg-amber-100 px-3 py-1 rounded-lg text-[10px] font-black border border-amber-200 flex items-center gap-1 w-full justify-center transition-all animate-pulse" title="Detayı görmek için tıklayın (Henüz yeni hatırlatma gönderilemez)">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const bekleyen = <?php echo e(($stats['toplam_sikayet'] ?? 0) - ($stats['aktif_sikayet'] ?? 0) - ($stats['cozulen_sikayet'] ?? 0)); ?>;
        const islemde = <?php echo e($stats['aktif_sikayet'] ?? 0); ?>;
        const cozulen = <?php echo e($stats['cozulen_sikayet'] ?? 0); ?>;
...
</script><?php /**PATH /var/www/kys_koksan/iaa/resources/views/dashboard/partials/musteri.blade.php ENDPATH**/ ?>