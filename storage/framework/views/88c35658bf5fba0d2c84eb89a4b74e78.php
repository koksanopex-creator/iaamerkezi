    ...
    <div class="card">
        ...
        <div class="steps">
            ...
            <div class="step pending">
                ...
                <span class="sname">Sistem testleri</span>
                <span class="sbadge">Bekliyor</span>
            </div>
        </div>

        
        <div style="margin-top: 1.5rem; padding-top: 1.5rem; border-top: 1px solid var(--border); text-align: left;">
            <p style="font-size: 11px; font-weight: 700; color: var(--muted); text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 0.75rem;">Destek ve İletişim</p>
            <div style="display: flex; align-items: center; gap: 12px; background: var(--faint); padding: 12px; border-radius: 12px; border: 1px solid var(--border);">
                <?php if(isset($sistemAdmin) && $sistemAdmin): ?>
                    <img src="<?php echo e($sistemAdmin->profile_photo_url); ?>" style="width: 44px; height: 44px; border-radius: 10px; object-fit: cover; border: 1px solid var(--border);" alt="Celal KARAMAN">
                <?php else: ?>
                    <div style="width: 44px; height: 44px; background: var(--blue); border-radius: 10px; display: flex; align-items: center; justify-content: center; color: white; flex-shrink: 0;">
                ...
                <?php endif; ?>
                <div>
                    <p style="font-size: 13px; font-weight: 700; color: var(--ink); display: flex; align-items: center; gap: 6px; margin: 0;">
                        Celal KARAMAN
                        <svg style="width: 12px; height: 12px; color: #fbbf24; fill: currentColor;" viewBox="0 0 20 20">
                    ...
                    <div style="margin-top: 2px; display: flex; flex-direction: column; gap: 1px;">
                        <span style="font-size: 11px; color: var(--muted);">celal.karaman@koksan.com</span>
                        <span style="font-size: 11px; color: var(--muted);">Tel: <?php echo e((isset($sistemAdmin) && $sistemAdmin) ? ($sistemAdmin->telefon ?: '-') : '-'); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="foot">
            <span class="foot-copy">&copy; <?php echo e(date('Y')); ?> Köksan Pet ve Plastik Ambalaj</span>
...
</html><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/errors/503.blade.php ENDPATH**/ ?>