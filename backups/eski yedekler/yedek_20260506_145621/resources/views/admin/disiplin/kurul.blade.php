<x-app-layout>
    ...
    <div class="py-6 space-y-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" x-data="{ 
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <!-- Kurul Üyesi Sayısı -->
            <div class="relative group overflow-hidden bg-white rounded-[2.5rem] border border-white p-6 shadow-xl transition-all hover:-translate-y-2 hover:shadow-indigo-500/20">
            ...
            <!-- Toplam Toplantı -->
            <div class="relative group overflow-hidden bg-white rounded-[2.5rem] border border-white p-6 shadow-xl transition-all hover:-translate-y-2 hover:shadow-emerald-500/20">
            ...
            <!-- Bekleyen Gündem -->
            <div @click="document.getElementById('kurul-gundemi').scrollIntoView({ behavior: 'smooth', block: 'start' })" 
            ...
            <!-- Planlanan Toplantı -->
            <div class="relative group overflow-hidden bg-white rounded-[2.5rem] border border-white p-6 shadow-xl transition-all hover:-translate-y-2 hover:shadow-sky-500/20">
            ...
            <!-- Ortalama Katılım -->
            <div class="relative group overflow-hidden bg-white rounded-[2.5rem] border border-white p-6 shadow-xl transition-all hover:-translate-y-2 hover:shadow-amber-500/20">
            ...
            <!-- Karar Sayısı -->
            <div class="relative group overflow-hidden bg-white rounded-[2.5rem] border border-white p-6 shadow-xl transition-all hover:-translate-y-2 hover:shadow-purple-500/20">
        ...
        <!-- TAB NAVİGASYONU -->
        <div class="flex items-center gap-2 border-b border-gray-100 p-1.5 bg-white/40 backdrop-blur-md rounded-[1.5rem] w-fit shadow-lg shadow-indigo-500/5 ring-1 ring-black/5">
        ...
        <div class="min-h-[600px]">
                                ...
                                <div class="bg-white p-4 rounded-3xl border border-gray-100 shadow-xl shadow-gray-500/5 hover:border-purple-200 transition-colors relative overflow-hidden group">
                                    <div class="flex items-center gap-4 relative z-10">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <h6 class="text-sm font-black text-gray-800 truncate">{{ $karar->user->name }}</h6>
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div class="bg-gray-50/50 p-4 rounded-3xl border border-gray-100 grid grid-cols-3 gap-2 ring-1 ring-black/5">
                                    <div class="text-center group-hover:scale-110 transition-transform">
                                        ...
                                        <p class="text-[8px] text-gray-400 uppercase font-black tracking-tighter mt-1">Lehte Oy</p>
                                    </div>
                                    <div class="text-center border-x border-gray-200 group-hover:scale-110 transition-transform">
                                        ...
                                        <p class="text-[8px] text-gray-400 uppercase font-black tracking-tighter mt-1">Aleyhte Oy</p>
                                    </div>
                                    <div class="text-center group-hover:scale-110 transition-transform">
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="bg-gray-50/50 border-b border-gray-100">
                                    ...
                                    <th class="px-6 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest">Performans (L/A/Ç)</th>
                                    ...
                                    <tr class="hover:bg-indigo-50/30 transition-colors group">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-2">
                                                <span class="px-2 py-0.5 bg-emerald-50 text-emerald-600 rounded text-[10px] font-black" title="Lehte">{{ $stat['leh_oy'] }}</span>
                                                <span class="px-2 py-0.5 bg-rose-50 text-rose-600 rounded text-[10px] font-black" title="Aleyhte">{{ $stat['aleyh_oy'] }}</span>
            ...
            <div x-show="activeTab === 'meetings'" x-transition:enter="transition ease-out duration-500" x-transition:enter-start="opacity-0 translate-y-8" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-8">
                ...
                <div class="bg-white/60 backdrop-blur-xl rounded-[2.5rem] border border-white/50 overflow-hidden shadow-2xl shadow-indigo-500/5 ring-1 ring-black/[0.02] overflow-hidden">
                                    ...
                                    <tr class="hover:bg-indigo-50/20 transition-all group">
                                        ...
                                        <td class="px-8 py-6">
                                            <div class="flex items-center justify-end gap-2">
                                                ...
                                                <a href="{{ route('admin.disiplin.kurul.toplanti.show', $t) }}" class="inline-flex items-center justify-center w-8 h-8 rounded-xl bg-indigo-50 text-indigo-600 hover:bg-black hover:text-white transition-all">
                                ...
                                <tr class="hover:bg-amber-50/10 transition-colors">
                                    <td class="px-8 py-6">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div class="font-black text-gray-800">{{ $gecmis->user->name }}</div>
                                    ...
                                    <td class="px-8 py-6">
                                        <div class="text-xs font-mono font-black space-y-1">
                                            <div class="text-emerald-500 flex items-center gap-1.5"><span class="w-1.5 h-1.5 bg-emerald-500 rounded-full animate-pulse"></span> {{ $gecmis->katilim_tarihi->format('d.m.Y') }}</div>
                                            @if($gecmis->aktif)
                                                <div class="text-indigo-400 text-[9px] uppercase tracking-widest">Hizmet Veriyor</div>
                                            @else
                                                <div class="text-rose-400 flex items-center gap-1.5"><span class="w-1.5 h-1.5 bg-rose-400 rounded-full"></span> {{ $gecmis->ayrilma_tarihi ? $gecmis->ayrilma_tarihi->format('d.m.Y') : 'Bilinmiyor' }}</div>
                                            @endif
                                        </div>
                                    </td>
                                    <td class="px-8 py-6">
