...
<x-app-layout>
                    ...
                    @else
                        ...
                        @php
                            $dashboardTitles = [
                                ...
                                'kurul' => 'Şikayet Kurulu Paneli',
                                'cozum_lideri' => 'Şikayet Çözüm Lideri Paneli',
                    ...
                    @else
                        @php
                            $dashboardSubtitles = [
                                ...
                                'kurul' => 'Şikayet kurulu genel istatistikleri ve personel puanları',
    ...
    {{-- ŞİFRE DEĞİŞTİRME UYARISI (Banner) --}}
            ...
            <div class="relative bg-gradient-to-r from-indigo-600 via-indigo-700 to-purple-700 rounded-2xl shadow-xl overflow-hidden group transition-all duration-300 hover:shadow-indigo-200/50">
                ...
                <div class="relative px-6 py-8 sm:px-10 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            <h3 class="text-xl font-black text-white leading-tight">Şifrenizi Güncelleyerek Başlayın!</h3>
    ...
    @if(Auth::user()->require_password_change)
        <div class="fixed top-24 right-6 z-[60] animate-bounce">
            <a href="{{ route('profile.edit') }}" class="flex items-center gap-2 bg-white dark:bg-gray-800 p-2 pr-4 rounded-full shadow-2xl border border-red-100 hover:border-red-500 transition-all group overflow-hidden">
                ...
                <div class="text-xs">
                    <p class="font-bold text-red-600">Şifre Uyarısı</p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if(!(isset($is_musteri_dashboard) && $is_musteri_dashboard))
                @php
                    ...
                    if ($user->hasRole('Müşteri Şikayeti Kurulu')) $availableDashboards['kurul'] = 'Şikayet Kurulu';
                    if ($user->hasRole('Müşteri Şikayeti Çözüm Lideri')) $availableDashboards['cozum_lideri'] = 'Çözüm Lideri';
            ...
            @else
                ...
                @if(isset($stats))
                            ...
                            <div class="bg-gradient-to-r from-purple-600 to-indigo-700 rounded-2xl p-6 text-white shadow-xl relative overflow-hidden">
                                ...
                                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                                    <div>
                                        ...
                                        <p class="text-purple-100 mt-1">Sorumlu olduğunuz şikayet süreçlerini ve bireysel performansınızı buradan yönetebilirsiniz.</p>
                                    </div>
                                    <div class="flex items-center gap-4">
                                        <div class="text-center px-4 py-2 bg-white/20 backdrop-blur-md rounded-xl">
                                            <p class="text-[10px] font-black uppercase tracking-widest opacity-70">Toplam Şikayet</p>
                                            <p class="text-xl font-bold">{{ $stats['toplam_sikayet_sayisi'] ?? 0 }}</p>
                                        </div>
                                        <div class="text-center px-4 py-2 bg-white/20 backdrop-blur-md rounded-xl">
                                            <p class="text-[10px] font-black uppercase tracking-widest opacity-70">Onay Bekleyen</p>
                                            <p class="text-xl font-bold">{{ count($stats['onay_bekleyen_sikayetler'] ?? []) }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    @elseif($activeDashboard === 'bolum_lideri')
