...
Route::prefix('admin')->name('admin.')->middleware(['auth'])->group(function ()
{
    ...
    Route::middleware(['role:Superadmin|Yonetim|Müşteri Şikayeti Kurulu|Müşteri Temsilcisi|Müşteri Şikayeti Çözüm Lideri|Bölüm Kalite Yöneticisi|Direktör|Bölüm Lideri'])->group(function() {
