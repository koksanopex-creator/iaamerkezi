...
>
    <!--[if BLOCK]><![endif]--><?php if($servers->isNotEmpty()): ?>
        <div class="grid grid-cols-[max-content,minmax(max-content,1fr),max-content,minmax(min-content,2fr),max-content,minmax(min-content,2fr),minmax(max-content,1fr)]">
            <div></div>
            <div></div>
            <div class="text-xs uppercase text-left text-gray-500 dark:text-gray-400 font-bold">İşlemci (CPU)</div>
            <div></div>
            <div class="text-xs uppercase text-left text-gray-500 dark:text-gray-400 font-bold">Bellek (Memory)</div>
            <div></div>
            <div class="text-xs uppercase text-left text-gray-500 dark:text-gray-400 font-bold">Depolama (Storage)</div>
...
Alpine.data('storageChart', (config) => ({
    ...
    ?>
<?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/vendor/pulse/livewire/servers.blade.php ENDPATH**/ ?>