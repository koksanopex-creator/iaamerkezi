        ...
        <div class="bg-white/90 backdrop-blur-xl border border-white shadow-2xl rounded-[2.5rem] overflow-hidden flex flex-col md:flex-row transform transition-all duration-500 hover:shadow-indigo-500/10">
            ...
            <div class="md:w-7/12 p-10 sm:p-14 lg:p-16 flex flex-col justify-center bg-white">
                ...
                <div class="mb-10">
                    ...
                    <h3 class="text-3xl font-extrabold text-slate-800 mb-4">Merhaba, <span class="text-indigo-600"><?php echo e($centralUser['first_name']); ?>!</span> 👋</h3>
                ...
                <form action="<?php echo e(route('sso.basvuru_kaydet')); ?>" method="POST" class="space-y-8">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="relative group">
                        ...
                        <div x-data="{
                            ...
                            bolumler: [
                                ...
                                ?>
                                {
                                    id: '<?php echo e($bolum->id); ?>',
                                    name: '<?php echo e(addslashes($bolum->ad)); ?>',
                                    leader: '<?php echo e(addslashes($leaderNames)); ?>'
                                },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/kys_koksan/iaa/resources/views/auth/sso_basvuru.blade.php ENDPATH**/ ?>