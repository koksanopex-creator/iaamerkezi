            ...
            <div class="bg-white overflow-hidden shadow-2xl rounded-xl sm:rounded-2xl">
                ...
                <div class="p-4 sm:p-8">
                    ...
                    <form action="{{ route('admin.sikayetler.update', $sikayet) }}" method="POST" enctype="multipart/form-data" x-data="fileUploadComponent()">
                        ...
                        {{-- KRİTİK DÜZELTME: md:grid-cols-2 yerine lg:grid-cols-2 kullanıldı. 
                             Mobilde ve Tablette TEK SÜTUN, sadece büyük ekranda ÇİFT SÜTUN olacak --}}
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            {{-- Kategori Sistemi --}}
                            <div class="lg:col-span-2 grid grid-cols-1 lg:grid-cols-2 gap-6" x-data="categorySystem()" x-init="init()">
                                {{-- Ana Kategori --}}
                                <div class="group flex flex-col">
    ...
    <script>
        ...
        function categorySystem() {
            return {
                ...
                selectedSubCategory: '{{ old('sikayet_alt_kategori_id', ($sikayet->sikayet_alt_kategori_diger ?? null) ? "other" : ($sikayet->sikayet_alt_kategori_id ?? '')) }}',
