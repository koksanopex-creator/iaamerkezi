...
class Iaa extends Model
{
    ...
    public function getDurumEtiketiAttribute()
    {
        $durumlar = [
            ...
            'Bölüm Onayı Bekliyor' => ['text' => $this->musteriSikayeti ? 'Bölüm Kalite Yöneticisi Onayı Bekliyor' : 'Final Onay Bekliyor', 'class' => 'bg-purple-100 text-purple-800 border-purple-200'],
            ...
            'Onay Bekliyor' => ['text' => $this->musteriSikayeti ? 'Bölüm Kalite Yöneticisi Onayı Bekliyor' : 'Final Onay Bekliyor', 'class' => 'bg-purple-100 text-purple-800 border-purple-200'],
