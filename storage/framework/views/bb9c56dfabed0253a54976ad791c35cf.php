<section class="relative overflow-hidden">
    <header class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__('Merkezi kimlik doğrulama sistemi (SSO) aktif olduğu için şifre güncellemelerinizi tek bir noktadan güvenle yapabilirsiniz.')); ?>
