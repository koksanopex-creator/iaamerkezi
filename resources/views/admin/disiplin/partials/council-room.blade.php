{{-- 
    ...
    Sadece 'Kurulda' değil, 'Karar Verildi' durumunda da görünecek.
    Böylece geçmişe dönük kayıt (log) olarak kalacak.
--}}
@if(in_array($case->durum, ['Kurulda', 'Karar Verildi']) && Auth::user()->hasRole(['Superadmin', 'Hukuk Yöneticisi', 'Hukuk Admini', 'Disiplin Kurulu Başkanı', 'Disiplin Kurulu Üyesi']))
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div class="lg:col-span-5 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 min-h-[400px]">
                    ...
                    @if(Auth::user()->hasRole(['Superadmin', 'Disiplin Kurulu Başkanı', 'Hukuk Yöneticisi']) && $votesUsed > 0 && $case->durum == 'Kurulda')
