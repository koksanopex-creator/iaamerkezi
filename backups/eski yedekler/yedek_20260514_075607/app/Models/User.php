...
class User extends Authenticatable implements MustVerifyEmail // <-- Interface Implemente Edildi
{
    ...
    public function getAllowedBolumIds()
    {
        ...
        if ($user->traitHasRole(['Superadmin', 'Yonetim', 'Müşteri Şikayeti Kurulu']))
        {
            return '*';
        }
    ...
    // === SHADOWING (GÖZLEMCİ MODU) MANTIĞI ===
    ...
    /**
     * Role Intelligence: Kullanıcının Müşteri Şikayeti modülüyle "Organik Bağı" var mı?
    ...
    public function canSeeMusteriOperasyonlari(): bool
    {
        ...
        if ($user->hasAnyRole(['Superadmin', 'Yonetim', 'Müşteri Şikayeti Kurulu', 'Bölüm Kalite Yöneticisi', 'Müşteri Şikayeti Çözüm Lideri'])) {
            return true;
        }
        ...
        // Bölüm Lider Yardımcısı: Şikayet veya İade görme yetkisi varsa ve bölümü kategoriye bağlıysa
