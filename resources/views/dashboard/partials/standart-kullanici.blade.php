<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-8">
    ...
    <a href="{{ route('takimlar.index') }}" class="group relative bg-gradient-to-br from-purple-50 to-violet-50 border border-purple-100 rounded-2xl p-6 hover:shadow-2xl hover:scale-105 transition-all duration-300 overflow-hidden">
    ...
    @if(isset($stats['iaa_projelerim_count']))
        <a href="{{ route('iaa.takimProjeleri') }}" class="group relative bg-gradient-to-br from-yellow-50 to-orange-50 border border-yellow-100 rounded-2xl p-6 hover:shadow-2xl hover:scale-105 transition-all duration-300 overflow-hidden">
    ...
    @if(isset($stats['sikayet_projelerim_count']))
        <a href="{{ route('sikayet-gorevlerim.index') }}" class="group relative bg-gradient-to-br from-red-50 to-pink-50 border border-red-100 rounded-2xl p-6 hover:shadow-2xl hover:scale-105 transition-all duration-300 overflow-hidden">
            ...
            <div class="relative">
                ...
                <div class="space-y-3 max-h-48 overflow-y-auto pr-2 custom-scrollbar">
                    @foreach($bekleyenAdimGorevleri as $gorev)
                        <a href="{{ route('proje.workspace.show', $gorev->iaa_id) }}" class="block bg-white p-3 rounded-lg border border-orange-100 shadow-sm hover:border-orange-300 hover:shadow-md transition-all group/item">
                            <div class="flex justify-between items-start">
                                <div>
                                    <p class="text-xs font-bold text-orange-600 mb-0.5 uppercase tracking-wide">Adım: {{ $gorev->adim_adi }}</p>
