...
<?php $component->withAttributes([]); ?>
    <div class="py-10 bg-[#f8fafc] min-h-screen" x-data="bolumSistemi()">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form action="<?php echo e(route('admin.bolumler.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 transition-all hover:shadow-2xl hover:shadow-slate-200/60">
                    <div class="p-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="relative">
                                <label class="block text-sm font-bold text-slate-700 mb-2">Bölüm Lider Yardımcısı Atayın</label>
                                <div class="relative" @click.away="yardimciSearch = ''">
                                    ...
                                    <div x-show="showYardimciList && filteredYardimcilar.length > 0" 
                                         class="absolute z-50 w-full mt-2 bg-white border border-slate-100 rounded-2xl shadow-2xl max-h-60 overflow-y-auto"
                                         x-transition:enter="transition ease-out duration-200"
                                         x-transition:enter-start="opacity-0 translate-y-2"
                                         x-transition:enter-end="opacity-100 translate-y-0">
                                        <template x-for="user in filteredYardimcilar" :key="user.id">
                                            <div @click="selectYardimci(user)" 
                                                 class="flex items-center px-4 py-3 hover:bg-slate-50 cursor-pointer transition-colors border-b border-slate-50 last:border-0">
                        ...
                        <div class="space-y-6">
                                ...
                                <div class="relative">
                                    <select name="sikayet_workflow_id" id="sikayet_workflow_id"
                                        ...
                                        <?php $__currentLoopData = $workflows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workflow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($workflow->id); ?>" <?php echo e(old('sikayet_workflow_id') == $workflow->id ? 'selected' : ''); ?>>
                            ...
                            <div class="bg-slate-50 p-6 rounded-3xl border border-slate-100 flex items-center justify-between group hover:bg-emerald-50/30 transition-colors">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="has_machines" value="1" class="sr-only peer" <?php echo e(old('has_machines') ? 'checked' : ''); ?>>
    ...
    <script>
        function bolumSistemi() {
            return {
                ...
                selectedCategory: "<?php echo e(old('bolum_kategori_id')); ?>",
                ...
                liderSearch: '',
                showLiderList: false,
                selectedLiderId: "<?php echo e(old('lider_id')); ?>",
                selectedLiderName: '',

                // Yardımcı Arama (Çoklu)
                yardimciSearch: '',
                showYardimciList: false,
                selectedYardimcilar: [], // [{id: 1, name: '...'}, ...]

                // Direktör Arama
                direktorler: <?php echo json_encode($directors, 15, 512) ?>,
                direktorSearch: '',
                showDirektorList: false,
                selectedDirektorId: "<?php echo e(old('director_id', '')); ?>",
                ...
                init() {
                    ...
                    // Çoklu Yardımcı İlklendirme (Eski datadan)
                    <?php if(old('lider_yardimcisi_ids')): ?>
                        const oldIds = <?php echo json_encode(old('lider_yardimcisi_ids'), 15, 512) ?>;
                        this.selectedYardimcilar = this.liderler.filter(u => oldIds.includes(String(u.id)));
                    <?php endif; ?>
                ...
                get filteredYardimcilar() {
                    ...
                    return this.liderler.filter(u => 
                        u.name.toLowerCase().includes(this.yardimciSearch.toLowerCase())
                    ).slice(0, 8);
                },
...
<?php endif; ?><?php /**PATH /var/www/kys_koksan/iaa/resources/views/admin/bolumler/create.blade.php ENDPATH**/ ?>