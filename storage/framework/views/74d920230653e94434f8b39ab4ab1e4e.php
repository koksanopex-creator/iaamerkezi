...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'reddet-modal-'.e($iaa->id).'','focusable' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'reddet-modal-'.e($iaa->id).'','focusable' => true]); ?>
    <form 
        method="post" 
        action="<?php echo e(route('admin.iaa-yonetim.reddet', $iaa)); ?>" 
        class="p-6"
    ...
    >
        ...
        <p class="mt-1 text-sm text-gray-600">"<?php echo e($iaa->baslik); ?>" başlıklı öneriyi reddetmek üzeresiniz. Lütfen gerekçenizi belirtin.</p>
        
        <div class="mt-6">
            <?php if (isset($component)) { $__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'yonetici_notu_'.e($iaa->id).'','value' => 'Reddetme Gerekçesi','class' => 'sr-only']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'yonetici_notu_'.e($iaa->id).'','value' => 'Reddetme Gerekçesi','class' => 'sr-only']); ?>
...
<?php endif; ?>
            <textarea 
                id="yonetici_notu_<?php echo e($iaa->id); ?>" 
                name="yonetici_notu" 
...
<?php endif; ?><?php /**PATH /var/www/kys_koksan/iaa/resources/views/admin/iaa-yonetim/partials/reddet-modal.blade.php ENDPATH**/ ?>