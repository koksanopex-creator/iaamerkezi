...
<?php $component->withAttributes([]); ?>
                <?php if(isset($actionText)): ?>
                    If you're having trouble clicking the "<?php echo new \Illuminate\Support\EncodedHtmlString($actionText); ?>" button, copy and paste the URL below into your web
                    browser: <span class="break-all">[<?php echo new \Illuminate\Support\EncodedHtmlString($actionUrl); ?>](<?php echo new \Illuminate\Support\EncodedHtmlString($actionUrl); ?>)</span>
                <?php endif; ?>
                <?php echo $subcopy; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            © <?php echo new \Illuminate\Support\EncodedHtmlString(date('Y')); ?> <?php echo new \Illuminate\Support\EncodedHtmlString(config('app.name')); ?>. Tüm hakları saklıdır.
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/vendor/mail/html/message.blade.php ENDPATH**/ ?>