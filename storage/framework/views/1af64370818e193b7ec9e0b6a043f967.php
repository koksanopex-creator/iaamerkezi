<div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-4 text-center">
    ...
    <?php if(auth()->user()->hasRole('Superadmin') || $stats['bolumOnayi'] > 0): ?>
    <div onclick="switchTab('onay-bekleyenler')" class="cursor-pointer hover:scale-105 transition-transform p-4 bg-purple-100 rounded-lg shadow-sm border-2 border-purple-300">
        ...
        <p class="mt-1 text-3xl font-bold text-purple-900"><?php echo e($stats['bolumOnayi']); ?></p>
    </div>
    <?php endif; ?>
...
</div><?php /**PATH /var/www/kys_koksan/iaa/resources/views/admin/iaa-yonetim/partials/stats-cards.blade.php ENDPATH**/ ?>