    ...
    <div class="bg-white rounded-2xl shadow-sm border border-indigo-100 overflow-hidden">
        <div class="p-6 border-b border-indigo-50 flex items-center justify-between">
            ...
            <span class="px-3 py-1 bg-indigo-100 text-indigo-700 text-xs font-black rounded-full">
                <?php echo e($bekleyenProjeDavetleri->count()); ?>

            </span>
        </div>

        <div class="divide-y divide-gray-50">
            <?php $__currentLoopData = $bekleyenProjeDavetleri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proje): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="p-4 hover:bg-gray-50 transition-colors flex items-center justify-between gap-4">
                    <div class="flex items-center gap-3 min-w-0">
                        <div class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white text-sm font-bold shadow-sm">
                            <?php echo e(substr($proje->baslik ?? 'P', 0, 1)); ?>

                        </div>
                        <div class="min-w-0">
                            <a href="<?php echo e(route('proje.workspace.show', $proje->id)); ?>" class="text-sm font-bold text-gray-900 hover:text-indigo-600 transition truncate block">
                            ...
                            <div class="flex items-center gap-2 mt-0.5">
                                <?php if($proje->atananTakim): ?>
                                    <span class="text-[10px] font-bold text-gray-400 uppercase">
                                        Takım: <?php echo e($proje->atananTakim->ad); ?>

                                    </span>
                                    <?php if($proje->atananTakim->lider): ?>
                                        <span class="text-[10px] text-gray-300">•</span>
                                        <span class="text-[10px] text-gray-400">
                                            Lider: <?php echo e($proje->atananTakim->lider->name); ?>
...
<?php /**PATH /var/www/kys_koksan/iaa/resources/views/dashboard/partials/project-invitations.blade.php ENDPATH**/ ?>