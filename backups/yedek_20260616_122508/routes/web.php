...
Route::get('/sso-login', function () use ($centralSsoUrl) { return redirect($centralSsoUrl); })->name('login');
...
Route::middleware(['auth', BlockCustomerAccess::class])->group(function ()
{
    ...
    Route::post('takim-istekleri/{davetiye}/reddet', [TakimController::class, 'istegiReddet'])->name('takimlar.istekReddet');
...
Route::post('users/{id}/reddet', [UserController::class, 'basvuruReddet'])->name('users.basvuru_reddet');
    ...
    Route::get('/musteriler', MusteriYonetimi::class)
        ...
        ->middleware(['role:Superadmin|Yonetim|Müşteri Şikayeti Kurulu|Bölüm Kalite Yöneticisi|Bölüm Lideri|Müşteri Şikayeti Çözüm Lideri|Direktör|Hukuk Admini|Hukuk Yöneticisi|Bölüm Lider Yardımcısı']);
    // =================================================================
    ...
    // =================================================================
    Route::middleware(['role:Superadmin|Bölüm Kalite Yöneticisi'])->group(function ()
    {
    ...
    Route::get('musteri-sikayet-raporlari', [ReportController::class, 'sikayetRaporlari'])
        ...
        ->middleware(['role:Superadmin|Yonetim|Müşteri Şikayeti Kurulu|Bölüm Kalite Yöneticisi|Direktör|Bölüm Lideri|Bölüm Lider Yardımcısı']);
    ...
    Route::get('musteri-sikayet-iade-raporlari', [ReportController::class, 'iadeRaporlari'])
        ...
        ->middleware(['role:Superadmin|Yonetim|Müşteri Şikayeti Kurulu|Bölüm Kalite Yöneticisi|Direktör|Bölüm Lideri|Müşteri Şikayeti Çözüm Lideri|Bölüm Lider Yardımcısı']);
    ...
    Route::resource('sikayetler', SikayetController::class)
        ...
        ->middleware('role:Superadmin|Yonetim|Müşteri Şikayeti Kurulu|Bölüm Kalite Yöneticisi|Bölüm Lideri|Müşteri Şikayeti Çözüm Lideri|Direktör|Bölüm Lider Yardımcısı');
    ...
    Route::middleware(['role:Superadmin|Yonetim|Müşteri Şikayeti Kurulu|Müşteri Temsilcisi|Müşteri Şikayeti Çözüm Lideri|Bölüm Kalite Yöneticisi|Direktör|Bölüm Lideri|Bölüm Lider Yardımcısı'])->group(function() {
