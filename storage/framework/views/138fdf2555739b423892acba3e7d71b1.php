<div> 
    <div class="bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40 min-h-screen p-4 md:p-6">
        <div class="max-w-7xl mx-auto">
                ...
                <div class="border-b border-gray-200 bg-white px-2 sm:px-6 mb-4 rounded-t-xl">
                    <nav class="-mb-px flex flex-nowrap justify-between items-center w-full overflow-hidden" aria-label="Tabs">
                        ...
                        <button wire:click="setTab('onay_bekleyenler')"
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(($stats['onay_bekleyenler'] ?? 0) > 0): ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(Auth::user()->hasAnyRole(['Superadmin', 'SuperAdmin', 'SUPERADMIN', 'superadmin', 'Super Admin', 'SUPER ADMIN', 'Yonetim', 'Yönetim'])): ?>
                        <button wire:click="setTab('cop_kutusu')"
                            class="whitespace-nowrap py-3 px-1 border-b-2 font-bold text-[10px] lg:text-xs xl:text-sm flex-1 flex justify-center items-center gap-1 xl:gap-2 transition-colors focus:outline-none
                                <?php echo e($activeTab === 'cop_kutusu' ? 'border-gray-800 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'); ?>">
                            🗑️ Çöp Kutusu
                        </button>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <!--[if BLOCK]><![endif]--><?php if($this->filterSummary): ?>
                <div class="mb-6 animate-fade-in">
                    <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-xl shadow-sm flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-blue-700 font-medium">
                                    <span class="font-bold">🔍 Aktif Filtreler:</span> <?php echo e($this->filterSummary); ?>

                                </p>
                            </div>
                        </div>
                        <button wire:click="resetFilters" class="text-blue-500 hover:text-blue-700 transition-colors">
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3978583641-0', $__slots ?? [], get_defined_vars());
...
?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($confirmingDeletionId || $confirmingBulkDelete): ?>
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    <!--[if BLOCK]><![endif]--><?php if($activeTab === 'cop_kutusu'): ?>
                                        <?php echo e($confirmingBulkDelete ? count($selectedSikayetler) . ' adet seçili şikayeti KALICI OLARAK silmek istiyor musunuz?' : 'Bu şikayeti KALICI OLARAK silmek istediğinize emin misiniz?'); ?>
                                    ...
                                    <?php else: ?>
                                        <?php echo e($confirmingBulkDelete ? count($selectedSikayetler) . ' adet seçili şikayeti Çöp Kutusuna taşımak istiyor musunuz?' : 'Bu şikayeti Çöp Kutusuna taşımak istediğinize emin misiniz?'); ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($recentlyDeletedSikayet): ?>
    <div x-data="{ show: true }" 
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="flex flex-col">
                <span class="text-sm font-semibold text-gray-800"><?php echo e($recentlyDeletedSikayet['message']); ?></span>
...
</div><?php /**PATH /var/www/kys_koksan/iaa/resources/views/livewire/admin/sikayetler-tablosu.blade.php ENDPATH**/ ?>