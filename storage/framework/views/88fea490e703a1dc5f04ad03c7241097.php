...
<div class="min-h-screen bg-gray-50/50">
        ...
        <div class="max-w-[98%] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row md:items-center justify-between py-4 gap-4">
                ...
                <div class="flex items-center gap-3 bg-gray-50 p-1.5 rounded-xl border border-gray-200">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($startDate || $endDate || $selectedBolumId): ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($startDate || $endDate || $selectedBolumId): ?>
                <div class="pb-3 animate-fade-in-down">
                    <div
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($selectedBolumId): ?>
                            <span class="px-2 py-0.5 bg-white rounded border border-indigo-200 shadow-sm">
                                <?php echo e($bolumler->find($selectedBolumId)->ad); ?> Bölümü
                            </span>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                        <!--[if BLOCK]><![endif]--><?php if($startDate || $endDate): ?>
                            <span class="px-2 py-0.5 bg-white rounded border border-indigo-200 shadow-sm">
                                <?php echo e($startDate ? \Carbon\Carbon::parse($startDate)->format('d.m.Y') : '...'); ?> -
                                <?php echo e($endDate ? \Carbon\Carbon::parse($endDate)->format('d.m.Y') : '...'); ?>
            ...
            <div class="bg-white rounded-2xl shadow-lg border-2 border-indigo-100 overflow-hidden relative">
                ...
                <div
                    ...
                    <span
                        ...
                        Son <?php echo e($sonSikayetler->count()); ?> Kayıt
                    </span>
                </div>
                ...
                <div class="relative h-[500px] overflow-hidden group hover:overflow-y-auto custom-scrollbar bg-gray-50/30"
                    ...
                    <div class="animate-marquee-vertical space-y-4 p-5">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $sonSikayetler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sikayet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="relative rounded-xl border-l-4 transition-all duration-300 hover:shadow-lg group/card
                                                            <?php echo e($isExternal ? 'bg-red-50 border-red-500 ring-1 ring-red-200' : 'bg-' . $statusColor . '-50 border-' . $statusColor . '-500'); ?>

                                                            p-4 overflow-hidden mb-3">

                                
                                <div
                                    class="mb-3 border-b <?php echo e($isExternal ? 'border-red-200' : 'border-' . $statusColor . '-200'); ?> pb-2">
                                    <div class="flex justify-between items-start gap-2">
                                        ...
                                        <h4 class="text-sm font-bold text-gray-900 leading-snug flex-1">
                                            <div class="flex items-center gap-2 mb-1">
                                                ...
                                                <span
                                                    class="px-2 py-0.5 rounded-[4px] text-[10px] font-bold uppercase tracking-wide bg-white border border-<?php echo e($statusColor); ?>-200 text-<?php echo e($statusColor); ?>-700 shadow-sm">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div>
                                            <span
                                                ...
                                                İsmi :</span>
                                            <span class="font-semibold text-gray-800"><?php echo e($sikayet->musteri_adi); ?></span>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <span
                                                ...
                                                <?php echo e($sikayet->sikayetKategori->bolum->ad ?? 'Genel'); ?>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div>
                                            <span
                                                ...
                                                Kategorisi :</span>
                                            <span
                                                class="font-medium text-gray-700"><?php echo e($sikayet->sikayetKategori->ad ?? '-'); ?></span>
                                        </div>
                                        ...
                                        <div>
                                            <span
                                                ...
                                                Alt Kategorisi :</span>
                                            <span
                                                class="font-medium text-gray-700"><?php echo e($sikayet->sikayetAltKategori->ad ?? '-'); ?></span>
                                        </div>
                                    </div>
                                ...
                                <div
                                    class="mt-4 pt-2 border-t <?php echo e($isExternal ? 'border-red-200' : 'border-' . $statusColor . '-200'); ?> flex justify-between items-center">
                                    <div class="font-black text-xs text-red-600 animate-pulse flex items-center gap-1.5">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        <?php echo e($sureMetni); ?>
    ...
    </div><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/livewire/executive-report.blade.php ENDPATH**/ ?>