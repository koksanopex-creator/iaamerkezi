...
class SikayetController extends Controller
{
    ...
    public function kurulGirdileri(Request $request)
    {
        ...
        $selectedUserId = $request->input('kullanici_id') ?? ($girisYapanKullanici->hasRole('Superadmin') ? 'all' : $girisYapanKullanici->id);
        ...
        return view('admin.sikayetler.kurul', compact('sikayetler', 'kurulUyeleri', 'selectedUserId', 'stats_filtrelenmis', 'stats_kisisel'));
    }
