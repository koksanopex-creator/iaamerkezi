<div class="mb-8">
    <div
        ...
        <div class="flex flex-wrap gap-3 items-center">
            ...
            <?php if(!Auth::user()->hasRole(['Yonetim', 'Direktör', 'Hukuk Admini', 'Hukuk Yöneticisi', 'Arabuluculuk Personel', 'Bölüm Lideri', 'Bölüm Lider Yardımcısı'])): ?>
...
</div><?php /**PATH /var/www/kys_koksan/iaa/resources/views/livewire/admin/sikayetler-partials/header.blade.php ENDPATH**/ ?>