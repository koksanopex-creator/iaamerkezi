                        ...
                        <div class="p-4 md:p-6 space-y-4">
                            <div>
                                ...
                                <input type="text" name="para_birimleri" id="para_birimleri" 
                                       value="<?php echo e(old('para_birimleri', $paraBirimleri->value ?? 'TL,USD,EUR')); ?>" 
                        ...
                        <div class="p-4 md:p-6 space-y-4">
                            <div>
                                ...
                                <input type="number" name="standart_puan" id="standart_puan" 
                                       value="<?php echo e(old('standart_puan', $standartPuan->value ?? 100)); ?>" 
                            ...
                            <div>
                                ...
                                <input type="number" name="musteri_sikayeti_standart_puan" id="musteri_sikayeti_standart_puan"
                                       value="<?php echo e(old('musteri_sikayeti_standart_puan', $musteriSikayetiPuan->value ?? 0)); ?>"
                                       min="0"
                                       class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors text-sm md:text-base"
                                       placeholder="0">
                                <?php $__errorArgs = ['musteri_sikayeti_standart_puan'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" name="musteri_sikayeti_cozum_carpan" id="musteri_sikayeti_cozum_carpan"
                                       value="<?php echo e(old('musteri_sikayeti_cozum_carpan', $musteriSikayetiCozumCarpan->value ?? 10)); ?>"
                                       min="1"
                                       class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors text-sm md:text-base"
                                       placeholder="10">
                                <?php $__errorArgs = ['musteri_sikayeti_cozum_carpan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" name="kurul_default_puan" id="kurul_default_puan"
                                       value="<?php echo e(old('kurul_default_puan', $kurulDefaultPuan->value ?? 0)); ?>"
                                       min="0"
                                       class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors text-sm md:text-base"
                                       placeholder="0">
                                <?php $__errorArgs = ['kurul_default_puan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
                                ...
                                <div class="space-y-3">
                                    <label class="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 hover:bg-blue-50 transition-all duration-200 group">
                                        <input id="onay_aktif" name="kayit_onay_sistemi" type="radio" value="1" 
                                               <?php echo e(($kayitOnay && $kayitOnay->value == 1) || !$kayitOnay ? 'checked' : ''); ?> 
                                    ...
                                    <label class="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 hover:bg-blue-50 transition-all duration-200 group">
                                        <input id="onay_pasif" name="kayit_onay_sistemi" type="radio" value="0" 
                                               <?php echo e($kayitOnay && $kayitOnay->value == 0 ? 'checked' : ''); ?> 
                                               class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                                        <div class="ml-3 flex-1">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <input type="text" name="sikayet_onay_email_subject" id="sikayet_onay_email_subject"
                                       value="<?php echo e(old('sikayet_onay_email_subject', $settings->get('sikayet_onay_email_subject')->value ?? 'Şikayetiniz Alınmıştır - Takip Bilgileriniz')); ?>"
                                ...
                                <?php $__errorArgs = ['sikayet_onay_email_subject'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <textarea name="sikayet_onay_email_body" id="sikayet_onay_email_body" rows="6"
                                          ...
                                          placeholder="Sayın {musteri_adi}, ..."><?php echo e(old('sikayet_onay_email_body', $settings->get('sikayet_onay_email_body')->value ?? "Sayın {musteri_adi},\n\nŞikayetiniz alınmıştır. Takip bilgileriniz aşağıdadır:\nTakip Linki: {takip_linki}\nŞifreniz: {sifre}\n\nTeşekkür ederiz.")); ?></textarea>
                                ...
                                <?php $__errorArgs = ['sikayet_onay_email_body'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <input type="text" name="sikayet_cozum_email_subject" id="sikayet_cozum_email_subject"
                                       value="<?php echo e(old('sikayet_cozum_email_subject', $settings->get('sikayet_cozum_email_subject')->value ?? 'Şikayetiniz Çözümlenmiştir')); ?>"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-colors text-sm"
                                       placeholder="Şikayetiniz Çözümlenmiştir">
                                <?php $__errorArgs = ['sikayet_cozum_email_subject'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <?php $__errorArgs = ['sikayet_cozum_email_body'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
                         ...
                         <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="email" name="sikayet_admin_notification_email" id="sikayet_admin_notification_email"
                                       value="<?php echo e(old('sikayet_admin_notification_email', $settings->get('sikayet_admin_notification_email')->value ?? '')); ?>"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-colors text-sm"
                                       placeholder="admin@example.com">
                                <p class="text-xs text-gray-500 mt-1">Yeni şikayet/geri bildirim gelince buraya e-posta gider.</p>
                                <?php $__errorArgs = ['sikayet_admin_notification_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" name="sikayet_response_time_hours" id="sikayet_response_time_hours"
                                       value="<?php echo e(old('sikayet_response_time_hours', $settings->get('sikayet_response_time_hours')->value ?? 72)); ?>"
                                       min="1"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-colors text-sm"
                                       placeholder="72">
                                <p class="text-xs text-gray-500 mt-1">İlk onay e-postasında müşteriye belirtilecek süre.</p>
                                <?php $__errorArgs = ['sikayet_response_time_hours'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
