        ...
        <div class="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-slate-900/60 backdrop-blur-sm transition-opacity duration-300"
            ...
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden border border-slate-200 relative transform transition-all"
                ...
                <div class="px-6 py-5 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center sticky top-0 z-10 backdrop-blur-md">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs font-semibold text-slate-500 mt-0.5"><?php echo e($sikayetler->first()->customer->name ?? ''); ?></p>
                        </div>
                    </div>
                ...
                <div class="p-6 overflow-y-auto flex-1 bg-slate-50/30">
                    <!--[if BLOCK]><![endif]--><?php if($sikayetler->isEmpty()): ?>
                    ...
                    <?php else: ?>
                        <div class="space-y-4">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $sikayetler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route(auth()->user()->hasRole('Müşteri|Müşteri Temsilcisi') ? 'iaa.sikayetler.show' : 'admin.sikayetler.show', $s->id)); ?>" 
                                   class="block bg-white border <?php echo e($s->id == $currentSikayetId ? 'border-indigo-300 ring-1 ring-indigo-300 shadow-md' : 'border-slate-200 hover:border-slate-300 shadow-sm'); ?> rounded-xl p-4 transition-all hover:-translate-y-0.5 relative">
                                    
                                    <!--[if BLOCK]><![endif]--><?php if($s->id == $currentSikayetId): ?>
                                    ...
                                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3">
                                        <div class="flex items-center gap-2">
                                            <span class="text-xs font-black text-slate-400">#<?php echo e($s->id); ?></span>
                                            <h4 class="font-bold text-slate-800 text-sm truncate"><?php echo e($s->musteri_sikayet_konusu); ?></h4>
                                        </div>
                                        <div class="flex items-center gap-2 flex-shrink-0">
                                            <span class="text-[10px] font-bold px-2 py-0.5 rounded border 
                                                <?php echo e(match($s->musteri_oncelik) {
                                                ...
                                                <?php echo e($s->musteri_oncelik); ?>

                                            </span>
                                            <?php echo $s->musteri_durum_badge; ?>
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                                        <div>
                                            ...
                                            <span class="text-slate-600 font-medium"><?php echo e($s->sikayetKategori->ad ?? 'Genel'); ?></span>
                                        </div>
                                        <div>
                                            <span class="block text-[10px] font-bold text-slate-400 uppercase mb-0.5">Tarih</span>
                                            <span class="text-slate-600 font-medium"><?php echo e($s->created_at->format('d.m.Y')); ?></span>
                                        </div>
                                        <div class="col-span-2">
                                            <span class="block text-[10px] font-bold text-slate-400 uppercase mb-0.5">Çözüm Takımı</span>
                                            <span class="text-slate-600 font-medium"><?php echo e($s->cozumTakimi->ad ?? 'Atanmadı'); ?></span>
                                        </div>
                                    </div>
                                </a>
...
<?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/livewire/admin/sikayetler/musteri-diger-sikayetler-modal.blade.php ENDPATH**/ ?>