<div class="flex items-center justify-end space-x-2">
    ...
    <?php if($type === 'atanmis'): ?>
        <a href="<?php echo e(route('proje.workspace.show', $iaa)); ?>" target="_blank" class="inline-flex items-center justify-center px-3 py-1 text-xs font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700">İlerleme İzle</a>
    <?php else: ?>
        <a href="<?php echo e(route('iaa.show', $iaa)); ?>" target="_blank" class="inline-flex items-center justify-center px-3 py-1 text-xs font-medium rounded-md shadow-sm text-white bg-gray-600 hover:bg-gray-700">İncele</a>
    <?php endif; ?>
    ...
    <?php if (\Illuminate\Support\Facades\Blade::check('role', 'Superadmin')): ?>
        ...
        <?php if(in_array($type, ['atanmis', 'havuz', 'reddedilmis', 'yonetici-onayi'])): ?>
            ...
            <form method="POST" action="<?php echo e(route('admin.iaa-yonetim.geriAl', $iaa)); ?>" class="inline" onsubmit="return confirm('İşlemi geri almak istediğinize emin misiniz?');"> 
