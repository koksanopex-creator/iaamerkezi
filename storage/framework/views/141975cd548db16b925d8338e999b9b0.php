        ...
        <div class="flex flex-col gap-2">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                <h2 class="text-2xl md:text-3xl font-bold text-gray-900">
                    <?php echo e($user->name); ?> - Puan Dökümü
                </h2>
                ...
                <div class="p-6 md:p-8">
                    <div class="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-6">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3 class="text-xl md:text-2xl font-bold text-gray-900 mb-1"><?php echo e($user->name); ?></h3>
                                <div class="flex items-center gap-2 text-gray-600">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                                    </svg>
                                    <span class="text-sm md:text-base"><?php echo e($user->email); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center sm:text-right bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl p-4 md:p-6 shadow-lg min-w-[160px]">
                            ...
                            <div class="flex items-center justify-center sm:justify-end gap-2">
                                ...
                                <p class="text-3xl md:text-4xl font-bold text-white"><?php echo e(number_format($user->toplam_puan, 0)); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-emerald-500 to-teal-600 p-4 md:p-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs md:text-sm text-emerald-100 mt-0.5">Toplam <?php echo e($kazanilanlar->count()); ?> kayıt</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="hidden md:block overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            <?php $__empty_1 = true; $__currentLoopData = $kazanilanlar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kayit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-emerald-50/50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-start gap-2">
                                            <div class="flex-1">
                                                ...
                                                <a href="<?php echo e($kayit['url']); ?>" 
                                                   class="<?php echo e($kayit['tip'] == 'Proje' ? 'text-indigo-600 hover:text-indigo-800' : 'text-emerald-600 hover:text-emerald-800'); ?> font-medium transition-colors duration-150 hover:underline" 
                                                   title="<?php echo e($kayit['baslik']); ?>">
                                                    <?php echo e(Str::limit($kayit['baslik'], 50)); ?>
                                                ...
                                                <div class="mt-1">
                                                    ...
                                                    <span class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-semibold <?php echo e($kayit['tip'] == 'Proje' ? 'bg-blue-100 text-blue-700' : 'bg-rose-100 text-rose-700'); ?>">
                                                        <?php if($kayit['tip'] == 'Proje'): ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2 text-sm text-gray-600">
                                            ...
                                            <?php echo e($kayit['tarih'] ? \Carbon\Carbon::parse($kayit['tarih'])->format('d.m.Y H:i') : '-'); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right">
                                        <span class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-green-100 text-green-700 font-bold text-sm">
                                            ...
                                            +<?php echo e(number_format($kayit['puan'], 0)); ?>
                        ...
                        <div class="p-4 hover:bg-emerald-50/50 transition-colors duration-150">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex items-center gap-2 flex-1">
                                    ...
                                    <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-semibold <?php echo e($kayit['tip'] == 'Proje' ? 'bg-blue-100 text-blue-700' : 'bg-rose-100 text-rose-700'); ?>">
                                        <?php if($kayit['tip'] == 'Proje'): ?>
                                            <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                                <path d="M2 6a2 2 0 012-2h5l2 2h5a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6z"/>
                                            </svg>
                            ...
                            <div class="mb-3">
                                ...
                                <a href="<?php echo e($kayit['url']); ?>" 
                                   class="<?php echo e($kayit['tip'] == 'Proje' ? 'text-indigo-600 hover:text-indigo-800' : 'text-emerald-700 hover:text-emerald-900'); ?> font-medium text-sm transition-colors duration-150 hover:underline block" 
                                   title="<?php echo e($kayit['baslik']); ?>">
                                    <?php echo e(Str::limit($kayit['baslik'], 60)); ?>
...
<?php endif; ?><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/kullanici-puanlari.blade.php ENDPATH**/ ?>