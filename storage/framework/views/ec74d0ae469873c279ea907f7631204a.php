...
<?php $component->withAttributes([]); ?> 
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div>
                <?php if($sikayet->iaa_id): ?>
                    ...
                    ?>
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold <?php echo e($renk); ?>">
                        <?php echo e($projeDurumu); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5 text-sm">
                ...
                <?php if($sikayet->sikayetAltKategori): ?>
                    <div class="md:col-span-2">
                        ...
                        <span class="text-gray-900"><?php echo e($sikayet->sikayetAltKategori->ad); ?></span>
                    </div>
                <?php elseif($sikayet->sikayet_alt_kategori_diger): ?>
                    <div class="md:col-span-2">
                        <strong class="text-gray-500">Alt Kategori (Diğer):</strong> 
                        <span class="text-gray-900"><?php echo e($sikayet->sikayet_alt_kategori_diger); ?></span>
                    </div>
                <?php endif; ?>
            </div>
            <div class="mt-6">
    ...
    <?php if($projeTamamlandi): ?>
        <div class="bg-white shadow-lg rounded-xl overflow-hidden mb-8 border border-gray-200" 
             x-data="{ editing: <?php echo e($sikayet->musteri_feedback ? 'false' : 'true'); ?> }">
            ...
            <div class="p-6">
                ...
                <div x-show="!editing">
                    <?php if($sikayet->musteri_feedback): ?>
                        <div class="p-6 <?php echo e($sikayet->musteri_feedback == 'Onaylandı' ? 'bg-green-50 border-green-200' : ($sikayet->musteri_feedback == 'Reddedildi' ? 'bg-red-50 border-red-200' : 'bg-yellow-50 border-yellow-200')); ?> border rounded-xl flex items-center gap-4">
                            ...
                            <div>
                                <p class="font-bold text-gray-900">Geri bildiriminiz alındı: <span class="<?php echo e($sikayet->musteri_feedback == 'Onaylandı' ? 'text-green-700' : ($sikayet->musteri_feedback == 'Reddedildi' ? 'text-red-700' : 'text-yellow-700')); ?>"><?php echo e($sikayet->musteri_feedback); ?></span></p>
                                <?php if($sikayet->musteri_feedback_note): ?>
                                    <p class="text-sm text-gray-600 mt-1 italic">"<?php echo e($sikayet->musteri_feedback_note); ?>"</p>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endif; ?>
                ...
                <div x-show="editing" style="display: none;">
                    ...
                    <form method="POST" action="<?php echo e(route('public.sikayet.storeFeedback', ['token' => $sikayet->takip_token])); ?>" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        <div>
                            <label for="feedback_note" class="block text-sm font-bold text-gray-700 mb-2">Ek Notunuz (Opsiyonel)</label>
                            <textarea name="feedback_note" id="feedback_note" rows="3" class="block w-full border-gray-300 rounded-xl shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm resize-y" placeholder="Düşüncelerinizi buraya yazabilirsiniz..."><?php echo e($sikayet->musteri_feedback_note); ?></textarea>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-red-500 text-sm font-medium mt-2 text-center"><?php echo e($message); ?></p> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
    ...
    <?php if($sikayet->iaa_id): ?>
        ...
        <div class="mb-8 mt-6">
            ...
            <?php elseif($projeDurumu == 'Tamamlandı'): ?>
                <div class="bg-gradient-to-r from-emerald-50 to-green-50 border border-green-200 rounded-xl p-6 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm">
                    ...
                    <a href="<?php echo e(route('proje.workspace.show', $sikayet->iaa_id)); ?>" class="whitespace-nowrap px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-bold rounded-lg shadow-md hover:shadow-lg transition-all flex items-center gap-2 transform hover:-translate-y-0.5">
                ...
                <?php else: ?>
                    <div class="bg-gradient-to-r from-indigo-50 to-blue-50 border border-indigo-100 rounded-xl p-6 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900 text-lg">
                                    <?php if(in_array($projeDurumu, ['Bölüm Onayı Bekliyor', 'Yönetici Onayı Bekliyor'])): ?>
                                        Onay Aşamasında
                                    <?php else: ?>
                        ...
                        <a href="<?php echo e(route('proje.workspace.show', $sikayet->iaa_id)); ?>" class="whitespace-nowrap px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-lg shadow-md hover:shadow-lg transition-all flex items-center gap-2 transform hover:-translate-y-0.5">
