        ...
        <div class="max-w-7xl mx-auto">
            <div class="bg-white overflow-hidden shadow-2xl rounded-xl sm:rounded-2xl">
                ...
                <div class="p-4 sm:p-8">
                    ...
                    <form action="<?php echo e(auth()->user()->is_personnel ? route('admin.sikayetler.store') : route('iaa.sikayetler.store')); ?>" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-8">
                            ...
                            <div class="md:col-span-2 mb-6">
                                ...
                                <?php if($isTekliMusteri && $tekFirma): ?>
                                    ...
                                    <div class="flex items-center p-4 bg-gray-50 border border-gray-200 rounded-lg">
                                        <div
                                            ...
                                            <?php echo e(substr($tekFirma->name ?? 'F', 0, 1)); ?>

                                        </div>
                                        <div>
                                            <p class="text-sm font-bold text-gray-900">
                                                <?php echo e($tekFirma->name ?? 'Firmanız'); ?>
                                    ...
                                    <input type="hidden" name="customer_id" value="<?php echo e($tekFirma->id); ?>">
...
[$__name, $__params] = $__split('admin.sikayet-musteri-secimi', ['preselectedCustomerId' => $preselectedCustomerId ?? null,'selectedRepId' => $preselectedRepId ?? null]);

$__html = app('livewire')->mount($__name, $__params, 'lw-1170174301-0', $__slots ?? [], get_defined_vars());
                                ...
                                <div class="mt-2 flex flex-wrap items-center gap-4 md:space-x-6">
                                    <label class="inline-flex items-center cursor-pointer">
                                        <input type="radio" name="konum_tipi" value="Yurt İçi"
                                            class="form-radio w-5 h-5 text-red-600 focus:ring-red-500" <?php echo e(old('konum_tipi', 'Yurt İçi') == 'Yurt İçi' ? 'checked' : ''); ?>>
                                        <span class="ml-2 text-sm text-gray-700">Yurt İçi</span>
                                    </label>
                                    <label class="inline-flex items-center cursor-pointer">
                                        <input type="radio" name="konum_tipi" value="Yurt Dışı"
                                            class="form-radio w-5 h-5 text-red-600 focus:ring-red-500" <?php echo e(old('konum_tipi') == 'Yurt Dışı' ? 'checked' : ''); ?>>
                            ...
                            <div class="group mb-6">
                                ...
                                <div class="relative">
                                    <select name="musteri_oncelik" id="musteri_oncelik"
                                        class="mt-1 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500 transition duration-150 ease-in-out pl-4 pr-10 py-3 text-gray-900 appearance-none bg-white">
                                        <option value="Düşük" <?php echo e(old('musteri_oncelik') == 'Düşük' ? 'selected' : ''); ?>>🟢
                                            Düşük</option>
                                        <option value="Normal" <?php echo e(old('musteri_oncelik', 'Normal') == 'Normal' ? 'selected' : ''); ?>>🟡 Normal</option>
                                        <option value="Yüksek" <?php echo e(old('musteri_oncelik') == 'Yüksek' ? 'selected' : ''); ?>>
                                            🟠 Yüksek</option>
                                        <option value="Acil" <?php echo e(old('musteri_oncelik') == 'Acil' ? 'selected' : ''); ?>>🔴
                                            Acil</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-2 group mb-6">
                                ...
                                <textarea name="musteri_sikayet_detayi" id="musteri_sikayet_detayi" rows="5" required
                                    ...
                                    placeholder="Şikayetin detaylı açıklamasını giriniz..."><?php echo e(old('musteri_sikayet_detayi')); ?></textarea>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm mt-1 flex items-center"><svg
                                    class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z"
                                        clip-rule="evenodd" />
                                </svg><?php echo e($message); ?></span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php endif; ?><?php /**PATH /var/www/kys_koksan/iaa/resources/views/admin/sikayetler/create.blade.php ENDPATH**/ ?>