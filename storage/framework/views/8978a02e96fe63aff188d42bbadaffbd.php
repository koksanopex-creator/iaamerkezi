     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-bold text-xl text-gray-800 leading-tight flex items-center gap-2">
                ...
                <?php echo e(__('Yeni Arabulucu Kaydı')); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white p-8 shadow-lg rounded-xl border border-gray-100">
                        ...
                        <form action="<?php echo e(route('admin.arabulucular.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="col-span-2 md:col-span-1">
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        ...
                                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md py-2" placeholder="Örn: Ahmet Yılmaz" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-2 md:col-span-1">
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        ...
                                        <input type="text" name="sicil_no" value="<?php echo e(old('sicil_no')); ?>" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md py-2" placeholder="Örn: 12345" required>
                                    </div>
                                ...
                                <div class="col-span-2 md:col-span-1">
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        ...
                                        <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md py-2" placeholder="ornek@email.com">
                                    </div>
                                </div>
                                ...
                                <div class="col-span-2 md:col-span-1">
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        ...
                                        <input type="text" name="telefon" value="<?php echo e(old('telefon')); ?>" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md py-2" placeholder="05XX XXX XX XX">
                                    </div>
                                </div>
                                ...
                                <div class="col-span-2 md:col-span-1">
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        ...
                                        <input type="text" name="sehir" value="<?php echo e(old('sehir')); ?>" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md py-2" placeholder="Örn: İstanbul" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-2">
                                    ...
                                    <textarea name="adres" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Ofis adresi vb."><?php echo e(old('adres')); ?></textarea>
                                </div>

                            </div>

                            <div class="mt-8 flex justify-end gap-3">
                                <a href="<?php echo e(route('admin.arabulucular.index')); ?>" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Vazgeç
                                </a>
...
<?php endif; ?><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/admin/arabulucular/create.blade.php ENDPATH**/ ?>