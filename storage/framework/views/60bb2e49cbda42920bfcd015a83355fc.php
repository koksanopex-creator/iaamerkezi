    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div class="lg:col-span-5 bg-gray-50 p-4 rounded-lg border border-gray-200 shadow-sm">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-3 py-2">
                                        <!--[if BLOCK]><![endif]--><?php if($canManage): ?>
                                            <input type="text" wire:model.live.debounce.1000ms="items.<?php echo e($index); ?>.category" class="w-full text-sm rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 p-1.5" placeholder="Hata türü">
                                        <?php else: ?>
                                            <div class="text-sm text-gray-900"><?php echo e($item['category'] ?: '-'); ?></div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </td>
                                    <td class="px-3 py-2">
                                        <!--[if BLOCK]><![endif]--><?php if($canManage): ?>
                                            <input type="number" wire:model.live.debounce.1000ms="items.<?php echo e($index); ?>.frequency" class="w-full text-sm rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 p-1.5" placeholder="0">
                                        <?php else: ?>
                                            <div class="text-sm text-gray-900"><?php echo e($item['frequency'] !== '' ? $item['frequency'] : '-'); ?></div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </td>
                                    <!--[if BLOCK]><![endif]--><?php if($canManage): ?>
                                        <td class="px-2 py-2 text-right">
                                            <!--[if BLOCK]><![endif]--><?php if(count($items) > 1): ?>
                                                <button wire:click="removeItem(<?php echo e($index); ?>)" class="text-red-400 hover:text-red-600 p-1 transition-colors bg-red-50 hover:bg-red-100 rounded">
                ...
                <!--[if BLOCK]><![endif]--><?php if(count($analyzedData) > 0): ?>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $analyzedData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="text-xs">
                                            <td class="px-2 py-1 text-gray-700 truncate max-w-[120px]"><?php echo e($data['category']); ?></td>
                                            <td class="px-2 py-1 text-right text-gray-900 font-medium"><?php echo e($data['frequency']); ?></td>
                                            <td class="px-2 py-1 text-right text-orange-600 font-bold">%<?php echo e($data['cumulative_percentage']); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                    <tr class="bg-gray-50 text-xs font-bold">
                                        <td class="px-2 py-1 text-gray-700">Toplam</td>
                                        <td class="px-2 py-1 text-right text-gray-900"><?php echo e($totalFrequency); ?></td>
            ...
            <div class="lg:col-span-7 bg-white p-4 rounded-lg border border-gray-200 shadow-sm flex flex-col items-center justify-center min-h-[400px]">
                <!--[if BLOCK]><![endif]--><?php if(count($analyzedData) > 0): ?>
                    <div class="w-full min-h-[400px]" wire:ignore
                         ...
                         x-init="$nextTick(() => { initChart(<?php echo \Illuminate\Support\Js::from($analyzedData)->toHtml() ?>) })"
                         @pareto-data-updated-<?php echo e($tool->id); ?>.window="initChart($event.detail[0])"
                    ></div>
                <?php else: ?>
...
<?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/livewire/project/tools/pareto-analysis.blade.php ENDPATH**/ ?>