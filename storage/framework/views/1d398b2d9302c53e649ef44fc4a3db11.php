        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-bold text-2xl text-gray-900 leading-tight">
                    <?php echo e(__('Tamamlanmış ve Arşivlenmiş Projeler')); ?>

                </h2>
                <p class="text-sm text-gray-500 mt-1">Başarıyla tamamlanan ve arşivlenen tüm projelerin listesi</p>
            </div>
            <a href="<?php echo e(route('admin.iaa-yonetim.index')); ?>" class="inline-flex items-center px-4 py-2.5 bg-white text-gray-700 font-medium text-sm rounded-lg border border-gray-300 hover:bg-gray-50 shadow-sm">
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-4xl font-bold mt-2"><?php echo e($tamamlananProjeler->total()); ?></p>
                        </div>
                    ...
                    <?php if($enIyiTakim): ?>
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold mt-2"><?php echo e($enIyiTakim['ad']); ?></p>
                                <p class="text-teal-200 text-sm font-medium"><?php echo e($enIyiTakim['proje_sayisi']); ?> proje ile</p>
                            </div>
                            <div class="bg-white bg-opacity-20 rounded-full p-4">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl border border-gray-200">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full">
                            ...
                            <tbody class="block sm:table-row-group">
                                <?php $__empty_1 = true; $__currentLoopData = $tamamlananProjeler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iaa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="block mb-6 bg-white border border-gray-200 rounded-lg shadow sm:table-row sm:mb-0 sm:shadow-none sm:border-0 sm:border-b">
                                        ...
                                        <td class="flex justify-between items-center p-4 font-semibold sm:table-cell sm:px-6 sm:py-5">
                                             ...
                                             <span class="text-sm text-gray-700">
                                                 <?php echo e($loop->iteration + ($tamamlananProjeler->currentPage() - 1) * $tamamlananProjeler->perPage()); ?>
                                        ...
                                        <td class="flex justify-between items-center p-4 border-t sm:table-cell sm:p-6 sm:border-t-0">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-xs text-gray-500 mt-1"><?php echo e($iaa->atananTakim->ad ?? 'Takım atanmamış'); ?></div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="flex justify-between items-center p-4 border-t sm:table-cell sm:p-6">
                                            ...
                                            <span class="font-medium text-gray-800 text-sm"><?php echo e($iaa->iaaTalebi ? \Carbon\Carbon::parse($iaa->iaaTalebi->start_date)->format('d.m.Y') : '-'); ?></span>
                                        </td>
                                        
                                        <td class="flex justify-between items-center p-4 border-t sm:table-cell sm:p-6">
                                            <span class="font-semibold text-xs text-gray-500 uppercase sm:hidden">Onaylanma</span>
                                            <span class="font-medium text-gray-800 text-sm"><?php echo e($iaa->onaylanma_tarihi ? \Carbon\Carbon::parse($iaa->onaylanma_tarihi)->format('d.m.Y') : '-'); ?></span>
                                        </td>
                                        ...
                                        <td class="flex justify-between items-center p-4 border-t sm:table-cell sm:p-6 sm:text-center">
                                            ...
                                            <span class="text-sm font-bold text-indigo-600"><?php echo e(number_format($iaa->puan, 0, ',', '.')); ?></span>
                                        </td>
                                        
                                        <td class="p-4 border-t sm:table-cell sm:p-6 sm:border-t-0 text-right">
                                            <a href="<?php echo e(route('proje.workspace.show', $iaa)); ?>" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50">
                ...
                <?php if($tamamlananProjeler->hasPages()): ?>
                    <div class="px-6 lg:px-8 py-4 bg-gray-50 border-t border-gray-200">
                        <?php echo e($tamamlananProjeler->links()); ?>
...
<?php endif; ?><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/admin/iaa-yonetim/arsiv.blade.php ENDPATH**/ ?>