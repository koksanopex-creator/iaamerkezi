...
<head>
    ...
    <title>İyileştirme Önerisi - <?php echo e(config('app.name', 'KÖKSAN')); ?></title>
    ...
    <div class="flex-grow container mx-auto max-w-5xl px-4 py-12 relative z-10">
        ...
        <div class="text-center mb-10 space-y-4">
            <a href="<?php echo e(url('/')); ?>" class="inline-block transition-transform hover:scale-105">
                <img src="<?php echo e(asset('storage/logos/2mIKZO0DYbIDjSJdjfN1IpO7jkTqEcSOh886xYH5.png')); ?>" class="h-16 w-auto mx-auto drop-shadow-xl" alt="Logo">
            </a>
            <div class="space-y-2">
        ...
        <div class="glass-card rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="p-6 sm:p-10">
                <form 
                    action="<?php echo e(route('guest.iaa.store')); ?>" 
                    method="POST" 
                        ...
                        <section>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="baslik" value="<?php echo e(old('baslik')); ?>" required 
                                ...
                                <div>
                                    ...
                                    <input type="text" name="ilgili_alan" value="<?php echo e(old('ilgili_alan')); ?>" required 
                                        class="modern-input block w-full px-4 py-3 rounded-xl bg-gray-50 focus:bg-white" 
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="mevcut_durum" rows="4" required 
                                        ...
                                        placeholder="Örn: Şu anda depo girişindeki lambalar yetersiz olduğu için akşam vardiyasında forklift operatörleri görüş zorluğu yaşıyor..."><?php echo e(old('mevcut_durum')); ?></textarea>
                                ...
                                <div>
                                    ...
                                    <textarea name="oneri" rows="4" 
                                        class="modern-input block w-full px-4 py-3 rounded-xl bg-gray-50 focus:bg-white resize-none" 
                                        placeholder="Örn: Mevcut halojen lambaların hareket sensörlü LED projektörlerle değiştirilmesini öneriyorum. Bu sayede hem enerji tasarrufu sağlanır hem de görüş açısı iyileşir."><?php echo e(old('oneri')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                                ...
                                                <?php if($kvkkPdfVal): ?>
                                                    <div class="mt-4 w-full h-[60vh] rounded-lg overflow-hidden border border-gray-100">
                                                        <embed src="<?php echo e(asset('storage/' . $kvkkPdfVal)); ?>#toolbar=0" type="application/pdf" class="w-full h-full">
                                                    </div>
                                                <?php else: ?>
                        ...
                        <div class="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-gray-100">
                            <a href="<?php echo e(url('/')); ?>" class="text-sm font-semibold text-gray-500 hover:text-gray-800 flex items-center transition-colors">
