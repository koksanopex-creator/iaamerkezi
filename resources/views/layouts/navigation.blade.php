                            ...
                            <div x-show="open" x-cloak x-transition.origin.top.right
                                ...
                                @if($disiplinYetkisi)
                                    ...
                                    @if(Auth::user()->hasAnyRole(['Superadmin', 'Yonetim', 'Hukuk Admini', 'Disiplin Kurulu Başkanı', 'Disiplin Kurulu Üyesi', 'Bölüm Lideri', 'Direktör']) || Auth::user()->can('disiplin.rapor.gor'))
                                        ...
                                        <x-dropdown-link :href="route('admin.reports.daily_disiplin')" class="text-rose-600 font-bold bg-rose-50/30">
            ...
            <div class="pt-2 pb-3 space-y-1 px-2">
                ...
                @if(Auth::user()->hasSikayetOrganikBagi())
                    ...
                    @if(Auth::user()->canSeeMusteriOperasyonlari() || $kullaniciSikayetTakimindaMi)
                        ...
                        <x-responsive-nav-link :href="route('admin.reports.daily_disiplin')"
                             class="text-rose-600 font-bold bg-rose-50/50">📅 GÜNLÜK DİSİPLİN RAPORU</x-responsive-nav-link>
                    @endif
