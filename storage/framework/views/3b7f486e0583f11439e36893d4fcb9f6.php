                ...
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="font-bold text-2xl text-gray-900 leading-tight">
                            <?php echo e(__('Aktif Görevlerim')); ?>
                    ...
                    <div class="flex items-center gap-3">
                        <span class="px-4 py-2 text-sm font-semibold text-indigo-700 bg-indigo-50 rounded-lg border-2 border-indigo-200">
                            <span class="text-lg font-bold"><?php echo e($projeler->total()); ?></span> Proje
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg border-2 border-gray-200 p-4">
                <div class="flex items-center justify-between text-sm">
                    <div class="flex items-center gap-2 text-gray-600">
                        ...
                        <span><strong class="text-gray-900"><?php echo e($projeler->count()); ?></strong> proje gösteriliyor</span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="p-6">
                        <div class="flex flex-col md:flex-row gap-6">
                            ...
                            <div class="flex-shrink-0">
                                <!--[if BLOCK]><![endif]--><?php if($proje->durum == 'Revize Ediliyor'): ?>
                                ...
                                <?php elseif(Str::contains($proje->durum, 'Onay')): ?>
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex flex-wrap items-center gap-2 mb-2">
                                    <span class="text-xs font-semibold px-3 py-1.5 rounded-md <?php echo e($proje->durum == 'Revize Ediliyor' ? 'bg-orange-100 text-orange-700 border border-orange-300' : 
                                    ...
                                    <span class="text-xs font-medium text-gray-600 px-3 py-1.5 bg-gray-100 rounded-md border border-gray-300">
                                        <?php echo e($proje->musteriSikayeti->sikayetKategori->ad ?? 'Genel Kategori'); ?>

                                    </span>
                                    <span class="text-xs text-gray-500 ml-auto font-mono">#<?php echo e($proje->musteriSikayeti->id ?? '-'); ?></span>
                                </div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($benimSorumlulugumda): ?>
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3">
                                                ...
                                                <p class="text-xs text-red-600 mt-0.5">
                                                    Bu projede <strong>"<?php echo e($aktifAdim->adim_tanimi ?? $aktifAdim->name ?? 'Aktif Adım'); ?>"</strong> adımını tamamlamanız bekleniyor.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="flex flex-wrap items-center gap-4 text-sm text-gray-600 mt-2">
                                    <div class="flex items-center gap-1.5">
                                        ...
                                        <span>
                                            <span class="text-gray-500">Son Güncelleme:</span> <strong class="text-gray-900"><?php echo e($proje->updated_at->diffForHumans()); ?></strong>
                                        </span>
                                    </div>
                                    
                                    <!--[if BLOCK]><![endif]--><?php if($proje->logs->isNotEmpty()): ?>
                                        <div class="hidden sm:flex items-center gap-1.5 pl-4 border-l-2 border-gray-200">
                                            ...
                                            <span class="truncate max-w-[200px]">
                                                <span class="text-gray-500">İşlemi Yapan:</span> <strong class="text-gray-900"><?php echo e($proje->logs->first()->user->name ?? 'Sistem'); ?></strong>
                                            </span>
                                        </div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                            ...
                            <div class="flex flex-row md:flex-col gap-2 justify-center md:justify-start border-t md:border-t-0 md:border-l-2 border-gray-200 pt-4 md:pt-0 md:pl-6 mt-4 md:mt-0">
                                <a href="<?php echo e(route('proje.workspace.show', $proje->id)); ?>" class="flex-1 md:flex-none inline-flex items-center justify-center px-4 py-2.5 bg-indigo-600 text-white text-sm font-semibold rounded-lg hover:bg-indigo-700 transition-colors whitespace-nowrap shadow-sm">
                                    Çalışma Alanı
                                    <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                                </a>
                                
                                <!--[if BLOCK]><![endif]--><?php if($proje->musteriSikayeti): ?>
                                    <a href="<?php echo e(route('admin.sikayetler.show', $proje->musteriSikayeti->id)); ?>" class="flex-1 md:flex-none inline-flex items-center justify-center px-4 py-2.5 bg-white text-gray-700 text-sm font-semibold rounded-lg border-2 border-gray-300 hover:bg-gray-50 hover:border-gray-400 transition-colors whitespace-nowrap">
                                        Şikayet Detayı
                                    </a>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
