...
<?php $component->withAttributes([]); ?>
    ...
    <form action="<?php echo e(route('public.sikayet.update', ['token' => $sikayet->takip_token])); ?>" method="POST" enctype="multipart/form-data" x-data="fileUploadComponent()">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
            ...
            <div class="group col-span-1">
                ...
                <input type="text" name="musteri_adi" id="musteri_adi" value="<?php echo e(old('musteri_adi', $sikayet->musteri_adi)); ?>" required class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500" placeholder="Adınız ve Soyadınız">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="group col-span-1">
                ...
                <input type="email" name="musteri_iletisim" id="musteri_iletisim" value="<?php echo e(old('musteri_iletisim', $sikayet->musteri_iletisim)); ?>" required class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500" placeholder="ornek@mail.com">
            ...
            <div class="group col-span-1 md:col-span-2">
                ...
                <div class="mt-2 flex items-center space-x-6">
                    <label class="inline-flex items-center cursor-pointer">
                        <input type="radio" name="konum_tipi" value="Yurt İçi" class="form-radio text-red-600 focus:ring-red-500" <?php echo e(old('konum_tipi', $sikayet->konum_tipi) == 'Yurt İçi' ? 'checked' : ''); ?>>
                        <span class="ml-2 text-sm text-gray-700">Yurt İçi</span>
                    </label>
                    <label class="inline-flex items-center cursor-pointer">
                        <input type="radio" name="konum_tipi" value="Yurt Dışı" class="form-radio text-red-600 focus:ring-red-500" <?php echo e(old('konum_tipi', $sikayet->konum_tipi) == 'Yurt Dışı' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-span-1 md:col-span-2 group">
                ...
                <input type="text" name="musteri_sikayet_konusu" id="musteri_sikayet_konusu" value="<?php echo e(old('musteri_sikayet_konusu', $sikayet->musteri_sikayet_konusu)); ?>" required class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500 transition duration-150 ease-in-out pl-4 pr-4 py-2.5 text-gray-900" placeholder="Sorunu kısaca özetleyin">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-span-1 md:col-span-2 group">
                ...
                <textarea name="musteri_sikayet_detayi" id="musteri_sikayet_detayi" rows="5" required class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500 transition duration-150 ease-in-out pl-4 pr-4 py-3 text-gray-900 resize-y" placeholder="Lütfen yaşadığınız sorunu tüm detaylarıyla açıklayınız..."><?php echo e(old('musteri_sikayet_detayi', $sikayet->musteri_sikayet_detayi)); ?></textarea>
            ...
            <div class="col-span-1 md:col-span-2 group space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-2 space-y-2 p-4 bg-gray-50 border border-gray-200 rounded-lg">
                        ...
                        <label for="dosya_sil_<?php echo e($dosya->id); ?>" class="flex items-center text-sm text-gray-700 hover:bg-red-50 p-2 rounded transition-colors cursor-pointer">
                            <input type="checkbox" name="dosyalar_sil[]" id="dosya_sil_<?php echo e($dosya->id); ?>" value="<?php echo e($dosya->id); ?>" class="h-4 w-4 text-red-600 border-gray-300 rounded focus:ring-red-500">
                            ...
                            <span class="truncate"><?php echo e($dosya->orijinal_adi); ?></span>
                            <a href="<?php echo e(asset('storage/'. $dosya->dosya_yolu)); ?>" target="_blank" class="ml-auto text-xs text-blue-500 hover:underline">(Görüntüle)</a>
                        </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <?php $__errorArgs = ['dosyalar_sil.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
            <a href="<?php echo e(route('public.sikayet.show', ['token' => $sikayet->takip_token])); ?>" class="inline-flex items-center px-5 py-2.5 border border-gray-300 rounded-lg font-medium text-sm text-gray-700 bg-white hover:bg-gray-50 transition duration-150 ease-in-out">
...
<?php endif; ?><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/public/sikayet/sikayet-edit.blade.php ENDPATH**/ ?>