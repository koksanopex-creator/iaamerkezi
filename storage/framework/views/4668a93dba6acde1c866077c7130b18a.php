    ...
    <div
        ...
        <div class="flex flex-wrap gap-3 items-center">
            ...
            <div class="flex items-center bg-gray-100 p-1 rounded-xl border border-gray-200 shadow-inner mr-2">
                <a href="<?php echo e(route('admin.sikayetler.export-excel', $this->exportParams)); ?>" 
                ...
                <a href="<?php echo e(route('admin.sikayetler.export-pdf', $this->exportParams)); ?>" 
            ...
            <div class="flex items-center bg-gray-100 p-1 rounded-xl border border-gray-200 shadow-inner mr-2">
                ...
                <button wire:click="setViewMode('card')"
                    class="p-2 rounded-lg transition-all flex items-center gap-2 <?php echo e($viewMode === 'card' ? 'bg-white text-indigo-600 shadow-sm ring-1 ring-gray-200 font-bold' : 'text-gray-400 hover:text-gray-600'); ?>"
                    title="Kart Görünümü">
                ...
                <button wire:click="setViewMode('list')"
                    class="p-2 rounded-lg transition-all flex items-center gap-2 <?php echo e($viewMode === 'list' ? 'bg-white text-indigo-600 shadow-sm ring-1 ring-gray-200 font-bold' : 'text-gray-400 hover:text-gray-600'); ?>"
            ...
            <!--[if BLOCK]><![endif]--><?php if(count($selectedSikayetler) > 0): ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('deleteAny', \App\Models\MusteriSikayeti::class)): ?>
                    <button type="button" wire:click="confirmBulkDelete"
                        ...
                        Seçilenleri Sil (<?php echo e(count($selectedSikayetler)); ?>)
                    </button>
                <?php endif; ?>
            ...
            <?php endif; ?>
            <!--[if BLOCK]><![endif]--><?php if (\Illuminate\Support\Facades\Blade::check('role', 'Superadmin|Müşteri Şikayeti Kurulu|Müşteri Şikayeti Kurulu - Yurt İçi|Müşteri Şikayeti Kurulu - Yurt Dışı|Müşteri Şikayeti Kurulu Yöneticisi|Müşteri Şikayeti Kurulu Yöneticisi - Yurt İçi|Müşteri Şikayeti Kurulu Yöneticisi - Yurt Dışı')): ?>
