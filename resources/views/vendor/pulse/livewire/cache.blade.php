                    ...
                    <x-pulse::table>
                        ...
                        <x-pulse::thead>
                            <tr>
                                ...
                                <x-pulse::th class="text-right">İsabet</x-pulse::th>
                                <x-pulse::th class="text-right">Kaçan</x-pulse::th>
                                <x-pulse::th class="text-right whitespace-nowrap">İsabet Oranı</x-pulse::th>
                            </tr>
                        </x-pulse::thead>
                        <tbody>
