...
class DisiplinKuruluToplanti extends Model
{
    ...
    protected $fillable = [
        ...
        'active_widgets', 'toplanti_karari', 'karar_dosya_yolu', 'davet_maili_gonderildi'
    ];
    ...
    public function disiplinDosyasi()
    {
        // Geriye dönük uyumluluk için ilk dosyayı döner
        return $this->disiplinDosyalari()->one();
    }

    public function disiplinDosyalari(): BelongsToMany
    {
        return $this->belongsToMany(DisciplinaryCase::class, 'disiplin_case_toplanti', 'toplanti_id', 'case_id');
    }
