        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="font-bold text-gray-900">{{ $case->user->name }}</p>
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500">Raporlayan: {{ $case->reporter->name }}</p>
                </div>
            </div>
        </div>
            ...
            @else
                <div class="flex flex-wrap gap-3">
                    @foreach($case->kanit_dosyalari as $kanit)
                        <a href="{{ asset('storage/'.$kanit) }}" target="_blank" class="group flex items-center gap-2 px-3 py-2 bg-white border border-gray-300 rounded-lg hover:border-indigo-500 hover:shadow-sm transition">
