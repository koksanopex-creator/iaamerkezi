                            ...
                            <td class="px-6 py-4">
                                <?php if($task['type'] == 'Müşteri Şikayeti'): ?>
                                    <div class="flex flex-col items-center gap-1.5 w-[130px]">
                                        ...
                                        <?php if(isset($task['is_customer_entry']) && $task['is_customer_entry']): ?>
                                ...
                                <?php else: ?>
                                    <span class="inline-flex justify-center items-center w-[130px] bg-gray-50 text-gray-600 border border-gray-200/60 text-[10px] font-black px-3 py-1.5 rounded-xl uppercase tracking-wider shadow-sm transition-all"><?php echo e(strtoupper($task['type'])); ?></span>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4">
...
</div><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/dashboard/partials/yonetim.blade.php ENDPATH**/ ?>