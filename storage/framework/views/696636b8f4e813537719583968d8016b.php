<div>
        ...
        <form wire:submit="save" id="main-form">
                        ...
                        <div class="border-t border-gray-200 pt-6">
                            <!--[if BLOCK]><![endif]--><?php switch($widget['type']):
                                ...
                                <?php case ('user_select'): ?>
                                    ...
                                    <?php break; ?>
                                <?php case ('user_select_info'): ?>
                                    <?php $widgetData['isLockedForUser'] = $isLockedForUser; ?>
                                    <?php echo $__env->make('livewire.project.widgets._user-select-info', $widgetData, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                    <?php break; ?>
            ...
            <div class="mt-8 flex justify-end items-center gap-3 border-t pt-6">
                ...
                <button type="submit"
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(!$isButtonDisabled): ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($isNotificationModalOpen): ?>
                        ...
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="bg-gray-50 p-3 rounded text-sm text-gray-700 whitespace-pre-wrap border"><?php echo e($notificationDraft); ?></div>
