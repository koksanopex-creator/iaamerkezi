<div class="mt-6">
        ...
        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6 shadow-sm">
            ...
            <form action="<?php echo e(route('disiplin.defense.store', $case->id)); ?>" method="POST" enctype="multipart/form-data"
                ...
                <div class="mb-4">
                    ...
                    <textarea name="savunma_aciklamasi" rows="4" class="w-full border-gray-300 rounded-md shadow-sm focus:border-yellow-500 focus:ring-yellow-500" placeholder="Olayla ilgili açıklamanızı buraya yazınız..." required><?php echo e(old('savunma_aciklamasi')); ?></textarea>
                </div>
                <div class="mb-6">
    ...
    <?php elseif($case->savunma_tarihi): ?>
        <div class="bg-white border-t-4 border-blue-500 rounded-lg shadow p-6 mb-6">
            ...
            <div class="bg-gray-50 p-4 rounded text-sm text-gray-800 italic border border-gray-200 mb-4">
                "<?php echo e($case->savunma_aciklamasi); ?>"
            </div>
                    ...
                    <?php $__currentLoopData = $case->savunma_dosyalari; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dosya): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <a href="<?php echo e($url); ?>" target="_blank" class="group relative border rounded-lg overflow-hidden bg-white hover:shadow-md transition block">
                            ...
                            <div class="p-2 border-t bg-white">
                                <p class="text-[10px] text-gray-500 truncate font-medium" title="<?php echo e(basename($dosya)); ?>"><?php echo e(basename($dosya)); ?></p>
                            </div>
                        </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
