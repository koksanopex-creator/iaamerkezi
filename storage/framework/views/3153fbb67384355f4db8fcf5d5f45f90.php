    ...
    <form method="POST" action="<?php echo e(route('public.sikayet.guestLogin', ['token' => $sikayet->takip_token])); ?>">
        ...
        <div class="space-y-6">
            ...
            <div class="group">
                ...
                <input type="email" name="email" id="email" value="<?php echo e(old('email', $sikayet->musteri_iletisim)); ?>" 
...
<?php endif; ?><?php /**PATH /var/www/kys_koksan/iaa/resources/views/public/sikayet/sikayet-login.blade.php ENDPATH**/ ?>