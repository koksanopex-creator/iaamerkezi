...
<?php if($bekleyenSavunmalar->isNotEmpty()): ?>
    <div class="mb-8 space-y-4">
        <?php $__currentLoopData = $bekleyenSavunmalar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dosya): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="relative bg-white rounded-xl shadow-lg border border-red-200 overflow-hidden group">
                ...
                <div class="p-6 relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-2 text-sm text-gray-600">
                                ...
                                <p class="mt-0.5 text-xs text-gray-500">
                                    <?php echo e(Str::limit($dosya->behavior->tanim ?? 'İhlal tanımı bulunamadı.', 60)); ?>
                            ...
                            <div class="mt-3 flex items-center gap-4 text-xs font-medium text-gray-500">
                                <div class="flex items-center gap-1 bg-white px-2 py-1 rounded border border-gray-200 shadow-sm">
                                    ...
                                    Olay: <?php echo e($dosya->olay_tarihi->format('d.m.Y')); ?>

                                </div>
                                <div class="flex items-center gap-1 text-red-600">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                    Bekleme Süresi: <?php echo e($dosya->created_at->diffForHumans()); ?>
                    ...
                    <div class="w-full md:w-auto flex-shrink-0">
                        <a href="<?php echo e(route($hedefRota, $dosya->id)); ?>" class="group/btn relative w-full md:w-auto inline-flex items-center justify-center gap-2 bg-gray-900 hover:bg-red-600 text-white px-6 py-3 rounded-lg font-bold shadow-lg transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
                        ...
                        <p class="text-[10px] text-center mt-2 text-gray-400">Dosya #<?php echo e($dosya->id); ?></p>
                    </div>
...
<?php endif; ?><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/dashboard/partials/disciplinary-waiting.blade.php ENDPATH**/ ?>