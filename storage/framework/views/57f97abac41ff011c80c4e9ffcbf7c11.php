...
[$__name, $__params] = $__split('project.plan-visit', ['iaa' => $iaa, 'embedded' => true, 'isStepEnd' => true]);
        ...
        <div class="mt-8 mb-8 bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
            ...
            <div class="p-6">
                ...
                <?php if($iaa->musteriSikayeti): ?>
                    ...
                    <div x-data="{ iadeVar: <?php echo e($iadeVarMi); ?>, ziyaretVar: <?php echo e($genelZiyaretVarMi); ?> }" @visit-synced.window="ziyaretVar = true">
                            ...
                            <div class="flex items-center justify-between bg-indigo-50/50 p-4 transition-colors hover:bg-indigo-50">
                                ...
                                <template x-if="ziyaretVar">
                                    <div 
                                        ...
                                        :class="{ 
                                            'text-green-600 cursor-pointer hover:text-green-700': !(<?php echo e(($genelZiyaret && $genelZiyaret->status === 'Tamamlandı') ? 'true' : 'false'); ?>),
                                            'text-green-500 opacity-75 cursor-not-allowed': <?php echo e(($genelZiyaret && $genelZiyaret->status === 'Tamamlandı') ? 'true' : 'false'); ?>

                                        }"
                                        <?php if(!($genelZiyaret && $genelZiyaret->status === 'Tamamlandı')): ?>
                                            @click="ziyaretVar = false"
                                        <?php endif; ?>
                                    >
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/></svg>
                                        Planlandı<?php echo e(($genelZiyaret && $genelZiyaret->status === 'Tamamlandı') ? '' : ' (Kilidi Aç)'); ?>
