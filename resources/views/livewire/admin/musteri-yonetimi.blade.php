                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    @forelse($customers as $customer)
                        <tr class="hover:bg-gray-50/80 transition-colors duration-150">
                                ...
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-12 w-12 mr-4 relative group">
                                        @if($customer->logo_path)
                                            <img class="h-12 w-12 rounded-xl object-cover border border-gray-200 shadow-sm group-hover:scale-105 transition-transform duration-200" src="{{ asset('storage/'.$customer->logo_path) }}" alt="">
                                        @else
                            ...
                            {{-- 2. KONUM --}}
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-semibold {{ $customer->location_type == 'Yurt İçi' ? 'bg-blue-50 text-blue-700 border border-blue-100' : 'bg-purple-50 text-purple-700 border border-purple-100' }}">
                                    @if($customer->location_type == 'Yurt İçi')
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-col space-y-1">
                                    ...
                                    <div class="flex items-start text-xs text-gray-500 truncate max-w-[200px]" title="{{ $customer->address }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-gray-100 text-gray-700 border border-gray-200">
                                    {{ $customer->representatives_count }}
                                </span>
                            </td>
                ...
                <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full">
                    <form wire:submit.prevent="{{ $isEditMode ? 'update' : 'store' }}">
                        ...
                        <div class="px-6 py-6 space-y-6">
                            ...
                            {{-- Yetkili Kişi (Sadece Ekleme Modunda) --}}
                            @if(!$isEditMode)
                                            ...
                                            @else
                                                ...
                                                <td class="px-6 py-4 text-right whitespace-nowrap">
                                                    <div class="flex justify-end space-x-2">
                                                        ...
                                                        <button 
                                                            wire:click="deleteRepresentative({{ $rep->id }})" 
