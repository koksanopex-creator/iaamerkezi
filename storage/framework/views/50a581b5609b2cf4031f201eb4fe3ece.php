...
<?php $component->withAttributes([]); ?>
    <?php $__env->startPush('pageTitle', 'Yeni Tutanak Oluştur | '); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Yeni Disiplin Tutanağı Oluştur')); ?>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <form action="<?php echo e(route('admin.disiplin.store')); ?>" method="POST" enctype="multipart/form-data"
                    x-data="{ 
                        selectedCategory: '', 
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <select name="user_id" id="user_id" class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 select2-searchable" required>
                                    ...
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($user->id); ?>" <?php echo e(old('user_id') == $user->id ? 'selected' : ''); ?>>
                                            <?php echo e($user->name); ?> (<?php echo e($user->bolum->ad ?? 'Bölümsüz'); ?>)
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div>
                                ...
                                <input type="date" name="olay_tarihi" value="<?php echo e(old('olay_tarihi')); ?>" class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            </div>
                        </div>
                    </div>
                            ...
                            <div>
                                ...
                                <select name="impact_id" class="w-full border-gray-300 rounded-md shadow-sm text-sm" required>
                                    ...
                                    <?php $__currentLoopData = $impacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($i->id); ?>" <?php echo e(old('impact_id') == $i->id ? 'selected' : ''); ?>><?php echo e($i->tanim); ?> (x<?php echo e($i->puan); ?>)</option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="scope_id" class="w-full border-gray-300 rounded-md shadow-sm text-sm" required>
                                    ...
                                    <?php $__currentLoopData = $scopes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($s->id); ?>" <?php echo e(old('scope_id') == $s->id ? 'selected' : ''); ?>><?php echo e($s->tanim); ?> (x<?php echo e($s->puan); ?>)</option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="olay_aciklamasi" rows="5" class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required><?php echo e(old('olay_aciklamasi')); ?></textarea>
                    </div>
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 hover:bg-gray-50 transition relative bg-white">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-2" x-show="files.length > 0">
                                <template x-for="(file, index) in files" :key="index">
                                    <div class="relative group border rounded-lg overflow-hidden bg-gray-50 shadow-sm z-20"> 
                    ...
                    <div class="flex justify-end gap-4 pt-4 border-t border-gray-200">
                        <a href="<?php echo e(route('admin.disiplin.index')); ?>" class="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-md font-semibold hover:bg-gray-50 transition">İptal</a>
                        <button type="submit" 
...
<?php endif; ?><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/admin/disiplin/create.blade.php ENDPATH**/ ?>