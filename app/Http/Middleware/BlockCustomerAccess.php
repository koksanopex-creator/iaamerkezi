    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (Auth::check() && Auth::user()->customer_id) {
            ...
            $allowedRoutes = [
                ...
                'dashboard.switch-customer',
                'iaa.hatirlatmalarim.index',
                'iaa.hatirlatmalarim.show',
                'admin.sikayet-hatirlatma.yorum',
                'admin.sikayet-hatirlatma.yorumGuncelle',
                'admin.sikayet-hatirlatma.yorumSil',
                'iaa.hatirlatmalarim.dashboardGonder',
                'admin.sikayet-hatirlatma.iknaOldu',
                'proje.workspace.show',
                'proje.export.pdf',
                'proje.export.excel'
            ];
