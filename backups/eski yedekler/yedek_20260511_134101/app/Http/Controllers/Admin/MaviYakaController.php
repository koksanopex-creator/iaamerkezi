...
class MaviYakaController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        // Bölüm lideriyse sadece kendi bölümüne ekleyebilir
        if ($user->hasRole('Bölüm Lideri') && !$user->hasRole('Superadmin') && !$user->hasRole('Hukuk Admini'))
        {
    ...
    public function store(Request $request)
    {
        ...
        // Bölüm doğrulama kuralları (Lider sadece kendi bölümüne ekleyebilir)
        $bolumIds = $user->hasRole('Bölüm Lideri') && !$user->hasRole('Superadmin') && !$user->hasRole('Hukuk Admini')
            ? [$user->bolum_id]
    ...
    public function edit(User $maviYaka)
    {
        ...
        // Bölüm lideriyse ve personelin bölümü kendisinden farklıysa engel ol
        if ($user->hasRole('Bölüm Lideri') && !$user->hasRole('Superadmin') && !$user->hasRole('Hukuk Admini'))
        {
    ...
    public function update(Request $request, User $maviYaka)
    {
        ...
        // Bölüm lideriyse yetkisini kontrol et
        if ($user->hasRole('Bölüm Lideri') && !$user->hasRole('Superadmin') && !$user->hasRole('Hukuk Admini'))
        {
            if ($maviYaka->bolum_id != $user->bolum_id)
            {
    ...
    public function export(Request $request)
    {
        ...
        // Bölüm lideriyse sadece kendi bölümündekileri görebilir
        if ($user->hasRole('Bölüm Lideri') && !$user->hasRole('Superadmin') && !$user->hasRole('Hukuk Admini'))
        {
    ...
    public function resign(User $maviYaka)
    {
        ...
        // Yetki kontrolü (Daha önce destroy'da vardı, buraya da ekleyelim)
        if ($user->hasRole('Bölüm Lideri') && !$user->hasRole('Superadmin') && !$user->hasRole('Hukuk Admini'))
        {
            if ($maviYaka->bolum_id != $user->bolum_id)
            {
