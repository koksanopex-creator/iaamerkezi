...
<?php $component->withAttributes([]); ?>
    ...
    <?php if($sikayet->iaaProjesi): ?>
        ...
        <div class="border border-<?php echo e($pRenk); ?>-200 rounded-xl p-6 bg-<?php echo e($pRenk); ?>-50 shadow-sm flex items-center justify-between">
            <div class="flex items-center gap-4">
                <div class="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-sm text-<?php echo e($pRenk); ?>-600">
                    <?php if($pDurum == 'Bölüm Onayı Bekliyor'): ?>
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                    <?php elseif($pDurum == 'Yönetici Onayı Bekliyor'): ?>
                ...
                <div>
                    ...
                    <?php if($pDurum == 'Bölüm Onayı Bekliyor'): ?>
                        <p class="text-xs text-<?php echo e($pRenk); ?>-700 mt-1">Bölüm yöneticisi onayı bekleniyor.</p>
                    <?php elseif($pDurum == 'Yönetici Onayı Bekliyor'): ?>
                        <p class="text-xs text-<?php echo e($pRenk); ?>-700 mt-1">Üst yönetici onayı bekleniyor.</p>
                    <?php endif; ?>
                </div>
            </div>
            <a href="<?php echo e(route('proje.workspace.show', $sikayet->iaaProjesi->id)); ?>" target="_blank" class="hidden sm:inline-flex items-center px-4 py-2 bg-white border border-<?php echo e($pRenk); ?>-300 rounded-lg text-sm font-medium text-<?php echo e($pRenk); ?>-700 hover:bg-white/50 transition-colors">
...
<?php endif; ?>
                                ...
                                <dl class="divide-y divide-gray-100">
                                    ...
                                    <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4">
                                        ...
                                        <dd class="mt-2 text-sm text-gray-900 sm:mt-0 sm:col-span-2 font-medium">
                                            <?php echo e($sikayet->musteri_iletisim ?? 'Belirtilmemiş'); ?>
                                        ...
                                        <?php $__currentLoopData = $sikayet->dosyalar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dosya): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="relative group bg-gray-100 rounded-lg overflow-hidden border">
                                                <?php if(Str::startsWith($dosya->mime_tipi, 'image/')): ?>
                                                    <a href="<?php echo e($fullAssetUrl); ?>" data-fancybox="gallery" data-caption="<?php echo e($dosya->orijinal_adi); ?>">
                                                        <img src="<?php echo e($fullAssetUrl); ?>" alt="<?php echo e($dosya->orijinal_adi); ?>" class="object-cover h-24 w-full group-hover:opacity-75 transition-opacity">
                                                    </a>
                                                <?php else: ?>
                                                    <a href="<?php echo e($fullAssetUrl); ?>" target="_blank" class="flex flex-col items-center justify-center h-24 bg-gray-200 p-2 group-hover:bg-gray-300 transition-colors">
                                                        ...
                                                        <p class="text-xs text-gray-500 mt-1 truncate w-full text-center"><?php echo e($dosya->orijinal_adi); ?></p>
                                                    </a>
                                                <?php endif; ?>
                                    ...
                                    <div class="pt-3 border-t border-gray-100">
                                        ...
                                        <dd class="text-sm">
                                            <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium bg-indigo-100 text-indigo-800">
                                                ...
                                                <?php echo e($sikayet->cozumTakimi->ad ?? 'Atanmadı'); ?>
                    ...
                    <!-- Çözüm Notları -->
                    <?php if($sikayet->musteri_cozum_notlari): ?>
                    <div class="mt-6 border border-green-200 rounded-xl p-6 bg-gradient-to-br from-green-50 to-white shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="text-sm text-gray-800 bg-white rounded-lg p-4 border border-green-100">
                            <?php echo nl2br(e($sikayet->musteri_cozum_notlari)); ?>
