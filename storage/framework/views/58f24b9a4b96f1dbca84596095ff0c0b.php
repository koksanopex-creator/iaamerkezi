<div x-show="activeTab === 'sikayetler'" class="space-y-4" x-data="{ limit: 5, total: <?php echo e($girilenSikayetler->count()); ?> }">
    <h3 class="text-lg font-bold text-gray-800 flex items-center gap-2">
        ...
        <span class="bg-gray-100 text-gray-600 py-0.5 px-2.5 rounded-full text-xs font-bold border border-gray-200">
            <?php echo e($girilenSikayetler->count()); ?>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $girilenSikayetler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sikayet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr x-show="<?php echo e($loop->index); ?> < limit" x-transition>
                        <td class="px-6 py-4 text-sm text-gray-400 font-medium"><?php echo e($loop->iteration); ?></td>
                        <td class="px-6 py-4 text-sm">
                            <a href="<?php echo e(route('admin.sikayetler.show', $sikayet->id)); ?>" class="font-bold text-indigo-700 hover:text-indigo-900 hover:underline transition-colors">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-900 font-bold">
                            <?php echo e($sikayet->kazanilan_puan > 0 ? '+' . $sikayet->kazanilan_puan : '0'); ?></td>
    ...
    <?php if($girilenSikayetler->count() > 5): ?>
    ...
    <?php endif; ?>
</div><?php /**PATH /var/www/kys_koksan/iaa/resources/views/profile/partials/show/tab-complaints.blade.php ENDPATH**/ ?>