                    ...
                    <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs md:text-sm text-indigo-100 mt-0.5">Toplam {{ $kategoriler->count() }} kategori</p>
                            </div>
                        </div>
                        <a href="{{ route('admin.sikayet-kategorileri.create') }}" 
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <span class="font-semibold text-gray-900">{{ $kategori->ad }}</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right">
                                        <div class="flex justify-end items-center gap-2">
                                            <a href="{{ route('admin.sikayet-kategorileri.edit', $kategori) }}" 
                                            ...
                                            <form action="{{ route('admin.sikayet-kategorileri.destroy', $kategori) }}" method="POST" onsubmit="return confirm('Bu kategoriyi silmek istediğinizden emin misiniz?');">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" 
                    ...
                    @forelse ($kategoriler as $kategori)
                        <div class="p-4 hover:bg-gray-50 transition-colors duration-150">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex items-center gap-3 flex-1">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h4 class="font-semibold text-gray-900 text-base truncate">{{ $kategori->ad }}</h4>
                            ...
                            <div class="flex gap-2 pl-13">
                                ...
                                <form action="{{ route('admin.sikayet-kategorileri.destroy', $kategori) }}" method="POST" onsubmit="return confirm('Bu kategoriyi silmek istediğinizden emin misiniz?');" class="flex-1">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" 
