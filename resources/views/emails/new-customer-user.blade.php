                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="color: #333; margin-top: 0; font-size: 20px;">Hoş Geldiniz, Sayın {{ $user->name }}</h2>
                            <p style="color: #555; line-height: 1.6; font-size: 16px;">
                                {!! nl2br(e($customBody)) !!}
                            </p>
                            
                            <div style="background-color: #f8f9fa; border-left: 4px solid #0056b3; padding: 20px; margin: 25px 0;">
                                <p style="margin: 0 0 10px 0; font-size: 15px;"><strong>E-posta:</strong> <span style="color: #0056b3;">{{ $user->email }}</span></p>
                                <p style="margin: 0; font-size: 15px;"><strong>Geçici Şifre:</strong> <span style="color: #d9534f; font-family: monospace; font-size: 17px;">{{ $plainPassword }}</span></p>
                            </div>

                            <div align="center" style="margin: 35px 0;">
                                <a href="{{ url('/iaa/login') }}" style="background-color: #0056b3; color: #ffffff; padding: 15px 35px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">
                                    Portala Giriş Yap
                                </a>
                            </div>
