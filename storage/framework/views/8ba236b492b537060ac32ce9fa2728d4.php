                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            <?php $__empty_1 = true; $__currentLoopData = $cozumTakimlari; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $takim): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-blue-50/30 transition-colors duration-150 group"> 
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="<?php echo e(route('admin.cozum-takimlari.show', ['cozumTakimi' => $takim->id])); ?>" class="font-semibold text-gray-900 group-hover:text-blue-700 transition-colors hover:underline block w-full h-full"><?php echo e($takim->ad); ?></a>
                                    </td>
                                    <td class="px-6 py-4">
                                        <?php if($takim->lider): ?>
                                            <a href="<?php echo e(route('profile.show', $takim->lider->id)); ?>" target="_blank" class="flex items-center gap-2 group">
                                                
                                                <?php if($takim->lider->profile_photo_path): ?>
                                                    <img class="h-8 w-8 rounded-full object-cover border border-gray-200 group-hover:border-indigo-500 transition-colors shadow-sm" src="<?php echo e(asset('storage/' . $takim->lider->profile_photo_path)); ?>" alt="<?php echo e($takim->lider->name); ?>">
                                                <?php else: ?>
                                                    <div class="w-8 h-8 rounded-full bg-gradient-to-br from-blue-400 to-cyan-500 flex items-center justify-center text-white font-semibold text-xs shadow group-hover:from-blue-500 group-hover:to-cyan-600 transition-all">
                                                        <?php echo e(strtoupper(substr($takim->lider->name, 0, 1))); ?>

                                                    </div>
                                                <?php endif; ?>
                                                <span class="text-sm font-medium text-gray-700 group-hover:text-indigo-600 hover:underline transition-colors"><?php echo e($takim->lider->name); ?></span>
                                            </a>
                                        <?php else: ?>
                            ...
                            <div class="space-y-2.5 mb-3 pl-13">
                                ...
                                <div class="flex items-start gap-2">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <?php if($takim->lider): ?>
                                            <a href="<?php echo e(route('profile.show', $takim->lider->id)); ?>" target="_blank" class="flex items-center gap-2 mt-1 group">
                                                <?php if($takim->lider->profile_photo_path): ?>
                                                    <img class="w-6 h-6 rounded-full object-cover border border-gray-200 group-hover:border-indigo-500 transition-colors" src="<?php echo e(asset('storage/' . $takim->lider->profile_photo_path)); ?>" alt="<?php echo e($takim->lider->name); ?>">
                                                <?php else: ?>
                                                ...
                                                <?php endif; ?>
                                                <span class="text-sm text-gray-700 font-medium truncate group-hover:text-indigo-600 hover:underline transition-colors"><?php echo e($takim->lider->name); ?></span>
                                            </a>
                                        <?php else: ?>
...
<?php /**PATH /var/www/kys_koksan/iaa/resources/views/admin/cozum_takimlari/index.blade.php ENDPATH**/ ?>