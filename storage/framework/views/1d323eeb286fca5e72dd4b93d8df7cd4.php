...
<div class="py-12 bg-gray-50 min-h-screen">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <!--[if BLOCK]><![endif]--><?php if($secilenBolumId): ?>
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-300">
                    <div class="bg-gradient-to-r from-blue-50 to-white px-6 py-4 border-b border-blue-100 flex items-center justify-between">
                        ...
                        <span class="bg-blue-100 text-blue-700 text-xs font-bold px-2.5 py-0.5 rounded-full"><?php echo e(count($tanimlar['urun_grubu'] ?? [])); ?></span>
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['yeniTanim.urun_grubu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs block -mt-4 mb-4"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <ul class="space-y-2 max-h-[400px] overflow-y-auto custom-scrollbar pr-1">
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $tanimlar['urun_grubu'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <li class="group flex items-center justify-between p-3 rounded-lg bg-gray-50 border border-gray-100 hover:bg-blue-50 hover:border-blue-200 transition-all duration-200">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($duzenlenenId === $item->id): ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <span class="text-sm text-gray-700 font-medium"><?php echo e($item->deger); ?></span>
                                        <div class="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <button wire:click="duzenle(<?php echo e($item->id); ?>)" class="text-gray-400 hover:text-indigo-600 transition-colors" title="Düzenle">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/></svg>
                                            </button>
                                            <button wire:click="sil(<?php echo e($item->id); ?>)" wire:confirm="Bu tanımı silmek istediğinize emin misiniz?" class="text-gray-400 hover:text-red-600 transition-colors" title="Sil">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-300">
                    <div class="bg-gradient-to-r from-red-50 to-white px-6 py-4 border-b border-red-100 flex items-center justify-between">
                        ...
                        <span class="bg-red-100 text-red-700 text-xs font-bold px-2.5 py-0.5 rounded-full"><?php echo e(count($tanimlar['iade_sebebi'] ?? [])); ?></span>
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['yeniTanim.iade_sebebi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs block -mt-4 mb-4"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <ul class="space-y-2 max-h-[400px] overflow-y-auto custom-scrollbar pr-1">
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $tanimlar['iade_sebebi'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-300">
                    <div class="bg-gradient-to-r from-green-50 to-white px-6 py-4 border-b border-green-100 flex items-center justify-between">
                        ...
                        <span class="bg-green-100 text-green-700 text-xs font-bold px-2.5 py-0.5 rounded-full"><?php echo e(count($tanimlar['birim'] ?? [])); ?></span>
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['yeniTanim.birim'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs block -mt-4 mb-4"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <ul class="space-y-2 max-h-[400px] overflow-y-auto custom-scrollbar pr-1">
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $tanimlar['birim'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
</div><?php /**PATH /var/www/kys_koksan/iaa/resources/views/livewire/admin/iade-tanimlari-yonetimi.blade.php ENDPATH**/ ?>