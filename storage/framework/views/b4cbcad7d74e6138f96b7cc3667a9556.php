<div class="bg-white rounded-t-xl shadow-sm border-b border-gray-200 px-4">
    <nav class="-mb-px flex space-x-8" aria-label="Tabs">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('arabuluculuk.tab_genel_view')): ?>
        ...
        <?php if(auth()->user()->can('arabuluculuk.tab_genel_view') || auth()->user()->hasRole('Superadmin')): ?>
        ...
        <?php if($case->board_required && auth()->user()->can('arabuluculuk.tab_kurul_view')): ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('arabuluculuk.tab_log_view')): ?>
...
</div><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/admin/arabuluculuk/parcalar/sekme-menusu.blade.php ENDPATH**/ ?>