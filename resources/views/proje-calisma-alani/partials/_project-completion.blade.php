        ...
        <div class="mt-8 mb-8 p-6 bg-blue-50 border border-blue-200 rounded-xl flex items-center gap-4 animate-fade-in-up">
            ...
            <div>
                ...
                <p class="text-sm text-blue-700">
                    Tüm adımlar tamamlandı. Proje Lideri ({{ $iaa->atananTakim->lider->name ?? 'Lider' }}) kapanış işlemini gerçekleştirecektir.
                </p>
            </div>
        </div>
