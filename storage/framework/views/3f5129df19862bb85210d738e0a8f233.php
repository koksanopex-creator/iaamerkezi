<?php if(isset($stats['lider_takim'])): ?>
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-8">
        ...
        <a href="<?php echo e(route('takimlar.show', $stats['lider_takim']->id)); ?>" class="group relative bg-gradient-to-br from-green-50 to-emerald-50 border border-green-100 rounded-2xl p-6 overflow-hidden block hover:shadow-xl transition-all">
            ...
            <div class="relative">
                ...
                <div class="flex items-end gap-2 mb-4">
                    <p class="text-4xl font-black text-gray-900"><?php echo e($stats['cozulen_projeler_count']); ?></p>
