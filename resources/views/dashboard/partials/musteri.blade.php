                            ...
                            <tr class="hover:bg-gray-50 transition-colors group">
                                ...
                                <td class="px-5 py-3 whitespace-nowrap text-center">
                                    <div class="flex flex-col items-center gap-1">
                                        ...
                                        @if($sikayet->iaaProjesi)
                                            ...
                                            @if(!$isSameStatus && $isApprovalPhase)
                                                @php
                                                    $bgClass = "bg-{$pRenk}-50";
                                                ...
                                                <div class="text-[9px] font-bold {{ $textClass }} animate-pulse flex items-center justify-center gap-1 {{ $bgClass }} px-1.5 py-0.5 rounded border {{ $borderClass }}">
                                                    {{ $pDurum === 'Bölüm Onayı Bekliyor' ? 'Bölüm Kalite Yöneticisi Onayı Bekliyor' : $pDurum }}
                                                </div>
                                            @endif
                                        @endif
                                    </div>
                                ...
                                <td class="px-5 py-3 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex flex-col items-end gap-1.5" x-data="{ openReminderModal: false }">
                                        ...
                                        {{-- HATIRLATMA BUTONU --}}
                                        @if(in_array($sikayet->musteri_durum, ['Yeni', 'İşlemde', 'Atandı', 'İnceleniyor', 'Devam Ediyor', 'Bölüm Onayı Bekliyor', 'Direktör Onayı Bekliyor', 'Yönetici Onayı Bekliyor']))
