    ...
    <div class="bg-green-50 p-6 rounded-lg border border-green-100">
        ...
        <div class="flex justify-between items-start mb-6 border-b border-green-200 pb-4">
            ...
            <div class="flex flex-col sm:flex-row items-end gap-2">
                <?php $dekont = $case->files->where('doc_type', 'dekont')->last(); ?>
                <?php if($dekont): ?>
                ...
                <?php endif; ?>
                <?php $sonTutanak = $case->files->where('doc_type', 'arabuluculuk_son_tutanak')->first(); ?>
                <?php if($sonTutanak): ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div class="col-span-2 mb-4">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3">
                                ...
                                <input type="text" class="w-full sm:w-7/12 border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent px-4 py-3 bg-gray-50" name="odenecek_kisi" id="odenecek_kisi_ad_soyad" value="<?php echo e($mevcutOdeme ? $mevcutOdeme->odenecek_kisi : ($arabuluculuk->relatedUser->name ?? '')); ?>" placeholder="Ad Soyad Giriniz..." readonly>
                            </div>
                            <div class="mt-2 flex items-start gap-2 text-xs text-gray-600 bg-blue-50 p-3 rounded-lg border border-blue-100">
                                ...
                                <span id="input_aciklama">Ödeme varsayılan olarak ilgili personele (<?php echo e($arabuluculuk->relatedUser->name ?? 'Sinan Poyraz'); ?>) yapılacaktır.</span>
                            </div>
                        </div>
