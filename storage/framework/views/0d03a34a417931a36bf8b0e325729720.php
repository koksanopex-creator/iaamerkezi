...
<?php if($kurulDosyalari->isNotEmpty()): ?>
    <style>
        @keyframes blinker {
            50% { opacity: 0.3; }
        }
    ...
    <div class="mb-8" x-cloak
                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="bg-indigo-600 text-white text-[10px] font-bold px-3 py-1 rounded-full shadow-sm">
                                <?php echo e($kurulDosyalari->count()); ?> AKTİF SEVK
                            </span>
                        </div>
        ...
        <div class="mb-4 bg-indigo-50 border border-indigo-100 rounded-xl px-4 py-3 flex flex-wrap items-center gap-2">
            ...
            <?php $__currentLoopData = $kurulUyeleri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uye): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $isBaskan = $uye->hasRole('Disiplin Kurulu Başkanı'); ?>
                <a href="<?php echo e(route('profile.show', $uye->id)); ?>"
                    class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold transition hover:opacity-80 <?php echo e($isBaskan ? 'bg-indigo-600 text-white' : 'bg-white text-indigo-700 border border-indigo-200'); ?>">
                    <?php echo e($isBaskan ? '👑 ' : ''); ?><?php echo e($uye->name); ?>

                    <?php if($isBaskan): ?><span class="text-[9px] opacity-75">(Başkan)</span><?php endif; ?>
                </a>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <?php $__currentLoopData = $kurulDosyalari; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dosya): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <tr class="hover:bg-slate-50 transition">
                                ...
                                <td class="px-5 py-4">
                                    <span class="font-bold text-slate-600">#<?php echo e($dosya->id); ?></span>
                                </td>
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-3">
                                        <div
                                            ...
                                            <?php echo e(strtoupper(substr($dosya->user->name, 0, 1))); ?>

                                        </div>
                                        <div>
                                            <a href="<?php echo e(route('profile.show', $dosya->user->id)); ?>"
                                                class="font-semibold text-slate-900 hover:text-indigo-700 hover:underline transition-colors">
                                                <?php echo e($dosya->user->name); ?>

                                            </a>
                                            <a href="<?php echo e($dosya->user->bolum ? route('admin.bolumler.show', $dosya->user->bolum->id) : '#'); ?>"
                                                class="block text-[10px] text-indigo-500 hover:underline uppercase tracking-wide mt-0.5">
                                                <?php echo e($dosya->user->bolum->ad ?? 'Birim Belirtilmedi'); ?>
                                ...
                                <td class="px-5 py-4">
                                    <span
                                        ...
                                        <?php echo e($dosya->behavior->category->ad ?? 'Genel Disiplin'); ?>
                                    ...
                                    <?php if($dosya->reporter): ?>
                                        <div class="flex items-center gap-2">
                                            <div
                                                ...
                                                <?php echo e(strtoupper(substr($dosya->reporter->name, 0, 1))); ?>

                                            </div>
                                            <div>
                                                <a href="<?php echo e(route('profile.show', $dosya->reporter->id)); ?>"
                                                    class="text-sm font-semibold text-slate-700 hover:text-indigo-700 hover:underline transition-colors">
                                                    <?php echo e($dosya->reporter->name); ?>

                                                </a>
                                                <p class="text-[10px] text-slate-400">
                                                    <?php echo e($dosya->reporter->bolum->ad ?? 'Birim Belirtilmedi'); ?>

                                                </p>
                                                <p class="text-[10px] text-slate-400">
                                                    <?php echo e($dosya->created_at->format('d.m.Y H:i')); ?>
                                ...
                                <td class="px-5 py-4">
                                    <?php if($toplantiTarihi): ?>
                                        <div>
                                            <p class="font-bold text-slate-800 text-sm"><?php echo e($toplantiTarihi->format('d.m.Y')); ?></p>
                                            <p class="text-[11px] text-slate-500"><?php echo e($toplantiTarihi->format('H:i')); ?></p>
                                        </div>
                                    <?php else: ?>
                                ...
                                <td class="px-5 py-4 text-center">
                                    <?php if($kalanGun): ?>
                                        <span
                                            class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold <?php echo e($badgeClass); ?> <?php echo e($pulseClass); ?>">
                                            <?php if(in_array($kalanDurumu, ['bugun', 'yakin', 'gecti'])): ?>
                                ...
                                <td class="px-5 py-4 text-right">
                                    <a href="<?php echo e(route('admin.disiplin.show', $dosya->id)); ?>"
...
<?php endif; ?><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/dashboard/partials/disciplinary-board.blade.php ENDPATH**/ ?>