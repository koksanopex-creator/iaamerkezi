...
<div class="space-y-12 animate-fade-in pb-10">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-2">
        ...
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('admin.sikayetler.kurulGirdileri')); ?>" class="flex items-center gap-2 px-5 py-2.5 bg-slate-800 text-white font-bold rounded-xl hover:bg-slate-900 transition-all shadow-lg shadow-slate-100 group">
            ...
            <a href="<?php echo e(route('admin.sikayetler.create')); ?>" class="flex items-center gap-2 px-5 py-2.5 bg-indigo-600 text-white font-bold rounded-xl hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-100 group">
    ...
    <?php if($yeniSikayetSayisi > 0): ?>
        <div class="bg-gradient-to-r from-rose-500 to-rose-600 rounded-2xl p-6 shadow-xl shadow-rose-100 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden group">
            ...
            <div class="flex items-center gap-6 relative z-10">
                ...
                <div>
                    <h3 class="text-xl font-black text-white uppercase tracking-tight">Dikkat: <?php echo e($yeniSikayetSayisi); ?> Yeni Şikayet Atama Bekliyor!</h3>
            ...
            <a href="<?php echo e(route('admin.sikayetler.index', ['tab' => 'yeni'])); ?>" class="relative z-10 px-8 py-3 bg-white text-rose-600 font-black rounded-xl hover:bg-rose-50 transition-colors shadow-lg whitespace-nowrap">
                Atamaları Yap →
            </a>
        </div>
    <?php endif; ?>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
            ...
            <h4 class="text-4xl font-black text-slate-800"><?php echo e($stats['toplam_sikayet']); ?></h4>
            <p class="text-slate-500 text-xs font-bold mt-1 uppercase">Kayıtlı Şikayet</p>
        </div>

        <a href="<?php echo e(route('admin.sikayetler.index', ['tab' => 'yeni'])); ?>" class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-all hover:-translate-y-1">
            <div class="flex items-center justify-between mb-4">
            ...
            <h4 class="text-4xl font-black text-amber-600"><?php echo e($stats['yeni_sikayet']); ?></h4>
            <p class="text-slate-500 text-xs font-bold mt-1 uppercase">Atama Bekleyen</p>
        </a>

        <a href="<?php echo e(route('admin.sikayetler.index', ['tab' => 'islemde'])); ?>" class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-all hover:-translate-y-1">
            <div class="flex items-center justify-between mb-4">
            ...
            <h4 class="text-4xl font-black text-indigo-600"><?php echo e($stats['islemde_sikayet']); ?></h4>
            <p class="text-slate-500 text-xs font-bold mt-1 uppercase">Çözüm Sürecinde</p>
        </a>

        <a href="<?php echo e(route('admin.sikayetler.index', ['tab' => 'cozulmus'])); ?>" class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-all hover:-translate-y-1">
            <div class="flex items-center justify-between mb-4">
            ...
            <h4 class="text-4xl font-black text-emerald-600"><?php echo e($stats['tamamlanan_sikayet'] ?? 0); ?></h4>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden"
         x-data="{ 
            limit: 5, 
            total: <?php echo e(count($stats['son_sikayetler'] ?? [])); ?>,
            increment: 5
         }">
        <div class="px-6 py-5 border-b border-slate-50 bg-slate-50/30 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('admin.sikayetler.index')); ?>" class="text-xs font-black text-indigo-600 hover:text-indigo-800 uppercase tracking-wider">Tümü →</a>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-50">
                    <?php $__empty_1 = true; $__currentLoopData = $stats['son_sikayetler']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $sikayet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                            $progress = $sikayet->iaaProjesi ? $sikayet->iaaProjesi->ilerleme_verisi['yuzde'] : 0;
                        ?>
                        <tr class="hover:bg-slate-50/50 transition-colors" x-show="<?php echo e($index); ?> < limit" x-transition>
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-9 h-9 rounded-lg bg-white border border-slate-100 shadow-sm flex items-center justify-center p-1 overflow-hidden flex-shrink-0">
                                        <?php if($sikayet->customer && $sikayet->customer->logo_path): ?>
                                            <img src="<?php echo e(asset('storage/' . $sikayet->customer->logo_path)); ?>" class="w-full h-full object-contain" alt="">
                                        <?php else: ?>
                                            <span class="text-[11px] font-black text-slate-400"><?php echo e(substr($sikayet->customer->name ?? $sikayet->musteri_adi, 0, 2)); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    <div class="min-w-0">
                                        <p class="text-xs font-black text-slate-800 truncate leading-tight" title="<?php echo e($sikayet->musteri_sikayet_konusu); ?>">
                                            <?php echo e(Str::limit($sikayet->musteri_sikayet_konusu, 40)); ?>

                                        </p>
                                        <div class="flex items-center gap-2 mt-0.5">
                                            <p class="text-[9px] font-bold text-indigo-600 uppercase tracking-tight"><?php echo e(Str::limit($sikayet->customer->name ?? $sikayet->musteri_adi, 25)); ?></p>
                                            <?php if($sikayet->konum_tipi): ?>
                                                <span class="text-[8px] px-1.5 py-0.5 rounded-sm <?php echo e($sikayet->konum_tipi === 'Yurt İçi' ? 'bg-sky-50 text-sky-600 border border-sky-100' : 'bg-fuchsia-50 text-fuchsia-600 border border-fuchsia-100'); ?>"><?php echo e($sikayet->konum_tipi); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="space-y-0.5">
                                    <p class="text-[11px] font-bold text-slate-700"><?php echo e($sikayet->sikayetKategori->bolum->ad ?? '-'); ?></p>
                                    <p class="text-[9px] text-slate-400 font-medium italic"><?php echo e($sikayet->sikayetKategori->ad ?? '-'); ?></p>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <?php if($sikayet->cozumTakimi): ?>
                                    <div class="flex items-center gap-2">
                                        <div class="w-5 h-5 rounded-full bg-indigo-500 text-[8px] text-white flex items-center justify-center font-black">
                                            <?php echo e(substr($sikayet->cozumTakimi->ad, 0, 1)); ?>

                                        </div>
                                        <span class="text-[10px] font-bold text-slate-600 truncate max-w-[100px]"><?php echo e($sikayet->cozumTakimi->ad); ?></span>
                                    </div>
                                <?php else: ?>
                                ...
                                <?php if($sikayet->olusturanKurulUyesi): ?>
                                    <p class="text-[8px] text-slate-400 mt-1" title="Ekleyen Personel">Ekleyen: <?php echo e($sikayet->olusturanKurulUyesi->name); ?></p>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4 text-center">
                                <div class="scale-90 origin-center flex flex-col items-center gap-1.5">
                                    ...
                                    <?php if($sikayet->iaaProjesi && $sikayet->iaaProjesi->ziyaretPlani()->exists()): ?>
                                    ...
                                    <?php if($sikayet->iaaProjesi && isset($sikayet->iaaProjesi->ilerleme_verisi['kapanis_bekleniyor']) && $sikayet->iaaProjesi->ilerleme_verisi['kapanis_bekleniyor']): ?>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-col items-center gap-1 min-w-[70px]">
                                    <div class="w-full bg-slate-100 rounded-full h-1 overflow-hidden">
                                        <div class="bg-indigo-500 h-full transition-all duration-700" style="width: <?php echo e($progress); ?>%"></div>
                                    </div>
                                    <span class="text-[8px] font-black text-slate-400"><?php echo e(round($progress)); ?>%</span>
                                </div>
                            </td>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        <?php $__currentLoopData = ($stats['kurul_uyeleri'] ?? [])->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $uye): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div class="relative">
                                            <img src="<?php echo e($uye->profile_photo_url); ?>" class="w-8 h-8 rounded-full border border-slate-100 shadow-sm" alt="">
                                            <div class="absolute -top-1 -right-1 w-4 h-4 rounded-full <?php echo e($index == 0 ? 'bg-amber-400' : 'bg-slate-200'); ?> flex items-center justify-center text-[8px] font-black border border-white"><?php echo e($index + 1); ?></div>
                                        </div>
                                        <span class="text-xs font-black text-slate-800"><?php echo e($uye->name); ?></span>
                                    </div>
                                </td>
                                <td class="px-4 py-4 text-center">
                                    <span class="px-2.5 py-0.5 bg-indigo-50 text-indigo-700 text-[10px] font-black rounded-full border border-indigo-100"><?php echo e($uye->girdigi_sikayetler_count); ?> Şikayet</span>
                                </td>
                                <td class="px-6 py-4 text-right text-xs font-black text-emerald-600">
                                    <?php echo e(number_format($uye->girdigi_sikayetler_sum_kazanilan_puan ?: 0)); ?>
            ...
            <div class="bg-slate-50/50 border-t border-slate-100 px-6 py-3 flex items-center justify-center">
                <a href="<?php echo e(route('admin.sikayetler.kurulGirdileri')); ?>" class="text-[10px] font-black text-indigo-600 uppercase tracking-widest hover:underline">Tüm Üyeleri ve Raporları Görüntüle →</a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            <div class="px-6 py-5 border-b border-slate-50 bg-rose-50/30 flex items-center justify-between">
                <h3 class="font-black text-rose-900 uppercase tracking-tight flex items-center gap-2 text-sm">
                    ...
                    Müşteri Hatırlatma Talepleri (<?php echo e($stats['toplam_hatirlatma_sayisi'] ?? 0); ?>)
                </h3>
            </div>
            <div class="overflow-x-auto scrollbar-hide">
                <table class="w-full text-left border-collapse table-auto">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        <?php $__empty_1 = true; $__currentLoopData = $stats['hatirlatmalar'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hatirlatma): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-rose-50/20 transition-colors">
                                <td class="px-4 py-3">
                                    <div class="min-w-0">
                                        <p class="text-[10px] font-black text-slate-800 truncate max-w-[150px] leading-tight" title="<?php echo e($hatirlatma->musteriSikayeti->musteri_sikayet_konusu ?? '-'); ?>">
                                            <?php echo e(Str::limit($hatirlatma->musteriSikayeti->musteri_sikayet_konusu ?? '-', 35)); ?>

                                        </p>
                                        <p class="text-[9px] font-bold text-rose-600 uppercase tracking-tight"><?php echo e(Str::limit($hatirlatma->musteriSikayeti->customer->name ?? '-', 25)); ?></p>
                                    </div>
                                </td>
                                <td class="px-2 py-3 text-center">
                                    ...
                                    ?>
                                    <span class="px-2 py-0.5 rounded-full text-[8px] font-black uppercase tracking-tighter border <?php echo e($colorClass); ?>">
                                        <?php echo e($labelText); ?>

                                    </span>
                                </td>
                                <td class="px-4 py-3 text-right">
                                    <p class="text-[9px] font-black text-slate-400 uppercase whitespace-nowrap"><?php echo e($hatirlatma->created_at->diffForHumans(null, true)); ?></p>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
            ...
            <div class="bg-slate-50/50 border-t border-slate-100 px-6 py-3 flex items-center justify-center">
                <a href="<?php echo e(route('admin.sikayet-hatirlatma.index')); ?>" class="text-[10px] font-black text-rose-600 uppercase tracking-widest hover:underline">Tüm Hatırlatma Süreçleri →</a>
            </div>
        </div>
    </div>
    ...
    <div id="musteri-listesi" class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden" 
         x-data="{ 
            limit: 5, 
            total: <?php echo e(count($stats['sorumlu_musteriler'] ?? [])); ?>,
            increment: 5
         }">
        <div class="px-6 py-5 border-b border-slate-50 bg-emerald-50/30">
            <h3 class="font-black text-emerald-900 uppercase tracking-tight flex items-center gap-2">
                ...
                Kayıtlı Müşteriler (<?php echo e(count($stats['sorumlu_musteriler'] ?? [])); ?>)
            </h3>
        </div>
        <div class="overflow-x-auto min-w-full">
            <table class="w-full text-left text-sm whitespace-nowrap table-auto">
                ...
                <tbody class="divide-y divide-slate-50">
                    <?php $__empty_1 = true; $__currentLoopData = $stats['sorumlu_musteriler']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $musteri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-emerald-50/20 transition-colors" x-show="<?php echo e($index); ?> < limit" x-transition>
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-8 h-8 rounded-lg bg-white border border-slate-100 shadow-sm flex items-center justify-center p-1 overflow-hidden">
                                        <?php if($musteri->logo_path): ?>
                                            <img src="<?php echo e(asset('storage/' . $musteri->logo_path)); ?>" class="w-full h-full object-contain" alt="">
                                        <?php else: ?>
                                            <div class="w-full h-full bg-emerald-50 text-emerald-600 flex items-center justify-center font-black text-[10px]"><?php echo e(substr($musteri->name, 0, 2)); ?></div>
                                        <?php endif; ?>
                                    </div>
                                    <a href="<?php echo e(route('musteri.profil.show', $musteri->id)); ?>" class="font-black text-slate-800 hover:text-emerald-600 transition-colors text-xs"><?php echo e(Str::limit($musteri->name, 45)); ?></a>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2">
                                    <div class="bg-slate-50 px-2 py-0.5 rounded border border-slate-100 text-[10px] font-black text-slate-500">T: <?php echo e($musteri->toplam_sikayet); ?></div>
                                    <div class="bg-emerald-50 px-2 py-0.5 rounded border border-emerald-100 text-[10px] font-black text-emerald-600">Ç: <?php echo e($musteri->cozulen_sikayet); ?></div>
                                    <div class="bg-amber-50 px-2 py-0.5 rounded border border-amber-100 text-[10px] font-black text-amber-600">B: <?php echo e($musteri->bekleyen_sikayet); ?></div>
                                </div>
                            </td>
                            <td class="px-6 py-4 text-[11px] text-slate-500 font-medium">
                                <?php echo e(Str::limit($musteri->address ?? '-', 40)); ?>

                            </td>
                            <td class="px-6 py-4">
                                <div class="flex -space-x-2">
                                    <?php $__currentLoopData = $musteri->users->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yetkili): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <img src="<?php echo e($yetkili->profile_photo_url); ?>" class="w-6 h-6 rounded-full border-2 border-white ring-1 ring-slate-100" title="<?php echo e($yetkili->name); ?>">
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($musteri->users->count() > 4): ?>
                                        <div class="w-6 h-6 rounded-full bg-slate-100 border-2 border-white flex items-center justify-center text-[8px] font-black text-slate-500">+<?php echo e($musteri->users->count() - 4); ?></div>
                                    <?php endif; ?>
                                </div>
                            </td>
                        </tr>
...
</div><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/dashboard/partials/sikayet-kurulu.blade.php ENDPATH**/ ?>