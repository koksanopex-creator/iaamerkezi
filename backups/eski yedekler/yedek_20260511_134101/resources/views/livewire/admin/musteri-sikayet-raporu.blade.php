    ...
    <div class="bg-white rounded-xl shadow-lg border border-red-100 overflow-hidden mt-8">
        <div class="px-6 py-4 bg-red-50 border-b border-red-100 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <button wire:click="setFilter('gecikmis')" class="text-xs font-black text-red-700 hover:underline flex items-center gap-1">
                    Tümünü Gör 
        ...
        <div class="px-6 py-3 bg-gray-50 border-t border-gray-100 flex justify-center">
            <button wire:click="setFilter('gecikmis')" class="inline-flex items-center gap-2 px-4 py-2 bg-red-600 text-white text-xs font-black rounded-lg hover:bg-red-700 transition-all shadow-md">
