...
$__html = app('livewire')->mount($__name, $__params, 'lw-259869832-0', $__slots ?? [], get_defined_vars());
                                    ...
                                    <?php if($tamYetki): ?>
                                        <label
                                            ...
                                            <input type="radio" name="konum_tipi" value="Yurt İçi"
                                                class="form-radio w-5 h-5 text-blue-600 focus:ring-blue-500" <?php echo e(old('konum_tipi', $sikayet->konum_tipi) == 'Yurt İçi' ? 'checked' : ''); ?>>
                                            <span class="ml-2 text-sm text-gray-700 font-medium">Yurt İçi</span>
                                        </label>
                                        <label
                                            class="inline-flex items-center cursor-pointer bg-gray-50 px-4 py-2 rounded-lg border border-gray-200 hover:bg-gray-100 transition">
                                            <input type="radio" name="konum_tipi" value="Yurt Dışı"
                                                class="form-radio w-5 h-5 text-blue-600 focus:ring-blue-500" <?php echo e(old('konum_tipi', $sikayet->konum_tipi) == 'Yurt Dışı' ? 'checked' : ''); ?>>
...
<?php endif; ?><?php /**PATH /var/www/kys_koksan/iaa/resources/views/admin/sikayetler/edit.blade.php ENDPATH**/ ?>