    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="bg-blue-50 p-4 rounded-lg border border-blue-100 shadow-sm">
                ...
                <?php else: ?>
                    <div class="text-sm text-gray-700 whitespace-pre-wrap min-h-[100px] bg-white p-3 rounded border border-blue-100"><?php echo e($strengths ?: 'Veri girilmemiş.'); ?></div>
            ...
            <div class="bg-red-50 p-4 rounded-lg border border-red-100 shadow-sm">
                ...
                <?php else: ?>
                    <div class="text-sm text-gray-700 whitespace-pre-wrap min-h-[100px] bg-white p-3 rounded border border-red-100"><?php echo e($weaknesses ?: 'Veri girilmemiş.'); ?></div>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </div>
            ...
            <div class="bg-emerald-50 p-4 rounded-lg border border-emerald-100 shadow-sm">
                ...
                <?php else: ?>
                    <div class="text-sm text-gray-700 whitespace-pre-wrap min-h-[100px] bg-white p-3 rounded border border-emerald-100"><?php echo e($opportunities ?: 'Veri girilmemiş.'); ?></div>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </div>
            ...
            <div class="bg-amber-50 p-4 rounded-lg border border-amber-100 shadow-sm">
                ...
                <?php else: ?>
                    <div class="text-sm text-gray-700 whitespace-pre-wrap min-h-[100px] bg-white p-3 rounded border border-amber-100"><?php echo e($threats ?: 'Veri girilmemiş.'); ?></div>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/livewire/project/tools/swot-analysis.blade.php ENDPATH**/ ?>