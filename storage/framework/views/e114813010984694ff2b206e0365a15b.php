            ...
            <div class="relative z-10">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-slate-300 text-sm">Hoşgeldiniz, <?php echo e(Auth::user()->name); ?></p>
                    </div>
                    ...
                    <form action="<?php echo e(route('dashboard')); ?>" method="GET"
                        ...
                        <input type="date" name="hukuk_start_date" value="<?php echo e(request('hukuk_start_date')); ?>"
                            class="bg-transparent border-0 text-white text-xs p-1 focus:ring-0 placeholder-slate-400 w-24">
                        <span class="text-slate-400 text-xs">-</span>
                        <input type="date" name="hukuk_end_date" value="<?php echo e(request('hukuk_end_date')); ?>"
                            class="bg-transparent border-0 text-white text-xs p-1 focus:ring-0 placeholder-slate-400 w-24">
                        <button type="submit"
                        ...
                        <?php if(request('hukuk_start_date') || request('hukuk_end_date')): ?>
                            <a href="<?php echo e(route('dashboard')); ?>" class="text-slate-400 hover:text-white p-1"
                ...
                <div class="flex items-center gap-4 mt-6">
                    <div class="bg-white/10 px-4 py-3 rounded-xl backdrop-blur-sm border border-white/5 w-full">
                        ...
                        <div class="flex items-baseline justify-between">
                            <span
                                class="text-3xl font-bold"><?php echo e($stats['toplam_arabuluculuk'] + $stats['toplam_disiplin']); ?></span>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow group">
            <div class="flex justify-between items-start mb-4">
                ...
                <span class="flex items-center text-xs font-semibold text-green-600 bg-green-50 px-2 py-1 rounded-full">
                    <?php echo e($stats['aktif_arabuluculuk']); ?> Aktif
                </span>
            </div>
            <h4 class="text-slate-500 text-sm font-medium">Arabuluculuk Dosyaları</h4>
            <div class="mt-2 flex items-baseline gap-2">
                <span class="text-3xl font-bold text-slate-800"><?php echo e($stats['toplam_arabuluculuk']); ?></span>
            ...
            <div class="mt-4 pt-3 border-t border-slate-50 flex items-center justify-between text-xs">
                <span class="text-orange-600 font-medium"><?php echo e($stats['bekleyen_arabuluculuk']); ?> Bekleyen İşlem</span>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow group">
            <div class="flex justify-between items-start mb-4">
                ...
                <span class="flex items-center text-xs font-semibold text-rose-600 bg-rose-50 px-2 py-1 rounded-full">
                    <?php echo e($stats['aktif_disiplin']); ?> Aktif
                </span>
            </div>
            <h4 class="text-slate-500 text-sm font-medium">Disiplin Tutanakları</h4>
            <div class="mt-2 flex items-baseline gap-2">
                <span class="text-3xl font-bold text-slate-800"><?php echo e($stats['toplam_disiplin']); ?></span>
                <span class="text-xs text-slate-400">Toplam Kayıt</span>
            </div>
            <div class="mt-4 pt-3 border-t border-slate-50 flex items-center justify-between text-xs">
                <span class="text-orange-600 font-medium"><?php echo e($stats['karar_bekleyen_disiplin']); ?> Karar Bekleyen</span>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden flex flex-col h-full">
            ...
            <div class="p-4 flex-1">
                <?php if(isset($stats['bekleyen_arabuluculuk_listesi']) && count($stats['bekleyen_arabuluculuk_listesi']) > 0): ?>
                    <div class="space-y-3">
                        <?php $__currentLoopData = $stats['bekleyen_arabuluculuk_listesi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dosya): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="relative group/avatar cursor-help">
                                        <div
                                            ...
                                            <?php if($dosya->calisan): ?>
                                                <?php echo e(substr($dosya->calisan->name, 0, 1)); ?><?php echo e(substr(explode(' ', $dosya->calisan->name)[1] ?? '', 0, 1)); ?>

                                            <?php else: ?>
                                                <?php echo e(substr($dosya->ad_soyad ?? '?', 0, 1)); ?>
                                        ...
                                        <div
                                            ...
                                            <div class="space-y-2">
                                                <div>
                                                    ...
                                                    <?php if($dosya->calisan): ?>
                                                        <span
                                                            class="font-semibold text-white block"><?php echo e($dosya->calisan->name); ?></span>
                                                        <span
                                                            class="text-slate-400 block text-[10px]"><?php echo e($dosya->calisan->email); ?></span>
                                                    <?php else: ?>
                                                        <span class="text-slate-300"><?php echo e($dosya->ad_soyad); ?> (Sistem Dışı)</span>
                                                    <?php endif; ?>
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        <span
                                                            class="font-semibold text-white"><?php echo e($dosya->creator->name ?? 'Sistem'); ?></span>
                                                        <span
                                                            class="text-[10px] text-slate-400"><?php echo e($dosya->updated_at->format('d.m.Y H:i')); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div>
                                        <h5
                                            ...
                                            <?php echo e($dosya->ad_soyad); ?>

                                        </h5>
                                        <div class="flex items-center gap-2 mt-1">
                                            <span class="text-[10px] px-1.5 py-0.5 rounded 
                                                                            <?php echo e($dosya->type == 'ZORUNLU' ? 'bg-rose-100 text-rose-700' : 'bg-blue-100 text-blue-700'); ?> 
                                                                            font-medium uppercase tracking-wide">
                                                <?php echo e($dosya->type); ?>

                                            </span>
                                            <span
                                                class="text-xs text-slate-400"><?php echo e($dosya->updated_at->diffForHumans()); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="text-right">
                                    ...
                                    ?>
                                    <span
                                        class="inline-block px-2 py-1 rounded text-[10px] font-bold mb-1 <?php echo e($statusColors[$dosya->status] ?? 'bg-slate-100 text-slate-600'); ?>">
                                        <?php echo e($statusText[$dosya->status] ?? $dosya->status); ?>

                                    </span>
                                    <a href="<?php echo e(route('admin.arabuluculuk.show', $dosya->id)); ?>"
        ...
        <div class="space-y-6">
            ...
            <?php if(isset($stats['disiplin_bolum_dagilimi']) && count($stats['disiplin_bolum_dagilimi']) > 0): ?>
                <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-5">
                    ...
                    <div class="space-y-3">
                        <?php $__currentLoopData = $stats['disiplin_bolum_dagilimi']->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dagilim): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div>
                                <div class="flex justify-between text-xs mb-1">
                                    <span class="font-medium text-slate-700"><?php echo e($dagilim->bolum_adi); ?></span>
                                    <span class="font-bold text-slate-900"><?php echo e($dagilim->dosya_sayisi); ?> Dosya</span>
                                </div>
                                <div class="w-full bg-slate-100 rounded-full h-1.5">
                                    <div class="bg-orange-500 h-1.5 rounded-full"
                                        style="width: <?php echo e(($dagilim->dosya_sayisi / $stats['toplam_disiplin']) * 100); ?>%"></div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                ...
                <div class="p-4">
                    <?php if(isset($stats['son_disiplin_vakalari']) && count($stats['son_disiplin_vakalari']) > 0): ?>
                        <div class="space-y-3">
                            <?php $__currentLoopData = $stats['son_disiplin_vakalari']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vaka): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                
                                <a href="<?php echo e(route('admin.disiplin.show', $vaka->id)); ?>" class="block">
                                    <div
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div
                                                ...
                                                <?php if($vaka->user && $vaka->user->profile_photo_path): ?>
                                                    <img src="<?php echo e($vaka->user->profile_photo_path); ?>"
                                                        class="w-full h-full object-cover">
                                                <?php elseif($vaka->user): ?>
                                                    <span
                                                        class="text-xs font-bold text-rose-600"><?php echo e(substr($vaka->user->name, 0, 1)); ?></span>
                                                <?php else: ?>
                                            ...
                                            <div class="min-w-0">
                                                <h5
                                                    ...
                                                    <?php echo e($vaka->user ? $vaka->user->name : 'Bilinmiyor'); ?>

                                                </h5>
                                                <div class="flex flex-col">
                                                    
                                                    <span class="text-[10px] text-slate-500 font-medium">
                                                        <?php echo e($vaka->user && $vaka->user->bolum ? $vaka->user->bolum->ad : 'Bölüm Yok'); ?>

                                                    </span>
                                                    
                                                    <span class="text-[10px] text-slate-400 truncate max-w-[150px]">
                                                        <?php echo e($vaka->behavior ? $vaka->behavior->name : 'Kategori Yok'); ?>
                                        ...
                                        <div class="text-right shrink-0">
                                            ...
                                            ?>
                                            <span
                                                class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold border <?php echo e($durumConfig); ?>">
                                                <?php echo e($vaka->durum); ?>

                                            </span>
                                            <span
                                                class="block text-[10px] text-slate-400 mt-1"><?php echo e($vaka->created_at->diffForHumans()); ?></span>
                                        </div>
                                    </div>
                                </a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</div><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/dashboard/partials/hukuk.blade.php ENDPATH**/ ?>