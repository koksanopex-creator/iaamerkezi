    ...
    <div class="py-10 bg-gradient-to-br from-gray-50 to-gray-100 overflow-x-hidden">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                <form action="{{ route('admin.sikayet-raporlari.tum-liste') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 items-end">
                    <div>
                                ...
                                <tr class="{{ $rowBg }} {{ $rowBar }} transition-colors">
                                    ...
                                    <td class="px-4 py-3 text-sm whitespace-nowrap">
                                        <div class="flex flex-col gap-1">
                                            <div class="flex items-center gap-1 {{ $sikayet->musteri_cozum_son_tarihi ? 'text-red-600 font-semibold' : 'text-gray-500' }}" title="Hedef Çözüm Tarihi">
                            ...
                            <div class="rounded-lg shadow border {{ $rowBg }} {{ $rowBar }} p-4 space-y-3 cursor-pointer"
                                ...
                                <div class="flex justify-between items-center pt-3 border-t border-gray-200">
                                    <div class="text-xs space-y-1">
                                        <div class="flex items-center gap-1 {{ $sikayet->musteri_cozum_son_tarihi ? 'text-red-600' : 'text-gray-500' }}">
                                            <span class="opacity-70">Hedef:</span>
                                            <span class="font-semibold">{{ $sikayet->musteri_cozum_son_tarihi ? \Carbon\Carbon::parse($sikayet->musteri_cozum_son_tarihi)->format('d.m.Y') : 'N/A' }}</span>
                                        </div>
                                        @if($sikayet->musteri_onay_tarihi || $sikayet->kurul_onay_tarihi)
