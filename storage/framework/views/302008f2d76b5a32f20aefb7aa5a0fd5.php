                    ...
                    <?php else: ?>
                        ...
                        <div class="flex items-center gap-2 mb-4 flex-wrap">
                            ...
                            <?php if($stepVisit): ?>
                                ...
                                ?>
                                <div class="flex items-center gap-1.5 px-3 py-1.5 border rounded-lg text-xs font-semibold shadow-sm <?php echo e($vStatusColor); ?>" x-show="!open" x-transition>
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                    <span>Ziyaret Planı (<?php echo e(mb_strtoupper($stepVisit->status, 'UTF-8')); ?>)</span>
                                </div>
                            <?php endif; ?>
                        </div>
                ...
                <div class="w-full">
                    ...
                    <div x-data="{ 
                        ...
                        <div class="flex items-center gap-3 flex-grow">
                            ...
                            <template x-if="selectedIds.length === 0">
                                <div>
                                    <?php if(!empty($widgetAssignedUserIds)): ?>
                                        <?php 
                                        ...
                                        <div class="mb-2 p-2 bg-indigo-50 border-l-2 border-indigo-500 rounded-r text-xs text-indigo-800">
                                            <?php if($isCompleted): ?>
                                                Bu adım <strong><?php echo e($widgetUsers); ?></strong> tarafından tamamlanmıştır.
                                            <?php else: ?>
                                                Bu alan için takım harici şu sorumlular (<strong><?php echo e($widgetUsers); ?></strong>) atanmış ve görevin tamamlanması bekleniyor.
                                            <?php endif; ?>
                                        </div>
                                    <?php endif; ?>
...
[$__name, $__params] = $__split('admin.proje-adim-yorumlari', ['iaa' => $iaa,'step' => $step,'lazy' => true]);

$__html = app('livewire')->mount($__name, $__params, 'comments-'.$step->id, $__slots ?? [], get_defined_vars());
