        ...
        <div class="overflow-x-auto">
            <ul class="divide-y divide-slate-100">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <li class="p-5 transition-all <?php echo e($notification->read_at ? 'bg-white' : 'bg-blue-50/80 shadow-inner'); ?> hover:bg-slate-50/80 group">
                        <div class="flex items-start gap-4">
                            
                            
                            <div class="relative flex-shrink-0">
                                <div class="w-12 h-12 rounded-2xl flex items-center justify-center transition-transform group-hover:scale-110 <?php echo e($notification->read_at ? 'bg-slate-100 text-slate-400' : 'bg-'.$notification->computed_color.'-100 text-'.$notification->computed_color.'-600'); ?>">
                                    <!--[if BLOCK]><![endif]--><?php if($notification->computed_color == 'red'): ?>
                                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg>
                                    <?php elseif($notification->computed_color == 'amber'): ?>
                            ...
                            <div class="flex-1 space-y-2">
                                <div class="flex flex-wrap items-center gap-2">
                                    ...
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-md text-[10px] font-bold uppercase tracking-wider bg-<?php echo e($notification->computed_color); ?>-50 text-<?php echo e($notification->computed_color); ?>-700 border border-<?php echo e($notification->computed_color); ?>-100 shadow-sm">
                                        <?php echo e($notification->computed_type); ?>

                                    </span>
                                    
                                    
                                        <span class="px-2 py-0.5 rounded text-[10px] font-bold bg-<?php echo e($notification->computed_dept_color); ?>-100 text-<?php echo e($notification->computed_dept_color); ?>-600 border border-<?php echo e($notification->computed_dept_color); ?>-200 uppercase tracking-tight">
                                            <?php echo e($notification->computed_dept); ?>
                                ...
                                <a href="<?php echo e(route('notifications.readAndRedirect', $notification->id)); ?>" 
                                   class="block text-[15px] leading-snug <?php echo e($notification->read_at ? 'text-slate-600 font-medium' : 'text-slate-900 font-extrabold'); ?> hover:text-indigo-600 transition-colors">
                                    <?php echo e($notification->data['message'] ?? 'Bildirim içeriği bulunamadı.'); ?>
                            ...
                            <div class="flex flex-col items-end gap-2 shrink-0">
                                <button wire:click="toggleRead('<?php echo e($notification->id); ?>')" 
                                        class="p-2.5 rounded-xl transition-all shadow-sm hover:shadow-md active:scale-90 flex items-center gap-2 <?php echo e($notification->read_at ? 'text-slate-400 hover:text-indigo-600' : 'text-blue-600 bg-white'); ?>"
                                        title="<?php echo e($notification->read_at ? 'Okunmadı İşaretle' : 'Okundu İşaretle'); ?>">
...
<?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/livewire/notifications-index.blade.php ENDPATH**/ ?>