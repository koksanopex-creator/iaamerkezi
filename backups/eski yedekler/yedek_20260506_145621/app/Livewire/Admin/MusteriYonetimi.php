...
class MusteriYonetimi extends Component
{
    ...
    public function render()
    {
        ...
        } elseif (!$user->hasAnyRole(['Superadmin', 'Yonetim', 'Yönetim', 'Müşteri Şikayeti Kurulu'])) {
            // Bölüm Lideri ve Direktör gibi roller (Kendi bölümü + Ekibinin dahil olduğu işler)
