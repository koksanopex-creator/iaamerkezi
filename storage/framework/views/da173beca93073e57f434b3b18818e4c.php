<div class="flex items-center justify-end gap-3">
    ...
    <?php if($iaa->atanan_takim_id): ?>
        <a href="<?php echo e(route('proje.workspace.show', $iaa)); ?>" target="_blank" 
        ...
        <a href="<?php echo e(route('iaa.show', $iaa)); ?>" target="_blank" 
        ...
        <div class="flex items-center justify-center bg-gray-50 rounded-md border border-gray-200 p-0.5 min-w-[120px]">
            ...
            <?php if(in_array($type, ['atanmis', 'havuz', 'reddedilmis', 'yonetici-onayi'])): ?>
                ...
                <?php if($iaa->gonderen_user_id): ?>
                    <a href="<?php echo e(route('admin.iaa-yonetim.reassignForm', $iaa)); ?>" 
                ...
                <form method="POST" action="<?php echo e(route('admin.iaa-yonetim.geriAl', $iaa)); ?>" class="inline-flex" onsubmit="return confirm('İşlemi geri almak istediğinize emin misiniz?');"> 
            ...
            <form method="POST" action="<?php echo e(route('admin.iaa-yonetim.destroy', $iaa)); ?>" class="inline-flex" onsubmit="return confirm('Bu öneriyi kalıcı olarak silmek istediğinizden emin misiniz?');">
...
</div><?php /**PATH /var/www/kys_koksan/iaa/resources/views/admin/iaa-yonetim/partials/actions.blade.php ENDPATH**/ ?>