            ...
            <div class="p-6 space-y-6">
                <div class="flex items-start">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500">Durum: {{ $sikayet->musteri_durum == 'Bölüm Onayı Bekliyor' ? 'Bölüm Kalite Yöneticisi Onayı Bekliyor' : ($sikayet->musteri_durum == 'Yönetici Onayı Bekliyor' ? 'Final Onay Bekliyor' : $sikayet->musteri_durum) }}</p>
                    </div>
                </div>
    ...
    @if($sikayet->iaa_id)
        ...
        <div class="mb-8 mt-6">
            ...
            @elseif($projeDurumu == 'hatali_bildirim_olarak_kapatildi')
                <div class="bg-orange-50 border border-orange-200 rounded-xl p-6 flex items-center gap-5 shadow-sm">
