    ...
    <div class="p-4 md:p-6 space-y-5">
        ...
        <div class="pt-4 border-t">
            ...
            <textarea class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-colors text-sm resize-y"
                      id="sikayet_notify_manual_emails" name="sikayet_notify_manual_emails" rows="3">{{ $notifyManualEmails }}</textarea>
        </div>
        ...
        <div>
            ...
            <textarea class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-colors text-sm resize-y"
                      id="sikayet_atama_notify_manual_emails" name="sikayet_atama_notify_manual_emails" rows="3">{{ $atamaNotifyManualEmails }}</textarea>
        </div>
