        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                @php
                    ...
                    // Eğer kullanıcı müşteri ise varsayılan geri dönüş dashboard olsun, değilse şikayetler listesi
                    $defaultBack = auth()->user()->hasRole('Müşteri|Müşteri Temsilcisi') ? route('dashboard') : route('admin.sikayetler.index');
                    
                    // Eğer önceki sayfa şu anki sayfadan farklıysa ve uygulama içinden geliniyorsa (referrer varsa) geri dönsün
                    // Aksi halde varsayılan listeye gitsin.
                ...
                @can('update', $sikayet)
                    <a href="{{ route('admin.sikayetler.edit', $sikayet) }}"
                        class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-indigo-600 to-indigo-700 border border-transparent rounded-lg font-semibold text-xs text-white uppercase tracking-widest hover:from-indigo-500 transition shadow-sm">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
