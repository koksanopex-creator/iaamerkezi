            ...
            foreach ($this->inconsistencies as $item) {
                if ($item['type'] === 'user') {
                    ...
                    if ($model) {
                        ...
                        $breakdown = [];
                        if ($item['details']['projeler_puan'] > 0) $breakdown[] = "{$item['details']['projeler']} Proje ({$item['details']['projeler_puan']} P)";
                        if ($item['details']['sikayet_giris_puan'] > 0) $breakdown[] = "Şikayet ({$item['details']['sikayet_giris_puan']} P)";
                        if ($item['details']['oneriler_puan'] > 0) $breakdown[] = "{$item['details']['oneriler']} Öneri ({$item['details']['oneriler_puan']} P)";
                        if ($item['details']['cezalar_puan'] > 0) $breakdown[] = "Ceza (-{$item['details']['cezalar_puan']} P)";
