...
class RolesSeeder extends Seeder // Class adı RolesSeeder olarak değiştirildi
{
    ...
    public function run(): void
    {
        ...
        Role::firstOrCreate(['name' => 'Yonetim']); // Eklendi
        ...
        Role::firstOrCreate(['name' => 'Müşteri Temsilcisi']);
        Role::firstOrCreate(['name' => 'Bölüm Kalite Yöneticisi']);
        Role::firstOrCreate(['name' => 'Direktör']);
        Role::firstOrCreate(['name' => 'Hukuk Admini']); // Eklendi
        Role::firstOrCreate(['name' => 'Disiplin Kurulu Başkanı']); // Eklendi
        Role::firstOrCreate(['name' => 'Disiplin Kurulu Üyesi']); // Eklendi
        // ===============================================
