<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-8">
    <a href="<?php echo e(route('admin.iaa-yonetim.index')); ?>" onclick="localStorage.setItem('activeTab', 'onay-bekleyenler')" class="group relative bg-gradient-to-br from-purple-50 to-fuchsia-50 border border-purple-100 rounded-2xl p-6 hover:shadow-2xl hover:scale-105 transition-all duration-300 overflow-hidden">
