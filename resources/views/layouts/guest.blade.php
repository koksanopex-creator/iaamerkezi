...
@props(['wrapperClass' => 'max-w-sm lg:w-96', 'fullWidth' => false])

<body class="h-full bg-slate-50">
    <div class="min-h-screen flex flex-col {{ $fullWidth ? '' : 'lg:flex-row' }}">
                ...
                <div class="relative z-10 w-full flex flex-col justify-between p-16">
                    ...
                    <div class="flex flex-col gap-6">
                        <div class="text-sm text-blue-200/60 font-medium pt-8 border-t border-white/10">
                            <span>© {{ date('Y') }} Köksan A.Ş. Tüm hakları saklıdır. | Köksan Opex</span>
                        </div>
            ...
            <div
                ...
                <div class="relative z-10 w-full">
                    ...
                    <div class="mt-8 pt-6 border-t border-white/10 flex flex-col items-center gap-4">
                        <p class="text-[10px] text-blue-200/60 font-medium">© {{ date('Y') }} Köksan A.Ş. Tüm hakları saklıdır. | Köksan Opex</p>
        ...
        {{-- SAĞ TARAF (FORM / İÇERİK ALANI) --}}
        <div
            class="flex-1 flex flex-col justify-{{ $fullWidth ? 'start mt-4' : 'center' }} py-10 px-4 sm:px-6 lg:px-8 bg-{{ $fullWidth ? 'slate-50' : 'white' }} relative w-full {{ $fullWidth ? '' : 'lg:flex-none lg:w-1/2 xl:px-24' }}">
