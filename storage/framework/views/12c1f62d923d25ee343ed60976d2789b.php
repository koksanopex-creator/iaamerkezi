<div class="space-y-6">
    ...
    <!--[if BLOCK]><![endif]--><?php if(isset($chartData['ozet'])): ?>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200 flex items-center justify-between">
                <div>
                    ...
                    <div class="text-3xl font-black text-gray-900"><?php echo e($chartData['ozet']['toplam']); ?></div>
                </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200 flex items-center justify-between">
                <div>
                    ...
                    <div class="text-3xl font-black text-green-600"><?php echo e($chartData['ozet']['cozulen']); ?></div>
                </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200 flex items-center justify-between">
                <div>
                    ...
                    <div class="text-3xl font-black text-orange-600"><?php echo e($chartData['ozet']['bekleyen']); ?></div>
                </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200 flex items-center justify-between">
                <div>
                    ...
                    <div class="text-3xl font-black text-indigo-600"><?php echo e($chartData['ozet']['ortalamaHiz']); ?> <span class="text-lg font-medium text-gray-500">Gün</span></div>
                </div>
    ...
    <!--[if BLOCK]><![endif]--><?php if(isset($chartData['ozet']['dateText'])): ?>
        <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg shadow-sm">
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-blue-700 font-medium">Bu sayfadaki tablolar ve istatistikler, <strong class="text-blue-900 border-b border-blue-300"><?php echo e($chartData['ozet']['dateText']); ?></strong>.</p>
                </div>
            </div>
        </div>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-3 py-3">
                                <div class="flex items-center gap-2">
                                    <!--[if BLOCK]><![endif]--><?php if($sikayet->customer && $sikayet->customer->logo_path): ?>
                                        <img src="<?php echo e(asset('storage/' . $sikayet->customer->logo_path)); ?>" class="w-7 h-7 rounded-lg object-cover shadow-sm border border-gray-100" alt="Logo">
                                    <?php else: ?>
                                    ...
                                    <div class="flex flex-col">
                                        <!--[if BLOCK]><![endif]--><?php if($sikayet->customer_id): ?>
                                            <a href="<?php echo e(route('musteri.profil.show', $sikayet->customer_id)); ?>" class="text-indigo-600 hover:text-indigo-800 hover:underline transition-colors block max-w-[120px] lg:max-w-[150px] font-bold truncate text-sm" title="<?php echo e($sikayet->musteri_adi); ?>">
                                                <?php echo e($sikayet->musteri_adi); ?>

                                            </a>
                                        <?php else: ?>
                                            <span class="block max-w-[120px] lg:max-w-[150px] truncate font-bold text-gray-900 text-sm" title="<?php echo e($sikayet->musteri_adi); ?>"><?php echo e($sikayet->musteri_adi); ?></span>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                </div>
                            </td>
                            <td class="px-3 py-3 text-sm text-gray-700">
                                <div class="max-w-[150px] lg:max-w-[200px] truncate group relative cursor-help" title="<?php echo e($sikayet->musteri_sikayet_konusu); ?>">
                                    <?php echo e($sikayet->musteri_sikayet_konusu); ?>

                                </div>
                            </td>
                            <td class="px-3 py-3 text-sm font-medium">
                                <!--[if BLOCK]><![endif]--><?php if(isset($sikayet->sikayetKategori->bolum_id)): ?>
                                    <a href="<?php echo e(route('admin.bolumler.dashboard', $sikayet->sikayetKategori->bolum_id)); ?>" class="text-indigo-600 hover:text-indigo-800 hover:underline transition-colors block max-w-[100px] truncate">
                                        <?php echo e($sikayet->sikayetKategori->bolum->ad ?? 'Bölüm Yok'); ?>

                                    </a>
                                <?php else: ?>
                                    <span class="text-gray-500 block max-w-[100px] truncate"><?php echo e($sikayet->sikayetKategori->bolum->ad ?? 'Bölüm Yok'); ?></span>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </td>
                            <td class="px-3 py-3 text-sm text-gray-600 space-y-1 whitespace-nowrap">
                                <div class="flex items-center gap-1.5" title="Başlangıç Tarihi">
                                    ...
                                    <?php echo e($baslangic->format('d.m.Y')); ?>

                                </div>
                                <!--[if BLOCK]><![endif]--><?php if($bitis): ?>
                            ...
                            <td class="px-3 py-3">
                                <!--[if BLOCK]><![endif]--><?php if($sikayet->iaaProjesi && $sikayet->iaaProjesi->durum == 'talep_olarak_kapatildi'): ?>
                                    <span
                                        ...
                                        Talep</span>
                                <?php elseif($sikayet->iaaProjesi && $sikayet->iaaProjesi->durum == 'hatali_bildirim_olarak_kapatildi'): ?>
                                    <span
                                ...
                                <?php else: ?>
                                    ...
                                    ?>
                                    <span
                                        class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold border <?php echo e($class); ?>">
                                        <?php echo e($metin); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($totalCount > $perPage): ?>
            <div class="px-6 py-4 border-t border-gray-200 bg-gray-50 flex justify-center">
                <button wire:click="loadMore"
                    ...
                    Daha Fazla Göster (<span class="text-indigo-600 ml-1"><?php echo e($totalCount - $perPage); ?></span> kaldı)
                </button>
            </div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    </div>
    ...
    ?>
</div><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/livewire/admin/sikayet-rapor-sayfasi.blade.php ENDPATH**/ ?>