            ...
            <div class="p-5 md:p-6 pl-7"> 
                ...
                <div class="flex flex-col md:flex-row justify-between items-start gap-4 mb-5">
                    ...
                    <div class="flex-shrink-0 flex flex-col items-end gap-1">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', 'Superadmin|Yonetim|Müşteri Şikayeti Kurulu|Müşteri Şikayeti Kurulu - Yurt İçi|Müşteri Şikayeti Kurulu - Yurt Dışı|Müşteri Şikayeti Kurulu Yöneticisi|Müşteri Şikayeti Kurulu Yöneticisi - Yurt İçi|Müşteri Şikayeti Kurulu Yöneticisi - Yurt Dışı|Bölüm Kalite Yöneticisi|Müşteri Şikayeti Çözüm Lideri')): ?>
                ...
                <div class="flex flex-wrap items-center justify-end gap-2 pt-3 border-t border-gray-100">
                    ...
                    <button x-data="{ loading: false }"
                        @click="loading = true; $wire.$dispatch('openTriyajModal', { id: <?php echo e($sikayet->id); ?> })"
