    ...
    <div class="bg-white border border-green-200 rounded-xl shadow-sm mb-8 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-green-50 to-white px-6 py-4 border-b border-green-100 flex justify-between items-center">
            ...
            <div class="text-right">
                ...
                <p class="font-mono text-gray-700 font-bold"><?php echo e($case->updated_at->format('d.m.Y H:i')); ?></p>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
                ...
                <div class="p-4 bg-gray-50 rounded-lg border border-gray-100 flex flex-col justify-center">
                    ...
                    <div class="flex items-baseline gap-2">
                        <p class="text-3xl font-black text-gray-800"><?php echo e($yuvarlanmisGun); ?> GÜN</p>
                    </div>
                    <p class="text-[10px] text-gray-400 font-medium mt-1">(<?php echo e($detaySure); ?>)</p>
                </div>
                ...
                <div class="p-4 bg-green-50 rounded-lg border border-green-100 flex flex-col justify-center">
                    ...
                    <p class="text-2xl font-black text-green-700">
                        <?php echo e(number_format($case->anlasilan_tutar, 2)); ?> <span class="text-sm font-normal text-green-600">TL</span>
                    </p>
                </div>
                ...
                <div class="p-4 bg-orange-50 rounded-lg border border-orange-100 flex flex-col justify-center">
                    ...
                    <div class="flex items-center gap-2">
                        <div class="w-8 h-8 rounded-full bg-orange-200 flex items-center justify-center text-orange-700 font-bold text-xs uppercase">
                            <?php echo e(substr($baslatanKisi->name ?? '?', 0, 1)); ?>

                        </div>
                        <div>
                            <p class="text-sm font-bold text-orange-900 truncate" title="<?php echo e($baslatanKisi->name ?? 'Bilinmiyor'); ?>">
                                <?php echo e($baslatanKisi->name ?? 'Bilinmiyor'); ?>
                ...
                <div class="p-4 bg-purple-50 rounded-lg border border-purple-100 flex flex-col justify-center">
                    ...
                    <div class="flex items-center gap-2">
                        <div class="w-8 h-8 rounded-full bg-purple-200 flex items-center justify-center text-purple-700 font-bold text-xs uppercase">
                            <?php echo e(substr($kapatanKisi, 0, 1)); ?>

                        </div>
                        <p class="text-sm font-bold text-purple-900 truncate" title="<?php echo e($kapatanKisi); ?>">
                            <?php echo e($kapatanKisi); ?>
                        ...
                        <?php if($odeme): ?>
                            <ul class="space-y-3 text-sm">
                                <li class="flex justify-between">
                                    ...
                                    <span class="font-bold text-gray-800"><?php echo e($odeme->odenecek_kisi); ?></span>
                                </li>
                                <li class="flex justify-between">
                                    <span class="text-gray-500">Banka:</span>
                                    <span class="font-bold text-gray-800"><?php echo e($odeme->banka_adi); ?></span>
                                </li>
                                <li class="flex justify-between">
                                    <span class="text-gray-500">IBAN:</span>
                                    <span class="font-mono text-gray-600 bg-gray-100 px-2 rounded"><?php echo e($odeme->iban); ?></span>
                                </li>
                                <li class="flex justify-between items-center">
                                    <span class="text-gray-500">Dekont:</span>
                                    <?php if($dekont): ?>
                                        <a href="<?php echo e(asset('storage/'.$dekont->dosya_yolu)); ?>" target="_blank" class="text-xs bg-green-100 text-green-700 px-2 py-1 rounded hover:bg-green-200 font-bold flex items-center gap-1">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-sm">
                            <li class="flex justify-between items-center">
                                ...
                                <?php if($taslakAnlasma): ?>
                                    <a href="<?php echo e(asset('storage/'.$taslakAnlasma->dosya_yolu)); ?>" target="_blank" class="text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded hover:bg-gray-200 font-bold flex items-center gap-1">
                            ...
                            <li class="flex justify-between items-center">
                                ...
                                <?php if($sonTutanak): ?>
                                    <a href="<?php echo e(asset('storage/'.$sonTutanak->dosya_yolu)); ?>" target="_blank" class="text-xs bg-red-100 text-red-700 px-2 py-1 rounded hover:bg-red-200 font-bold flex items-center gap-1">
                ...
                <div>
                    ...
                    <div class="relative border-l-2 border-gray-200 ml-3 space-y-6">
                        <div class="relative pl-6">
                            ...
                            <p class="text-xs text-gray-500"><?php echo e($case->created_at->format('d.m.Y H:i')); ?></p>
                            <p class="text-sm font-bold text-gray-800">Süreç Başlatıldı</p>
                            <p class="text-xs text-gray-500">Oluşturan: <?php echo e($case->creator->name ?? 'Sistem'); ?></p>
                        </div>
                        <?php if($case->arabulucu): ?>
                            <div class="relative pl-6">
                                ...
                                <p class="text-xs text-gray-500"><?php echo e($case->arabulucu->name); ?></p>
                            </div>
                        <?php endif; ?>
                        <?php if($dekont): ?>
                        <div class="relative pl-6">
                            <span class="absolute -left-[9px] top-1 h-4 w-4 rounded-full bg-yellow-400 border-2 border-white"></span>
                            <p class="text-xs text-gray-500"><?php echo e($dekont->created_at->format('d.m.Y H:i')); ?></p>
                            <p class="text-sm font-bold text-gray-800">Ödeme Yapıldı</p>
                            <p class="text-xs text-gray-500">İşlemi Yapan: <?php echo e($finansci); ?></p>
                        </div>
                        <?php endif; ?>
                        <div class="relative pl-6">
                            <span class="absolute -left-[9px] top-1 h-4 w-4 rounded-full bg-green-500 border-2 border-white animate-pulse"></span>
                            <p class="text-xs text-green-600"><?php echo e($case->updated_at->format('d.m.Y H:i')); ?></p>
                            <p class="text-sm font-bold text-green-800">Süreç Tamamlandı</p>
                            <p class="text-xs text-gray-500">Kapatan: <?php echo e($kapatanKisi); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php endif; ?><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/admin/arabuluculuk/parcalar/genel-surec-sonuc-ekrani.blade.php ENDPATH**/ ?>