<div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-purple-200">
                    ...
                    <?php $__currentLoopData = $iaas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iaa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-purple-50/30 transition-colors duration-150">
                            <td class="px-6 py-4">
                                ...
                                <div class="text-xs text-gray-500 mt-0.5">ID: #<?php echo e($iaa->id); ?></div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex flex-col">
                                    <span class="text-sm font-medium text-gray-700"><?php echo e($iaa->bolum->ad ?? 'Genel'); ?></span>
                                    <?php if($iaa->musteriSikayeti && $iaa->musteriSikayeti->sikayetKategori): ?>
                                        <span class="text-xs text-purple-600 font-medium mt-0.5">
                                            <?php echo e($iaa->musteriSikayeti->sikayetKategori->ad); ?>
                            ...
                            <td class="px-6 py-4 text-right text-sm font-medium">
                                ...
                                <?php if($yetkiliMi): ?>
                                    <div x-data="{ showRevizeModal: false, showRedModal: false }" class="flex items-center justify-end space-x-2">
                                        ...
                                        <a href="<?php echo e(route('proje.workspace.show', $iaa->id)); ?>" target="_blank" 
                                        ...
                                        <form action="<?php echo e(route('admin.iaa-yonetim.bolumOnayiVer', $iaa->id)); ?>" method="POST" class="inline-block">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" 
                                        ...
                                        <div x-show="showRevizeModal" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
                                            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                                ...
                                                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                                    <form action="<?php echo e(route('admin.iaa-yonetim.bolumRevizyon', $iaa->id)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div x-show="showRedModal" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
                                            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                                ...
                                                <span class="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">&#8203;</span>
                                                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                                    <form action="<?php echo e(route('admin.iaa-yonetim.bolumReddet', $iaa->id)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
                                                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                                            <div class="sm:flex sm:items-start">
    ...
    <?php endif; ?>
</div><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/admin/iaa-yonetim/partials/bolum-onayi-bekleyenler-table.blade.php ENDPATH**/ ?>