...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-10 bg-gradient-to-br from-gray-50 via-white to-gray-100">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
                    ...
                    <div class="p-4 flex items-start justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900">
                                <?php echo e($aktifKullanicilar->total()); ?>
                ...
                <div class="relative overflow-hidden rounded-2xl border border-yellow-200/60 bg-white shadow-sm">
                    <div class="p-4 flex items-start justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900">
                                <?php echo e($kayitOnayiAktif && $onayBekleyenler->isNotEmpty() ? $onayBekleyenler->total() : 0); ?>
            ...
            <?php if($kayitOnayiAktif && $onayBekleyenler->isNotEmpty()): ?>
                                    ...
                                    <tr class="hover:bg-yellow-50/40 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-xs font-medium">
                                            <div class="flex items-center justify-end gap-2">
                                                ...
                                                <a href="<?php echo e(route('admin.users.edit', $user)); ?>" class="px-2.5 py-0.5 text-xs font-medium rounded-full bg-indigo-100 text-indigo-700 hover:bg-indigo-200 transition-colors">
                                                    Düzenle
                                                </a>
                                                <form method="POST" action="<?php echo e(route('admin.users.destroy', $user)); ?>" onsubmit="return confirm('Bu kullanıcı kaydını kalıcı olarak silmek istediğinizden emin misiniz?');">
            ...
            <div class="bg-white/80 backdrop-blur-sm overflow-hidden shadow-xl rounded-2xl border border-gray-200 ring-1 ring-gray-100">
                <div class="p-6 sm:p-8 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white flex flex-col gap-4">
                    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between w-full gap-4">
                        ...
                        <div class="flex items-center gap-2 text-xs">
                            <div class="px-2.5 py-1 rounded-lg border border-gray-300 bg-white text-gray-700 font-semibold shadow-sm">
                                Toplam: <?php echo e($aktifKullanicilar->total()); ?>
                    ...
                    <form method="GET" action="<?php echo e(route('admin.users.index')); ?>" class="bg-white/60 border border-gray-200 rounded-xl p-4 shadow-inner">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="name_filter" id="name_filter"
                                       value="<?php echo e($filters['name_filter'] ?? ''); ?>"
                                ...
                                <select name="role_filter" id="role_filter"
                                    ...
                                    <?php $__currentLoopData = $roller; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($role->name); ?>"
                                                <?php if(isset($filters['role_filter']) && $filters['role_filter'] == $role->name): ?> selected <?php endif; ?>>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            <?php $__empty_1 = true; $__currentLoopData = $aktifKullanicilar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-indigo-50/40 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-xs text-gray-700">
                                        <?php if($user->bolum && $user->bolum->ad): ?>
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            <?php $__empty_2 = true; $__currentLoopData = $user->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                <span class="
                                                    ...
                                                    <?php elseif($role->name == 'Müşteri Şikayeti Kurulu'): ?>
                                                        bg-yellow-50 text-yellow-700 ring-yellow-200
                                                    <?php elseif($role->name == 'Bölüm Lideri'): ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-xs font-medium">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <form method="POST" action="<?php echo e(route('admin.users.destroy', $user)); ?>" onsubmit="return confirm('Bu kullanıcıyı silmek istediğinizden emin misiniz?');">
                                                <?php echo csrf_field(); ?> <?php echo method_field('delete'); ?>
                                                <button type="submit" class="px-2.5 py-0.5 text-xs font-medium rounded-full bg-red-100 text-red-700 hover:bg-red-200 transition-colors">
                                                    Sil
                                                </button>
                ...
                <?php if($aktifKullanicilar->hasPages()): ?>
                    <div class="p-6 bg-gray-50 border-t border-gray-200">
                        <?php echo e($aktifKullanicilar->links()); ?>
