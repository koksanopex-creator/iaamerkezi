        ...
        <dl class="grid grid-cols-1 md:grid-cols-{{ $iaa->musteriSikayeti ? 4 : 5 }} gap-4">
            ...
            <div class="bg-gradient-to-r from-red-50 to-orange-50 rounded-lg p-3 shadow-sm border-2 border-red-200 flex flex-col justify-between"
                ...
                @if(in_array($iaa->durum, ['Tamamlandı', 'talep_olarak_kapatildi', 'hatali_bildirim_olarak_kapatildi']))
                    ...
                    @endif
                @else
                    <div x-show="deadline" class="mt-2 text-sm font-bold tracking-tight"
                        :class="{'text-red-600 animate-pulse': days < 0, 'text-green-600': days >= 0}" x-cloak>
        ...
        <div class="mt-8 mb-4 animate-fade-in-up">
            @php
                ...
                $displayLabel = match($durum) {
                    'talep_onayi_bekliyor_kalite' => '🟣 Talep Onayı Bekleniyor (Kalite)',
                    'talep_onayi_bekliyor_direktor' => '🟣 Talep Onayı Bekleniyor (Direktör)',
                    'talep_onayi_bekliyor_superadmin' => '🟣 Talep Onayı Bekleniyor (Yönetim)',
                    'hatali_bildirim_onayi_bekliyor_kalite' => '🟠 Hatalı Bildirim Onayı (Kalite)',
                    'hatali_bildirim_onayi_bekliyor_direktor' => '🟠 Hatalı Bildirim Onayı (Direktör)',
                    'hatali_bildirim_onayi_bekliyor_superadmin' => '🟠 Hatalı Bildirim Onayı (Yönetim)',
                    'talep_olarak_kapatildi' => 'Talep Olarak Kapatıldı',
                    'hatali_bildirim_olarak_kapatildi' => 'İptal / Hatalı',
                    default => $durum
                };
            @endphp
