<div x-data="{ activeBolum: <?php echo e($stats['direktor_bolumleri']->first()->id ?? 'null'); ?>, currentFilter: 'all' }" class="space-y-8">
        ...
        <div x-show="activeBolum === <?php echo e($bolum->id); ?>" x-cloak x-transition:enter="transition-opacity duration-300" class="space-y-8 animate-fade-in">
            <?php if($bData): ?>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <!-- Aktif Şikayet -->
                    <?php if($bData['is_responsible_for_sikayet']): ?>
                ...
                <?php if($bData['bolum_sikayet_count'] > 0): ?>
                <div id="bolum-sikayetleri-tablosu-<?php echo e($bolum->id); ?>" class="bg-white rounded-2xl border border-red-100 shadow-sm overflow-hidden scroll-mt-24">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                <?php $__currentLoopData = $bData['bolum_sikayetleri']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sikayet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php 
                                        $rowKey = 'all';
                                    ...
                                    ?>
                                    <tr x-show="currentFilter === 'all' || currentFilter === '<?php echo e($rowKey); ?>' || (currentFilter === 'geciken' && <?php echo e($isDelayed ? 'true' : 'false'); ?>)" 
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="flex flex-col items-center gap-1.5">
                                                ...
                                                <?php if($sikayet->iaaProjesi): ?>
                                                    <div class="flex items-center gap-1 px-1.5 py-0.5 rounded bg-<?php echo e($sikayet->iaaProjesi->durum_rengi ?? 'gray'); ?>-50 text-<?php echo e($sikayet->iaaProjesi->durum_rengi ?? 'gray'); ?>-600 border border-<?php echo e($sikayet->iaaProjesi->durum_rengi ?? 'gray'); ?>-100 text-[9px] font-medium italic">
                                                        ...
                                                        Proje: <?php echo e($sikayet->iaaProjesi->durum); ?>

                                                        <?php if(in_array($sikayet->iaaProjesi->durum, ['talep_olarak_kapatildi', 'hatali_bildirim_olarak_kapatildi', 'Talep Olarak Kapatıldı'])): ?>
                                                            <span class="ml-1 px-1 py-0.5 rounded bg-amber-100 text-amber-700 text-[8px] font-bold uppercase">
                                                                <?php echo e($sikayet->iaaProjesi->durum_etiketi); ?>
                    ...
                    <?php if($bData['bolum_sikayet_count'] > 10): ?>
                        <div class="px-6 py-3 bg-gray-50 border-t border-red-50 text-center">
                            <a href="<?php echo e(route('admin.sikayetler.index')); ?>" class="text-sm font-bold text-red-600 hover:text-red-800 transition flex items-center justify-center gap-1">
                                <span>Tümünü Gör (Toplam <?php echo e($bData['bolum_sikayet_count']); ?> Kayıt)</span>
                ...
                <?php if($bData['bolum_iaa_projeleri']->count() > 0): ?>
                <div id="bolum-iaa-tablosu-<?php echo e($bolum->id); ?>" class="bg-white rounded-2xl border border-indigo-100 shadow-sm overflow-hidden scroll-mt-24">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                <?php $__currentLoopData = $bData['bolum_iaa_projeleri']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iaa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php 
                                        $rowKey = 'all';
                                    ...
                                    <tr x-show="currentFilter === 'all' || currentFilter === '<?php echo e($rowKey); ?>' || (currentFilter === 'geciken' && <?php echo e($isDelayed ? 'true' : 'false'); ?>)" 
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <span class="px-2 py-1 rounded-full bg-<?php echo e($iaa->durum_rengi ?? 'gray'); ?>-100 text-<?php echo e($iaa->durum_rengi ?? 'gray'); ?>-700 font-bold border border-<?php echo e($iaa->durum_rengi ?? 'gray'); ?>-200 text-[10px]">
                    ...
                    <?php if($bData['total_iaa_count'] > 10): ?>
                        <div class="px-6 py-3 bg-gray-50 border-t border-indigo-50 text-center">
                            <a href="<?php echo e(route('admin.iaa-yonetim.index')); ?>" class="text-sm font-bold text-indigo-600 hover:text-indigo-800 transition flex items-center justify-center gap-1">
                                <span>Tümünü Gör (Toplam <?php echo e($bData['total_iaa_count']); ?> Kayıt)</span>
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path></svg>
                            </a>
                        </div>
                    <?php endif; ?>
                ...
                <?php if($bData['bolum_disiplin_count'] > 0): ?>
                <div id="bolum-disiplin-tablosu-<?php echo e($bolum->id); ?>" class="bg-white rounded-2xl border border-orange-100 shadow-sm overflow-hidden scroll-mt-24">
                    <div class="px-6 py-4 border-b border-orange-50 bg-orange-50/50 flex justify-between items-center">
                        ...
                        <span class="text-xs font-bold text-orange-600 bg-orange-100 px-2.5 py-1 rounded-full"><?php echo e($bData['bolum_disiplin_count']); ?> Kayıt</span>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                <?php $__currentLoopData = $bData['bolum_disiplinleri'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $case): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50 transition cursor-pointer" onclick="window.location='<?php echo e(route('disiplin.show', $case->id)); ?>'">
                    ...
                    <?php if($bData['bolum_disiplin_count'] > 5): ?>
                        <div class="px-6 py-3 bg-gray-50 border-t border-orange-50 text-center">
                            <a href="<?php echo e(route('disiplin.index')); ?>" class="text-sm font-bold text-orange-600 hover:text-orange-800 transition flex items-center justify-center gap-1">
                                <span>Tümünü Gör (Toplam <?php echo e($bData['bolum_disiplin_count']); ?> Kayıt)</span>
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path></svg>
                            </a>
                        </div>
                    <?php endif; ?>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-visible mt-8">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                <?php $__currentLoopData = $bData['personel_listesi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $personel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php 
                                        $isLider = ($bolum->lider_user_id && $personel->id == $bolum->lider_user_id);
                                        $isOnline = $personel->isOnline();
                                    ?>
                                    <tr class="<?php echo e($isLider ? 'bg-amber-50/70 border-l-4 border-amber-400 sticky top-0 z-20' : 'hover:bg-gray-50'); ?> transition-all border-b border-gray-100 last:border-0">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                <?php $__empty_1 = true; $__currentLoopData = $bData['bolum_personel_gorevleri']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gorev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    ?>
                                    <tr class="hover:bg-gray-50 transition cursor-pointer" onclick="window.location='<?php echo e($targetRoute); ?>'">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex flex-col">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <span class="px-2 py-1 rounded-full bg-<?php echo e($gorev->durum_rengi ?? 'gray'); ?>-50 text-<?php echo e($gorev->durum_rengi ?? 'gray'); ?>-700 font-bold border border-<?php echo e($gorev->durum_rengi ?? 'gray'); ?>-100 text-[10px]">
                                                <?php if($gorev->durum == 'Bölüm Onayı Bekliyor'): ?>
                                                    Bölüm Onayı Bekliyor
                                                <?php else: ?>
                                                    <?php echo e($gorev->aktifAdim ? $gorev->aktifAdim->name : $gorev->durum); ?>
                     ...
                     <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <?php $__currentLoopData = collect($bData['list']['iaa']['onay_bekleyen'] ?? [])->merge($bData['list']['sikayet']['onay_bekleyen'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <a href="<?php echo e($targetRoute); ?>" class="group block bg-white border border-orange-200 p-4 rounded-xl hover:shadow-lg transition">
                                ...
                                <p class="text-sm font-bold text-gray-900 line-clamp-2 group-hover:text-indigo-600 transition"><?php echo e($item->baslik); ?></p>
