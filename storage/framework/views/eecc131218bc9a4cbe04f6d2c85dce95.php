<div class="bg-white rounded-2xl shadow-xl overflow-hidden mb-8 border border-gray-100 mt-8">
    ...
    <div class="px-6 py-6 border-b border-gray-100 bg-gradient-to-br from-red-600 to-rose-700 relative overflow-hidden">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative z-10">
            <div class="flex-1">
                ...
                <?php if(isset($iadeToplamlari) && count($iadeToplamlari) > 0): ?>
                    <div class="flex flex-wrap items-center gap-2 mt-3">
                        <span class="text-[10px] font-bold text-gray-400 uppercase tracking-wider mr-1">Genel Toplam:</span>
                        <?php $__currentLoopData = $iadeToplamlari; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $birim => $miktar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="inline-flex items-center px-3 py-1.5 rounded-xl text-xs font-black bg-white/10 backdrop-blur-md text-white border border-white/20 shadow-sm">
                                ...
                                <?php echo e(number_format($miktar, 0, ',', '.')); ?> <?php echo e($birim); ?>
            ...
            <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm w-full lg:w-auto">
                <form method="GET" action="<?php echo e(route('dashboard')); ?>" class="flex flex-col lg:flex-row items-stretch lg:items-center gap-4">
                    <input type="hidden" name="active_dashboard" value="<?php echo e($activeDashboard ?? ''); ?>">
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-2 flex-1">
                        <div class="relative w-full">
                            ...
                            <input type="text" name="return_search" value="<?php echo e(request('return_search')); ?>"
                        ...
                        <div class="flex items-center gap-2 w-full sm:w-auto">
                            <div class="relative w-full">
                                <input type="date" name="return_start_date" value="<?php echo e(request('return_start_date')); ?>"
                            ...
                            <div class="relative w-full">
                                <input type="date" name="return_end_date" value="<?php echo e(request('return_end_date')); ?>"
                                    class="w-full text-xs border-gray-200 rounded-lg focus:ring-red-500 focus:border-red-500 py-2.5 px-3 shadow-inner bg-gray-50/50"
                                    placeholder="Bitiş">
                            </div>
                        </div>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <?php if(request('return_start_date') || request('return_end_date') || request('return_search')): ?>
                            <a href="<?php echo e(route('dashboard', array_filter(['active_dashboard' => $activeDashboard ?? null]))); ?>"
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-100">
            ...
            <tbody class="bg-white divide-y divide-gray-50">
                <?php $iadeLimit = $iadeLimit ?? null; ?>
                <?php $__empty_1 = true; $__currentLoopData = $iadeVerileri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-red-50/30 transition-all group border-b border-gray-50 last:border-0"
                        <?php if($iadeLimit && $loop->index >= $iadeLimit): ?>
                            x-show="iadeShowAll"
                    ...
                    >
                        <td class="px-6 py-5 whitespace-nowrap text-sm text-gray-600">
                            <div class="font-bold text-gray-800">
                                <?php echo e($iade->iade_tarihi ? $iade->iade_tarihi->format('d.m.Y') : $iade->created_at->format('d.m.Y')); ?>

                            </div>
                            <div class="text-[10px] text-gray-400 font-medium"><?php echo e($iade->created_at->diffForHumans()); ?></div>
                        </td>
                        <td class="px-6 py-5">
                            <div class="flex flex-col">
                                <?php if(isset($iade->musteriSikayeti->customer_id)): ?>
                                    <a href="<?php echo e(route('musteri.profil.show', $iade->musteriSikayeti->customer_id)); ?>" 
                                       class="text-sm font-bold text-gray-900 line-clamp-1 hover:text-red-600 transition-all flex items-center gap-1 group/link"
                                       title="<?php echo e($iade->musteriSikayeti->musteri_adi ?? '-'); ?>">
                                        <?php echo e($iade->musteriSikayeti->musteri_adi ?? 'Belirtilmemiş'); ?>
                                ...
                                <?php endif; ?>
                                <?php if($iade->musteriSikayeti->sikayetKategori && $iade->musteriSikayeti->sikayetKategori->bolum): ?>
                                    <span
                                        ...
                                        <?php echo e($iade->musteriSikayeti->sikayetKategori->bolum->ad); ?>
                        ...
                        <td class="px-6 py-5">
                            <div class="text-sm text-gray-800 font-bold line-clamp-1 group-hover:text-red-700 transition-colors"
                                title="<?php echo e($iade->musteriSikayeti->musteri_sikayet_konusu ?? ''); ?>">
                                <?php echo e($iade->musteriSikayeti->musteri_sikayet_konusu ?? '-'); ?>

                            </div>

                            <div class="flex flex-wrap items-center gap-2 mt-2">
                                
                                <a href="<?php echo e(route('admin.sikayetler.show', $iade->musteri_sikayeti_id)); ?>"
                                    ...
                                    #<?php echo e($iade->musteriSikayeti->id); ?>

                                </a>

                                
                                <?php if($iade->musteriSikayeti->iaaProjesi): ?>
                                    <a href="<?php echo e(route('proje.workspace.show', $iade->musteriSikayeti->iaaProjesi->id)); ?>"
                                        ...
                                        Prj #<?php echo e($iade->musteriSikayeti->iaaProjesi->id); ?>
                        ...
                        <td class="px-6 py-5">
                            <div class="text-sm text-gray-800 font-medium"><?php echo e($iade->urun_turu); ?></div>
                            <div class="text-[11px] text-red-500 font-bold bg-red-50 px-2 py-0.5 rounded-full w-fit mt-1"><?php echo e($iade->iade_sebebi); ?></div>
                        </td>
                        <td class="px-6 py-5 whitespace-nowrap text-right">
                            <div class="flex flex-col items-end">
                                ...
                                <?php if($iade->toplam_parti_miktari): ?>
                                    <span class="text-[10px] text-gray-400 mt-1.5 font-bold uppercase tracking-tighter">
                                        Parti: <?php echo e(number_format($iade->toplam_parti_miktari, 0, ',', '.')); ?> <?php echo e($iade->birim); ?>
    ...
    <?php if($iadeLimit && count($iadeVerileri) > $iadeLimit): ?>
        <div class="px-6 py-4 border-t border-gray-100 flex items-center justify-center gap-3">
            ...
            <button x-show="!iadeShowAll" @click="iadeShowAll = true"
                ...
                Devamını Yükle
                <span class="bg-red-100 text-red-600 px-2 py-0.5 rounded-lg text-[10px] font-black">+<?php echo e(count($iadeVerileri) - $iadeLimit); ?></span>
            </button>
    ...
    <?php if(isset($iadeVerileri) && $iadeVerileri instanceof \Illuminate\Pagination\LengthAwarePaginator && $iadeVerileri->count() > 0 && !isset($iadeLimit)): ?>
        <div class="px-6 py-4 border-t border-gray-100">
            <?php echo e($iadeVerileri->links()); ?>

        </div>
    <?php endif; ?>
</div><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/dashboard/partials/iadeler-tablosu.blade.php ENDPATH**/ ?>