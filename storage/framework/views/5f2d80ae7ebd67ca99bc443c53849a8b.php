...
<?php if(in_array($case->durum, ['Karar Verildi', 'Kurulda'])): ?>
            ...
            <div class="relative flex flex-col md:flex-row justify-between items-start gap-6">
                <div class="flex-1 w-full">
                    ...
                    <div class="flex items-center gap-4 mb-6">
                        <div class="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-<?php echo e($cardColor); ?>-500 to-<?php echo e($cardColor); ?>-700 rounded-2xl flex items-center justify-center shadow-lg transform -rotate-2">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <?php else: ?> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                                <?php endif; ?>
                            </svg>
                        </div>
                        
                        <div>
                            <h3 class="text-2xl font-black text-<?php echo e($cardColor); ?>-900 leading-tight"><?php echo e($cardTitle); ?></h3>
                            
                            <div class="flex flex-wrap items-center gap-2 mt-2">
                                
                                <span class="inline-flex items-center px-3 py-1 rounded-md text-xs font-bold bg-white text-<?php echo e($cardColor); ?>-700 border border-<?php echo e($cardColor); ?>-200 shadow-sm">
                                    ...
                                    İşlem: <?php echo e($case->karar_tarihi ? $case->karar_tarihi->format('d.m.Y H:i') : 'Tarih Yok'); ?>
                                ...
                                <?php if($case->toplanti_tarihi): ?>
                                    <span class="inline-flex items-center px-3 py-1 rounded-md text-xs font-bold bg-slate-100 text-slate-600 border border-slate-200 shadow-sm">
                                        ...
                                        Toplantı: <?php echo e($case->toplanti_tarihi->format('d.m.Y H:i')); ?>
                    ...
                    <div class="space-y-5">
                        ...
                        <?php if($case->final_karar): ?>
                            <div class="bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-<?php echo e($cardColor); ?>-200">
                                <span class="block text-[10px] font-bold text-<?php echo e($cardColor); ?>-400 uppercase tracking-wider mb-1">Nihai Karar</span>
                                <p class="text-lg font-bold text-gray-800"><?php echo e($case->final_karar); ?></p>
                            </div>
                        <?php endif; ?>
                        
                        
                        <?php if($case->yonetici_notu): ?>
                            <div class="bg-white/60 backdrop-blur-sm rounded-xl p-5 border border-<?php echo e($cardColor); ?>-200 relative group">
                                <span class="block text-[10px] font-bold text-<?php echo e($cardColor); ?>-400 uppercase tracking-wider mb-2">Yönetici / Kurul Açıklaması</span>
                                <p class="text-sm text-gray-700 italic leading-relaxed">"<?php echo e($case->yonetici_notu); ?>"</p>
                            </div>
                        <?php endif; ?>

                        
                        <?php if($case->karar_dosyasi): ?>
                            <?php
                            ...
                            ?>
                            <div class="mt-4">
                                <span class="text-[10px] font-bold text-<?php echo e($cardColor); ?>-400 uppercase tracking-wider block mb-2">Karar / Tutanak Dosyası</span>
                                <a href="<?php echo e($kUrl); ?>" target="_blank" class="flex items-center gap-4 p-3 border border-<?php echo e($cardColor); ?>-200 rounded-xl bg-white hover:bg-<?php echo e($cardColor); ?>-50 transition group max-w-md shadow-sm">
                                    <div class="h-12 w-12 flex-shrink-0 bg-<?php echo e($cardColor); ?>-50 rounded-lg flex items-center justify-center overflow-hidden border border-<?php echo e($cardColor); ?>-100">
                                        <?php if($kIsImage): ?> <img src="<?php echo e($kUrl); ?>" class="w-full h-full object-cover">
                                        <?php else: ?> <span class="text-xs font-black text-<?php echo e($cardColor); ?>-500 uppercase"><?php echo e($kExt); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <p class="text-sm font-bold text-gray-800 truncate"><?php echo e(basename($case->karar_dosyasi)); ?></p>
                                        <p class="text-[10px] text-<?php echo e($cardColor); ?>-500 font-medium flex items-center gap-1 group-hover:underline">Görüntülemek için tıklayın</p>
                                    </div>
                                </a>
                            </div>
                        <?php endif; ?>
                ...
                <?php if(Auth::user()->hasRole(['Superadmin', 'Hukuk Yöneticisi', 'Hukuk Admini', 'Disiplin Kurulu Başkanı'])): ?>
                    <div class="flex-shrink-0 mt-4 md:mt-0">
                        <form action="<?php echo e(route('admin.disiplin.decision.revoke', $case->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php if($case->durum == 'Yönetici Değerlendirmesi' && Auth::user()->hasRole(['Superadmin', 'Hukuk Yöneticisi', 'Hukuk Admini'])): ?>
            ...
            <form method="POST" enctype="multipart/form-data" class="relative z-10">
                ...
                <div class="mt-8 pt-6 border-t border-indigo-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <button type="submit" formaction="<?php echo e(route('admin.disiplin.penalty.approve', $case->id)); ?>" onclick="return confirm('Ceza onaylanacak ve <?php echo e($case->hesaplanan_puan); ?> puan düşülecek. Emin misiniz?')" class="group relative overflow-hidden bg-white border-2 border-rose-100 rounded-xl p-4 hover:border-rose-500 hover:shadow-lg transition-all duration-300 text-left">
                        ...
                        <button type="submit" formaction="<?php echo e(route('admin.disiplin.defense.accept', $case->id)); ?>" onclick="return confirm('Dosya cezasız kapatılacak. Emin misiniz?')" class="group relative overflow-hidden bg-white border-2 border-emerald-100 rounded-xl p-4 hover:border-emerald-500 hover:shadow-lg transition-all duration-300 text-left">
                        ...
                        <button type="submit" formaction="<?php echo e(route('admin.disiplin.board.send', $case->id)); ?>" onclick="return confirm('Dosya Kurul\'a sevk edilecek. Emin misiniz?')" class="group relative overflow-hidden bg-white border-2 border-slate-200 rounded-xl p-4 hover:border-slate-800 hover:shadow-lg transition-all duration-300 text-left">
