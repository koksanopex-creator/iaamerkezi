                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="olay_tarihi" value="<?php echo e(old('olay_tarihi')); ?>" class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            </div>
                        </div>
                    </div>
...
<?php endif; ?><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/admin/disiplin/create.blade.php ENDPATH**/ ?>