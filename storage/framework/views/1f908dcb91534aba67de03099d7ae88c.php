...
<div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6"
     x-data="{
        ...
        selectedSubCategory: '<?php echo e(old('sikayet_alt_kategori_id', $sikayet->sikayet_alt_kategori_diger ? 'other' : $sikayet->sikayet_alt_kategori_id)); ?>',
        subCategories: [],
        ...
        init() {
            if (this.selectedCategory) { this.fetchSubCategories(true); }
        },
        ...
        fetchSubCategories(keepSelection = false) {
            ...
            this.isLoading = true;
            fetch('/api/get-alt-kategoriler/' + this.selectedCategory)
                .then(res => res.json())
                .then(data => {
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="group" x-show="subCategories.length > 0 || showOtherOption" style="display: none;">
        <label for="sikayet_alt_kategori_id" class="flex items-center font-semibold text-sm text-gray-700 mb-2">Alt Kategori</label>
        <div class="relative">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="group md:col-span-2 bg-gray-50 p-4 rounded border border-gray-200" 
        ...
        <input type="text" name="sikayet_alt_kategori_diger" id="sikayet_alt_kategori_diger" 
               ...
               class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 py-3">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="group">
                                ...
                                <input
                                    ...
                                    value="<?php echo e(old('musteri_sikayet_tarihi', $sikayet->musteri_sikayet_tarihi ? $sikayet->musteri_sikayet_tarihi->format('Y-m-d') : date('Y-m-d'))); ?>"
                                    required
                                    class="mt-1 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out pl-4 pr-4 py-3 text-gray-900">                                <?php $__errorArgs = ['musteri_sikayet_tarihi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm mt-1 flex items-center"><svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg><?php echo e($message); ?></span> <?php unset($message);
