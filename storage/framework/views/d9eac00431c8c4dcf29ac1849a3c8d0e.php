...
<?php $component->withAttributes([]); ?>
    ...
    <form action="<?php echo e(route('public.sikayet.store')); ?>" method="POST" enctype="multipart/form-data" x-data="fileUploadComponent()">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
            ...
            <div class="group col-span-1">
                ...
                <input type="text" name="musteri_adi" id="musteri_adi" value="<?php echo e(old('musteri_adi', auth()->user()?->name)); ?>" required class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500 transition duration-150 ease-in-out pl-4 pr-4 py-2.5 text-gray-900" placeholder="Adınız ve Soyadınız">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="group col-span-1">
                ...
                <input type="email" name="musteri_iletisim" id="musteri_iletisim" value="<?php echo e(old('musteri_iletisim', auth()->user()?->email)); ?>" required class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500 transition duration-150 ease-in-out pl-4 pr-4 py-2.5 text-gray-900" placeholder="ornek@mail.com">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="group col-span-1">
                ...
                <input type="date" name="musteri_sikayet_tarihi" id="musteri_sikayet_tarihi" value="<?php echo e(old('musteri_sikayet_tarihi', date('Y-m-d'))); ?>" required class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500 transition duration-150 ease-in-out pl-4 pr-4 py-2.5 text-gray-900">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-span-1 md:col-span-2 group">
                ...
                <input type="text" name="musteri_sikayet_konusu" id="musteri_sikayet_konusu" value="<?php echo e(old('musteri_sikayet_konusu')); ?>" required class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500 transition duration-150 ease-in-out pl-4 pr-4 py-2.5 text-gray-900" placeholder="Sorunu kısaca özetleyin">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-span-1 md:col-span-2 group">
                ...
                <textarea name="musteri_sikayet_detayi" id="musteri_sikayet_detayi" rows="5" required class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500 transition duration-150 ease-in-out pl-4 pr-4 py-3 text-gray-900 resize-y" placeholder="Lütfen yaşadığınız sorunu tüm detaylarıyla açıklayınız..."><?php echo e(old('musteri_sikayet_detayi')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
            <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center px-5 py-2.5 border border-gray-300 rounded-lg font-medium text-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition duration-150 ease-in-out">
...
<?php endif; ?><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/public/sikayet/sikayet-form.blade.php ENDPATH**/ ?>