<?php if($iaa->musteriSikayeti): ?>
            ...
            <div class="p-5">
                ...
                <?php if(!$sikayet->musteri_bildirim_tarihi): ?>
                    ...
                    <div class="flex items-center justify-between bg-yellow-50 p-4 rounded-lg border border-yellow-100">
                        ...
                        <form action="<?php echo e(route('proje.notify_customer', $iaa->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="flex items-start gap-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-green-700 mt-1">
                                        <?php echo e($sikayet->musteri_bildirim_tarihi->format('d.m.Y H:i')); ?> tarihinde<br>
                        ...
                        <div class="bg-gray-50 border border-gray-200 rounded-lg p-3 flex flex-col justify-center">
                            ...
                            <code class="text-xs bg-white p-1 rounded border text-gray-600 truncate"><?php echo e(route('public.sikayet.show', $sikayet->takip_token)); ?></code>
                            
                            <div class="mt-3 pt-3 border-t border-gray-200">
                                <form action="<?php echo e(route('proje.reset_customer_password', $iaa->id)); ?>" method="POST" onsubmit="return confirm('Müşterinin mevcut şifresi geçersiz olacak ve yeni bir şifre gönderilecek. Emin misiniz?');">
                                    <?php echo csrf_field(); ?>
    ...
    <?php endif; ?>
<?php endif; ?> 
<?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/proje-calisma-alani/partials/_customer-notification.blade.php ENDPATH**/ ?>