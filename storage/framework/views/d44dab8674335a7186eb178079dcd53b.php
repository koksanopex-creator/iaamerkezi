<div class="relative bg-gray-900 pb-24 overflow-hidden shadow-2xl">
    ...
    <div
            ...
            <div class="text-left flex-1">
                ...
                <div class="flex flex-wrap items-center justify-start gap-2 mt-3">
                    ...
                    <?php if(auth()->user()->hasRole('Superadmin') && auth()->id() != $user->id): ?>
                        <a href="<?php echo e((isset($isCustomerRep) && $isCustomerRep) ? route('admin.musteriler.index') : route('admin.users.edit', $user->id)); ?>"
                ...
                <div class="flex flex-wrap items-center justify-start gap-3 mt-4">
                    <div class="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm shadow-sm group hover:bg-white/10 transition-all">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-xs font-bold text-white"><?php echo e($user->bolum->ad ?? 'Belirtilmedi'); ?></span>
                        </div>
                    </div>

                    <?php if(isset($bolumManager) && $bolumManager): ?>
                    <a href="<?php echo e(route('profile.show', $bolumManager->id)); ?>" class="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm shadow-sm group hover:bg-white/10 transition-all">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-xs font-bold text-white"><?php echo e($bolumManager->name); ?></span>
                        </div>
                    </a>
                    <?php endif; ?>

                    <?php if(isset($director) && $director): ?>
                    <a href="<?php echo e(route('profile.show', $director->id)); ?>" class="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm shadow-sm group hover:bg-white/10 transition-all">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-xs font-bold text-white"><?php echo e($director->name); ?></span>
                        </div>
                    </a>
                    <?php endif; ?>
                </div>
        ...
        <a href="<?php echo e(route('profile.puanlar', $user->id)); ?>"
            ...
            <div
                ...
                <div
                    ...
                    <?php echo e(($user->toplam_puan ?? 0) > 1000 ? '🏆 Usta Seviye' : (($user->toplam_puan ?? 0) > 500 ? '⭐ Uzman Seviye' : '🌱 Başlangıç')); ?>
        ...
        <?php elseif(isset($isCustomerRep) && $isCustomerRep && $user->customer): ?>
        ...
        <div class="relative group w-full md:w-auto">
            ...
            <div class="relative bg-white/10 backdrop-blur-2xl rounded-2xl p-7 border border-white/20 flex flex-col items-center justify-center min-w-[300px] shadow-2xl ring-1 ring-white/10">
                ...
                <a href="<?php echo e(route('musteri.profil.show', $user->customer->id)); ?>" class="group/link block">
...
</div><?php /**PATH /var/www/kys_koksan/iaa/resources/views/profile/partials/show/header.blade.php ENDPATH**/ ?>