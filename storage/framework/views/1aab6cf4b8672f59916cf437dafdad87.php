                            ...
                            <tbody class="divide-y divide-gray-50">
                                <?php $__empty_1 = true; $__currentLoopData = $arsivdekiDosyalar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $case): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-purple-50/20 transition-all group">
                                        ...
                                        <td class="px-6 py-6">
                                            <div class="text-xs font-black text-gray-700 leading-relaxed"><?php echo e($case->behavior->tanim ?? 'Belirtilmemiş'); ?></div>
                                            <?php if($case->subject): ?>
...
<?php endif; ?>
<?php /**PATH /var/www/kys_koksan/iaa/resources/views/admin/disiplin/kurul.blade.php ENDPATH**/ ?>