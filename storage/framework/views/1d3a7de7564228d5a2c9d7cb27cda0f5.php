                    ...
                    <div class="flex justify-between items-start">
                        <div class="flex items-center gap-3">
                            ...
                            <?php if($ilkDosya && str_contains($ilkDosya->mime_tipi, 'image')): ?>
                                <img src="<?php echo e(asset('storage/'.$ilkDosya->dosya_yolu)); ?>" class="w-10 h-10 rounded-lg object-cover border">
                            <?php else: ?>
                            ...
                            <div>
                                <p class="text-sm font-bold text-gray-800">
                                    ...
                                    <span class="font-normal text-gray-500">– <?php echo e($sikayet->sikayetKategori->ad ?? ''); ?></span>
                                </p>
                                <p class="text-xs text-gray-700 truncate w-80"><?php echo e($sikayet->musteri_sikayet_konusu); ?></p>
                            </div>
                        </div>
                        <div class="text-right">
                            <span class="text-[11px] font-bold px-2 py-0.5 rounded <?php echo e($isGecikmis ? 'bg-red-200 text-red-800' : 'bg-white/60 text-gray-800 border border-gray-200'); ?>"><?php echo e($sikayet->musteri_durum); ?></span>
                            <p class="text-[10px] text-gray-500 mt-1 font-semibold"><?php echo e($tarih); ?></p>
                        </div>
                    </div>
                </a>
...
</style><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/admin/raporlar/partials/executive/vertical-flow.blade.php ENDPATH**/ ?>