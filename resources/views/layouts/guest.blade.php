...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="gradient-bg min-h-screen">
        ...
        <div class="relative min-h-screen flex flex-col items-center justify-center p-4 sm:p-6 z-10">
            ...
            <div class="mb-6">
                <a href="/">
                    <img src="{{ asset('storage/logos/2mIKZO0DYbIDjSJdjfN1IpO7jkTqEcSOh886xYH5.png') }}" alt="Köksan Logo" class="h-16 sm:h-20 w-auto mx-auto drop-shadow-sm">
                </a>
            </div>
            
            {{-- İçeriğin Geleceği Kart --}}
