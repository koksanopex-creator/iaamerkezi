                    ...
                    <div class="p-6">
                        <div class="flex flex-col md:flex-row gap-6">
                            ...
                            <div class="flex flex-row md:flex-col gap-2 justify-center md:justify-start border-t md:border-t-0 md:border-l-2 border-gray-200 pt-4 md:pt-0 md:pl-6 mt-4 md:mt-0">
                                <a href="{{ route('proje.workspace.show', $proje->id) }}" class="flex-1 md:flex-none inline-flex items-center justify-center px-4 py-2.5 bg-indigo-600 text-white text-sm font-semibold rounded-lg hover:bg-indigo-700 transition-colors whitespace-nowrap">
                                    Çalışma Alanı
