<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <div class="bg-white p-5 rounded-xl shadow-lg border border-gray-100">
            ...
            <p class="text-3xl font-black text-blue-600"><?php echo e($kpi['toplam']); ?></p>
        </div>
        <div class="bg-white p-5 rounded-xl shadow-lg border border-gray-100">
            <h4 class="text-sm font-semibold text-gray-500 uppercase">Yeni (Beklemede)</h4>
            <p class="text-3xl font-black text-yellow-600"><?php echo e($kpi['yeni']); ?></p>
        </div>
        <div class="bg-white p-5 rounded-xl shadow-lg border border-gray-100">
            <h4 class="text-sm font-semibold text-gray-500 uppercase">İşlemde</h4>
            <p class="text-3xl font-black text-indigo-600"><?php echo e($kpi['islemde']); ?></p>
        </div>
        <div class="bg-white p-5 rounded-xl shadow-lg border border-gray-100">
            <h4 class="text-sm font-semibold text-gray-500 uppercase">Çözülen/Kapatılan</h4>
            <p class="text-3xl font-black text-green-600"><?php echo e($kpi['cozuldu']); ?></p>
        </div>
        <div class="bg-white p-5 rounded-xl shadow-lg border <?php echo e($kpi['gecikmis'] > 0 ? 'border-red-300 bg-red-50' : 'border-gray-100'); ?>">
            <h4 class="text-sm font-semibold <?php echo e($kpi['gecikmis'] > 0 ? 'text-red-700' : 'text-gray-500'); ?> uppercase">Gecikmiş (İşlemde)</h4>
            <p class="text-3xl font-black <?php echo e($kpi['gecikmis'] > 0 ? 'text-red-600' : 'text-gray-800'); ?>"><?php echo e($kpi['gecikmis']); ?></p>
        </div>
        <div class="bg-white p-5 rounded-xl shadow-lg border border-gray-100">
            <h4 class="text-sm font-semibold text-gray-500 uppercase">Projeye Dönüşen</h4>
            <p class="text-3xl font-black text-purple-600"><?php echo e($kpi['projeye_donusen']); ?></p>
        </div>
    </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $sonSikayetler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sikayet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr class="<?php echo e($rowBg); ?> <?php echo e($rowBar); ?> transition-all duration-200">
                                    ...
                                    <td class="px-4 py-4 text-sm font-medium text-gray-900 truncate" title="<?php echo e($sikayet->musteri_adi); ?>">
                                        <?php echo e($sikayet->musteri_adi); ?>

                                    </td>
                                    <td class="px-4 py-4 text-sm text-gray-700 truncate" title="<?php echo e($sikayet->musteri_sikayet_konusu); ?>">
