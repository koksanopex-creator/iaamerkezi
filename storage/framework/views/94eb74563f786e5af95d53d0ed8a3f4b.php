<div x-data="{
    ...
    <div class="overflow-hidden relative">
        <div class="flex transition-all duration-700" :style="'transform: translateX(-' + (slide * 100) + '%)'">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = array_chunk($bolumPerformansi->toArray(), 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="min-w-full grid grid-cols-1 md:grid-cols-2 gap-4 px-1">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bolum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="border rounded-xl p-4 hover:shadow-md transition-shadow bg-white relative overflow-hidden">
                            ...
                            <div class="absolute top-0 right-0 flex gap-1 p-1">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = [now()->year, now()->year - 1, now()->year - 2]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="bg-orange-100 text-orange-700 rounded-bl-lg px-2 py-0.5 text-[9px] border-b border-l text-center">
                                        ...
                                        <span class="block text-[8px]">
                                            T: <?php echo e($bolum['yillik_detay'][$yy]['toplam'] ?? 0); ?> | Ç: <?php echo e($bolum['yillik_detay'][$yy]['cozulen'] ?? 0); ?>
                            ...
                            <div class="mb-2">
                                <div class="flex justify-between text-xs mb-1">
                                    ...
                                    <span class="font-bold <?php echo e($bolum['basari_orani'] < 50 ? 'text-red-600' : 'text-green-600'); ?>">%<?php echo e($bolum['basari_orani']); ?></span>
                                </div>
                                <div class="w-full bg-gray-100 rounded-full h-2">
                                    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 h-2 rounded-full" style="width: <?php echo e($bolum['basari_orani']); ?>%"></div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = [now()->year, now()->year - 1, now()->year - 2]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="border-t border-gray-200 hover:bg-gray-50">
                                                ...
                                                <td class="px-2 py-1 text-center font-semibold"><?php echo e($bolum['yillik_detay'][$yy]['toplam'] ?? 0); ?></td>
                                                <td class="px-2 py-1 text-center text-green-600 font-bold"><?php echo e($bolum['yillik_detay'][$yy]['cozulen'] ?? 0); ?></td>
                                                <td class="px-2 py-1 text-center text-blue-600 font-bold"><?php echo e($bolum['yillik_detay'][$yy]['acik'] ?? 0); ?></td>
                                                <td class="px-2 py-1 text-center text-red-600 font-bold"><?php echo e($bolum['yillik_detay'][$yy]['geciken'] ?? 0); ?></td>
                                                <td class="px-2 py-1 text-center text-purple-600 font-bold"><?php echo e($bolum['yillik_detay'][$yy]['ortalama'] ?? 0); ?> gün</td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                    </tbody>
                                </table>
...
</div><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/admin/raporlar/partials/executive/department-performance.blade.php ENDPATH**/ ?>