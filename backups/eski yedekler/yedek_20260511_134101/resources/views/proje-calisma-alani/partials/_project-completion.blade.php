                        ...
                        <div class="mb-8 overflow-hidden rounded-2xl border border-gray-100 shadow-sm">
                            ...
                            <div x-show="!iadeVar" class="p-6 bg-white text-center space-y-4">
                                ...
                                <form action="{{ route('proje.completeWithoutReturn', $iaa->id) }}" method="POST">
                                    @csrf
                                    <button type="submit" class="w-full sm:w-auto px-8 py-3 bg-green-600 text-white font-bold rounded-xl hover:bg-green-700 transition shadow-lg hover:shadow-green-500/30 flex items-center justify-center gap-2 mx-auto">
