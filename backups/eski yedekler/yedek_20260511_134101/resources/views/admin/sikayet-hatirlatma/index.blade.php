                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors group">
                                ...
                                <td class="px-6 py-6">
                                    @php
                                        ...
                                        $labels = [
                                            'bilgi_girisi_bekleniyor' => 'Bilgi Bekleniyor',
                                            'bilgi_girildi' => 'Bilgi Girildi',
                                            'musteri_ikna_oldu' => 'Müşteri İkna Oldu',
                                            'kapatildi' => 'Kapatıldı',
                                        ];
                                    @endphp
                                    <span class="px-3 py-1 rounded-full text-[10px] font-black uppercase border {{ $colors[$h->durum] }}">
                                        {{ $labels[$h->durum] }}
                                    </span>
                                </td>
