                    ...
                    <form action="{{ route('admin.sikayetler.store') }}" method="POST" enctype="multipart/form-data" x-data="fileUploadComponent()">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="group">
                                ...
                                <input type="text" name="musteri_adi" id="musteri_adi" value="{{ old('musteri_adi') }}" required class="mt-1 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500 transition duration-150 ease-in-out pl-4 pr-4 py-3 text-gray-900" placeholder="Ad ve Soyad">
                            ...
                            <div class="group">
                                ...
                                <input type="text" name="musteri_iletisim" id="musteri_iletisim" value="{{ old('musteri_iletisim') }}" class="mt-1 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500 transition duration-150 ease-in-out pl-4 pr-4 py-3 text-gray-900" placeholder="0532... veya mail@...">
