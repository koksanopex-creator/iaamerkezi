                            ...
                            <div class="flex items-center justify-between px-2">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="px-3 py-1 bg-indigo-50 text-indigo-600 text-[10px] font-black uppercase tracking-widest rounded-full ring-1 ring-indigo-100">
                                        {{ $gundemItems->count() }} Toplam Kayıt
                                    </div>
                                ...
                                <div class="overflow-x-auto custom-scrollbar">
                                    <table class="w-full text-left border-collapse min-w-[1000px]">
                                        ...
                                        <tbody class="divide-y divide-gray-50">
                                            @forelse($gundemItems->whereIn('durum', ['gündem_bekliyor', 'planlandı', 'devam_ediyor']) as $t)
                                    ...
                                    <tr class="hover:bg-indigo-50/20 transition-all group"
                                        ...
                                        <td class="px-5 py-6 text-right">
                                            <div class="flex items-center justify-end gap-2">
                                                <a href="{{ route('admin.disiplin.kurul.toplanti.show', $t) }}" class="inline-flex items-center justify-center w-8 h-8 rounded-xl bg-black text-white hover:bg-indigo-600 transition-all">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                @forelse($arsivdekiDosyalar as $case)
                                    <tr class="hover:bg-purple-50/20 transition-all group">
                                        ...
                                        <td class="px-6 py-6">
                                            <div class="text-xs font-black text-gray-700 leading-relaxed">{{ $case->behavior->tanim ?? 'Belirtilmemiş' }}</div>
                                            @if($case->subject)
