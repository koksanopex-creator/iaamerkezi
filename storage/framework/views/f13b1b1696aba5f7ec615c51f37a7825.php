<!--[if BLOCK]><![endif]--><?php if($sonSikayetler->isNotEmpty()): ?>
    <div class="bg-white rounded-xl shadow-sm border border-indigo-100 p-3 flex items-center gap-4 relative overflow-hidden"
        ...
        <div class="flex-1 h-8 relative overflow-hidden" @mouseenter="stopTimer()" @mouseleave="startTimer()">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $sonSikayetler->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $sikayet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <a href="<?php echo e(route('admin.sikayetler.show', $sikayet->id)); ?>" target="_blank"
                    ...
                    <div class="flex items-center gap-1 text-sm w-full overflow-hidden font-medium">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($isGecikmis): ?> <span class="ml-2 bg-red-600 text-white px-2 py-0.5 rounded text-[10px] font-black animate-pulse shadow-sm whitespace-nowrap">GECİKTİ!</span> <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        <!--[if BLOCK]><![endif]--><?php if($sikayet->musteri_feedback): ?> <span class="ml-2 px-2 py-0.5 rounded text-[10px] font-bold uppercase border bg-white/50"><?php echo e($sikayet->musteri_feedback); ?></span> <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </div>
                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
        </div>
    </div>
<?php endif; ?><!--[if ENDBLOCK]><![endif]--><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/admin/raporlar/partials/executive/horizontal-ticker.blade.php ENDPATH**/ ?>