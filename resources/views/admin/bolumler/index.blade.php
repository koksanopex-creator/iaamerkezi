                        ...
                        <div class="p-6 pt-2 flex-grow">
                             ...
                             <div class="space-y-4">
                                 ...
                                 <div>
                                     ...
                                     @if($bolum->liderler->isNotEmpty())
                                         <div class="flex flex-wrap gap-2">
                                             @foreach($bolum->liderler->take(3) as $lider)
                                 ...
                                 <div>
                                     ...
                                     @if($bolum->yardimcilar->isNotEmpty())
                                         <div class="flex flex-wrap gap-2">
                                             @foreach($bolum->yardimcilar->take(3) as $yardimci)
                                                  <a href="{{ route('profile.show', $yardimci->id) }}" class="flex items-center gap-2 bg-white hover:bg-emerald-50 rounded-xl p-1 pr-3 transition-all border border-gray-100 hover:border-emerald-200 shadow-sm" title="{{ $yardimci->name }}">
                                                      @if($yardimci->profile_photo_path)
                                                         <img src="{{ asset('storage/' . $yardimci->profile_photo_path) }}" class="w-6 h-6 rounded-full object-cover">
                                                      @else
                                                      ...
                                                      @endif
                                                      <span class="text-[11px] font-bold text-gray-700 truncate max-w-[80px]">{{ $yardimci->name }}</span>
                                                  </a>
                                             @endforeach
                                             @if($bolum->yardimcilar->count() > 3)
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <div class="flex flex-wrap gap-1">
                                                @foreach($bolum->liderler as $lider)
                                                    <a href="{{ route('profile.show', $lider->id) }}" class="flex items-center gap-1.5 bg-indigo-50/50 text-indigo-700 px-2 py-0.5 rounded-lg border border-indigo-100/50 hover:bg-indigo-100 transition-colors" title="Bölüm Lideri">
                                                        <span class="text-[10px] font-black">{{ $lider->name }}</span>
                                                    </a>
                                                @endforeach
                                            </div>
                                            {{-- Yardımcılar --}}
                                            <div class="flex flex-wrap gap-1">
                                                @foreach($bolum->yardimcilar as $yardimci)
                                                    <a href="{{ route('profile.show', $yardimci->id) }}" class="flex items-center gap-1.5 bg-emerald-50/50 text-emerald-700 px-2 py-0.5 rounded-lg border border-emerald-100/50 hover:bg-emerald-100 transition-colors" title="Lider Yardımcısı">
                                                        <span class="text-[10px] font-black">{{ $yardimci->name }}</span>
                                                    </a>
                                                @endforeach
                                            </div>
                                            @if($bolum->liderler->isEmpty() && $bolum->yardimcilar->isEmpty())
