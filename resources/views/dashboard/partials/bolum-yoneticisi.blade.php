...
<div x-data="{ activeKategori: 'all' }" class="space-y-8 animate-fade-in-up">
    ...
    @if(isset($stats['onay_bekleyen_ziyaretler']) && count($stats['onay_bekleyen_ziyaretler']) > 0)
            ...
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-sm text-indigo-800">
                        Onayınızı bekleyen <span class="font-bold">{{ count($stats['onay_bekleyen_ziyaretler']) }} adet</span> müşteri ziyareti planı bulunmaktadır. Lütfen inceleyip onaylayınız.
                    </p>
                </div>
            </div>
