                        ...
                        <button @click="open = !open" type="button"
                            ...
                            <span class="block truncate">
                                @if(empty($filtreDurum))
                                    Tüm Durumlar
                                @else
                                    {{ is_array($filtreDurum) ? count($filtreDurum) : 1 }} Durum Seçildi
                                @endif
                            </span>
                        ...
                        <button @click="open = !open" type="button"
                            ...
                            <span class="block truncate">
                                @if(empty($filtreOncelik))
                                    Tüm Öncelikler
                                @else
                                    {{ is_array($filtreOncelik) ? count($filtreOncelik) : 1 }} Seçildi
                                @endif
                            </span>
                            <span class="absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <button @click="open = !open" type="button"
                            ...
                            <span class="block truncate">
                                @if(empty($filtreKonumTipi))
                                    Tümü
                                @else
                                    {{ is_array($filtreKonumTipi) ? count($filtreKonumTipi) : 1 }} Seçildi
                                @endif
                            </span>
                            <span class="absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <button @click="open = !open" type="button"
                            ...
                            <span class="block truncate">
                                @if(empty($filtreProjeDurumu))
                                    Tümü
                                @else
                                    {{ is_array($filtreProjeDurumu) ? count($filtreProjeDurumu) : 1 }} Seçildi
                                @endif
                            </span>
                            <span class="absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                @foreach(['Atandı', 'Bölüm Onayı Bekliyor', 'Yönetici Onayı Bekliyor', 'Revize Ediliyor', 'Tamamlandı', 'talep_olarak_kapatildi', 'hatali_bildirim_olarak_kapatildi', 'Reddedildi'] as $durum)
                                    <label class="flex items-center px-4 py-2 hover:bg-indigo-50 cursor-pointer transition-colors">
                                        ...
                                        <span class="ml-3 text-gray-700">
                                            {{ $durum == 'Bölüm Onayı Bekliyor' ? 'Bölüm Kalite Yöneticisi Onayı Bekliyor' : ($durum == 'Yönetici Onayı Bekliyor' ? 'Final Onay Bekliyor' : $durum) }}
                                        </span>
                                    </label>
                                @endforeach
                            </div>
                        ...
                        <button @click="open = !open" type="button"
                            ...
                            <span class="block truncate">
                                @if(empty($filtreTakim))
                                    Tüm Takımlar
                                @else
                                    {{ is_array($filtreTakim) ? count($filtreTakim) : 1 }} Seçildi
                                @endif
                            </span>
                            <span class="absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <button @click="open = !open" type="button"
                            ...
                            <span class="block truncate">
                                @if(empty($filtreKategori))
                                    Tüm Kategoriler
                                @else
                                    {{ is_array($filtreKategori) ? count($filtreKategori) : 1 }} Seçildi
                                @endif
                            </span>
                            <span class="absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <button @click="open = !open" type="button"
                            ...
                            <span class="block truncate">
                                @if(empty($filtreEkleyen))
                                    Tüm Kullanıcılar
                                @else
                                    {{ is_array($filtreEkleyen) ? count($filtreEkleyen) : 1 }} Seçildi
                                @endif
                            </span>
                            <span class="absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
