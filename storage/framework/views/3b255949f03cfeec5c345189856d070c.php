                    ...
                    <form action="<?php echo e(route('admin.users.update', $user)); ?>" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="<?php echo e(old('name', $user->name)); ?>" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
...
<?php endif; ?>
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" value="<?php echo e(old('email', $user->email)); ?>" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
                                ...
                                <div class="mt-2 space-y-2">
                                    ...
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center">
                                            <input id="role-<?php echo e($rol->id); ?>"
                                                   name="roles[]"
                                                   type="checkbox"
                                                   value="<?php echo e($rol->name); ?>"
                                                   
                                                   <?php if( (is_array(old('roles')) && in_array($rol->name, old('roles'))) || (empty(old('roles')) && $user->hasRole($rol->name)) ): ?> checked <?php endif; ?>
                                                   class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                                            <label for="role-<?php echo e($rol->id); ?>" class="ml-3 block text-sm font-medium text-gray-700">
                                                <?php echo e($rol->name); ?>
