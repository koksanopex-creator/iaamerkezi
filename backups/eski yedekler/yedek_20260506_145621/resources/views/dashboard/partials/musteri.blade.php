...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4 relative overflow-hidden">
        ...
        <div class="flex gap-2 w-full md:w-auto relative z-10">
            ...
            <a href="{{ route('iaa.sikayetler.create', ['musteri_id' => $user->customer_id]) }}" 
                            ...
                            <tr class="hover:bg-gray-50 transition-colors group">
                                ...
                                <td class="px-5 py-3">
                                    ...
                                    @if($sikayet->iaaProjesi)
                                        <div class="mt-2 w-full max-w-[180px]">
                                ...
                                <td class="px-5 py-3 whitespace-nowrap text-center">
                                    ...
                                    @if($sikayet->iaaProjesi && in_array($sikayet->iaaProjesi->durum, [
                                        ...
                                        <div class="mt-1 text-[9px] font-bold text-indigo-600 animate-pulse flex items-center justify-center gap-1">
                                            <svg class="w-2 h-2" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
                                            @if(str_contains($sikayet->iaaProjesi->durum, 'talep'))
                                                Müşteri talebi olarak onay sürecinde
                                            @else
                                                Hatalı bildirim olarak onay sürecinde
                                            @endif
                                        </div>
                                    @elseif($sikayet->iaaProjesi && $sikayet->iaaProjesi->durum == 'talep_olarak_kapatildi')
                                        <div class="mt-1 text-[9px] font-bold text-purple-600">
