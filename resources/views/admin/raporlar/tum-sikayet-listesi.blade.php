                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($sikayetler as $index => $sikayet)
                                ...
                                <tr class="{{ $rowBg }} {{ $rowBar }} transition-colors">
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-700 truncate" title="{{ $sikayet->sikayetKategori->ad ?? 'N/A' }}">
                                        {{ $sikayet->sikayetKategori->ad ?? 'N/A' }}
                                    </td>
                                    <td class="px-4 py-3 text-sm font-medium text-gray-900 truncate" title="{{ $sikayet->musteri_adi }}">
                                        {{ $sikayet->musteri_adi }}
                                    </td>
                                    <td class="px-4 py-3 text-sm text-gray-700 truncate" title="{{ $sikayet->musteri_sikayet_konusu }}">
                                    ...
                                    <td class="px-4 py-3 text-sm whitespace-nowrap {{ $sikayet->musteri_cozum_son_tarihi ? 'text-red-600 font-semibold' : 'text-gray-500' }}">
                        ...
                        @forelse ($sikayetler as $index => $sikayet)
                            ...
                            <div class="rounded-lg shadow border {{ $rowBg }} {{ $rowBar }} p-4 space-y-3 cursor-pointer"
                                ...
                                <div class="flex justify-between items-start">
                                    <div>
                                        <span class="font-semibold text-gray-700">#{{ ($sikayetler->currentPage() - 1) * $sikayetler->perPage() + $index + 1 }}</span>
