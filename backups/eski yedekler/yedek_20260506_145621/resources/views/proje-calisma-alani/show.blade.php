<x-app-layout>
    ...
    <div class="py-8 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            {{-- 1. İADE VE ZİYARET DETAY KARTLARI (SADECE ONAY/BİTİŞ DURUMUNDA GÖRÜNÜR) --}}
            @if($kartGoster)
                @if($iadeVar)
            ...
            @if($progressPercentage == 100 && in_array($iaa->durum, $duzenlemeDurumlari))
            ...
            @if(!$isTrashed && in_array($iaa->durum, ['Bölüm Onayı Bekliyor', 'Yönetici Onayı Bekliyor', 'Direktör Onayı Bekliyor', 'Revize Ediliyor', 'Tamamlanması Reddedildi', 'Tamamlandı']))
            ...
            @php
                ...
                $canSeeHistory = $isAdminOrManagement || $isDirector || $isTeamLeader;
            @endphp
