        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h2 class="font-semibold text-2xl text-gray-900 leading-tight flex items-center gap-2">
                    <span class="text-indigo-600">●</span> <?php echo e(__('Kullanıcı Yönetimi')); ?>
    ...
    <div class="py-10 bg-gradient-to-br from-gray-50 via-white to-gray-100">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <a href="<?php echo e(route('admin.users.index', ['activeTab' => 'sistem'])); ?>" class="block group relative overflow-hidden rounded-2xl border border-indigo-200/60 bg-white shadow-sm hover:shadow-md transition-shadow cursor-pointer">
                    <div class="p-4 flex items-start justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900">
                                <?php echo e($sistemKullanicilari->total()); ?>
                ...
                <a href="<?php echo e(route('admin.users.index', ['activeTab' => 'mavi'])); ?>" class="block group relative overflow-hidden rounded-2xl border border-emerald-200/60 bg-white shadow-sm hover:shadow-md transition-shadow cursor-pointer">
                    <div class="p-4 flex items-start justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900">
                                <?php echo e($maviYakaKullanicilari->total()); ?>
                ...
                <a href="<?php echo e(route('admin.users.index', ['activeTab' => 'musteri'])); ?>" class="block group relative overflow-hidden rounded-2xl border border-purple-200/60 bg-white shadow-sm hover:shadow-md transition-shadow cursor-pointer">
                    <div class="p-4 flex items-start justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900">
                                <?php echo e($musteriKullanicilari->total()); ?>
                ...
                <div class="relative overflow-hidden rounded-2xl border border-yellow-200/60 bg-white shadow-sm">
                    <div class="p-4 flex items-start justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900">
                                <?php echo e($onayBekleyenler->total()); ?>
            ...
            <?php if($onayBekleyenler->isNotEmpty()): ?>
                <div class="bg-white/80 backdrop-blur-sm overflow-hidden shadow-xl rounded-2xl border border-yellow-200/50 ring-1 ring-yellow-100/70">
                    <div class="p-6 sm:p-8 border-b border-yellow-100 bg-gradient-to-r from-yellow-50 to-white flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div class="text-sm font-semibold text-yellow-800 bg-yellow-100 px-3 py-1 rounded-lg border border-yellow-300 shadow-inner w-fit">
                            Toplam: <?php echo e($onayBekleyenler->total()); ?>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 text-sm">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                <?php $__empty_1 = true; $__currentLoopData = $onayBekleyenler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-xs font-medium">
                                            ...
                                            <div class="flex items-center justify-end gap-2">
                                                <?php if(!$user->hasVerifiedEmail()): ?>
                                                    <form method="POST" action="<?php echo e(route('admin.users.verifyEmail', $user)); ?>">
                                                        <?php echo csrf_field(); ?>
                                                ...
                                                <?php endif; ?>
                                                <form method="POST" action="<?php echo e(route('admin.users.onayla', $user)); ?>">
                                                ...
                                                <a href="<?php echo e($user->is_mavi_yaka ? route('admin.mavi-yaka.edit', $user->id) : route('admin.users.edit', $user)); ?>" class="px-2.5 py-0.5 text-xs font-medium rounded-full bg-indigo-100 text-indigo-700 hover:bg-indigo-200 transition-colors">
                                                    Düzenle
                                                </a>
            ...
            <div x-data="{ activeTab: '<?php echo e(request('activeTab', 'sistem')); ?>' }" class="bg-white/80 backdrop-blur-sm shadow-xl rounded-xl border border-gray-200 ring-1 ring-gray-100 overflow-hidden">
                ...
                <div class="border-b border-gray-200 bg-gray-50 flex items-center px-4">
                    <button @click="activeTab = 'sistem'" 
                        ...
                        Sistem Kullanıcıları (<?php echo e($sistemKullanicilari->total()); ?>)
                    </button>
                    <button @click="activeTab = 'mavi'" 
                            ...
                            class="flex-1 py-4 px-1 text-center border-b-2 font-medium text-sm transition-colors duration-200 ease-in-out focus:outline-none">
                        Mavi Yaka (<?php echo e($maviYakaKullanicilari->total()); ?>)
                    </button>
                    <button @click="activeTab = 'musteri'" 
                            ...
                            class="flex-1 py-4 px-1 text-center border-b-2 font-medium text-sm transition-colors duration-200 ease-in-out focus:outline-none">
                        Müşteri Yetkilileri (<?php echo e($musteriKullanicilari->total()); ?>)
                    </button>
                    <button @click="activeTab = 'resigned'" 
                            ...
                            class="flex-1 py-4 px-1 text-center border-b-2 font-medium text-sm transition-colors duration-200 ease-in-out focus:outline-none">
                        İşten Çıkanlar (<?php echo e($resignedUsers->total()); ?>)
                    </button>
                </div>

                
                <div class="p-4 border-b border-gray-100 bg-white">
                     <form method="GET" action="<?php echo e(route('admin.users.index')); ?>" class="grid grid-cols-1 md:grid-cols-4 gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="name_filter" id="name_filter" value="<?php echo e($filters['name_filter'] ?? ''); ?>"
                        ...
                        <div x-show="activeTab === 'sistem'">
                            ...
                            <select name="bolum_filter" id="bolum_filter"
                                ...
                                <?php $__currentLoopData = $bolumler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bolum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($bolum->id); ?>"
                                            <?php if(isset($filters['bolum_filter']) && $filters['bolum_filter'] == $bolum->id): ?> selected <?php endif; ?>>
                                        <?php echo e($bolum->ad); ?>
                        ...
                        <div x-show="activeTab === 'musteri'" style="display: none;">
                            ...
                            <select name="customer_filter" id="customer_filter"
                                ...
                                <?php $__currentLoopData = $musteriler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $musteri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($musteri->id); ?>"
                                            <?php if(isset($filters['customer_filter']) && $filters['customer_filter'] == $musteri->id): ?> selected <?php endif; ?>>
                        ...
                        <div x-show="activeTab === 'sistem'">
                            ...
                            <select name="role_filter" id="role_filter" class="mt-1 block w-full rounded-lg border-gray-300 text-xs shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <?php $__currentLoopData = $roller; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($role->name); ?>" <?php if(isset($filters['role_filter']) && $filters['role_filter'] == $role->name): ?> selected <?php endif; ?>>
                        ...
                        <div x-show="activeTab === 'musteri'" style="display: none;">
                            ...
                            <input type="text" name="title_filter" id="title_filter" value="<?php echo e($filters['title_filter'] ?? ''); ?>"
                                   class="mt-1 block w-full rounded-lg border-gray-300 text-xs shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <a href="<?php echo e(route('admin.users.index')); ?>" class="bg-gray-200 text-gray-700 px-3 py-2 rounded-lg text-xs font-semibold hover:bg-gray-300 transition">Temizle</a>
                        </div>
                    </form>
                </div>
                ...
                <div x-show="activeTab === 'sistem'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0">
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 text-sm">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                <?php $__empty_1 = true; $__currentLoopData = $sistemKullanicilari; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-indigo-50/50 transition">
                                        <td class="px-6 py-3">
                                            <div class="flex items-center gap-3">
                                                 <?php if($user->profile_photo_path): ?>
                                                    <img src="<?php echo e(asset('storage/' . $user->profile_photo_path)); ?>" alt="<?php echo e($user->name); ?>" class="h-8 w-8 rounded-full object-cover border border-gray-200">
                                                 <?php else: ?>
                                        ...
                                        <td class="px-6 py-3 text-right">
                                            ...
                                            <div class="flex items-center justify-end gap-2">
                                                <?php if(!$user->hasVerifiedEmail()): ?>
                                                    <form method="POST" action="<?php echo e(route('admin.users.verifyEmail', $user)); ?>" class="inline-block">
                                                        <?php echo csrf_field(); ?>
                                                ...
                                                <?php endif; ?>
                                                <a href="<?php echo e($user->is_mavi_yaka ? route('admin.mavi-yaka.edit', $user->id) : route('admin.users.edit', $user)); ?>" class="p-1.5 rounded-full text-indigo-600 hover:bg-indigo-50 transition-colors" title="Düzenle">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                    </svg>
                                                </a>
                                                <form method="POST" action="<?php echo e(route('admin.users.resign', $user)); ?>" class="inline-block">
                                                    <?php echo csrf_field(); ?> <?php echo method_field('patch'); ?>
                    ...
                    <?php if($sistemKullanicilari->hasPages()): ?>
                        <div class="px-6 py-3 border-t border-gray-200 bg-gray-50">
                            <?php echo e($sistemKullanicilari->appends(['activeTab' => 'sistem'])->links()); ?>
                ...
                <div x-show="activeTab === 'mavi'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" style="display: none;">
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 text-sm">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                <?php $__empty_1 = true; $__currentLoopData = $maviYakaKullanicilari; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-emerald-50/50 transition">
                                        ...
                                        <td class="px-6 py-3">
                                            <div class="text-xs text-gray-900"><?php echo e($user->unvan ?? '-'); ?></div>
                                            <div class="text-[10px] text-gray-500">Sicil: <?php echo e($user->sicil_no ?? '-'); ?></div>
                                        </td>
                                        <td class="px-6 py-3 text-xs text-gray-500">
                                            <?php echo e($user->created_at->format('d.m.Y H:i')); ?>
                                        ...
                                        <td class="px-6 py-3 text-right">
                                            <?php if(!Auth::user()->hasRole(['Yonetim', 'Yönetim'])): ?>
                                            <div class="flex items-center justify-end gap-2">
                                                <a href="<?php echo e(route('admin.mavi-yaka.edit', $user->id)); ?>" class="p-1.5 rounded-full text-indigo-600 hover:bg-indigo-50 transition-colors" title="Düzenle">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                    </svg>
                                                </a>
                    ...
                    <?php if($maviYakaKullanicilari->hasPages()): ?>
                        <div class="px-6 py-3 border-t border-gray-200 bg-gray-50">
                            <?php echo e($maviYakaKullanicilari->appends(['activeTab' => 'mavi'])->links()); ?>
                ...
                <div x-show="activeTab === 'musteri'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" style="display: none;">
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 text-sm">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                <?php $__empty_1 = true; $__currentLoopData = $musteriKullanicilari; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-purple-50/50 transition">
                                        ...
                                        <td class="px-6 py-3">
                                            <?php if($user->customer): ?>
                                                <a href="<?php echo e(route('musteri.profil.show', $user->customer->id)); ?>" class="text-indigo-600 hover:underline font-medium text-xs">
                                            ...
                                            <div class="group relative inline-block cursor-help">
                                                ...
                                                <div class="opacity-0 invisible group-hover:opacity-100 group-hover:visible absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg shadow-lg whitespace-nowrap z-50 transition-all duration-200 pointer-events-none">
                                                    <?php if($creatorName): ?>
                                                        ...
                                                        <div><?php echo e($creatorName); ?></div>
                                                    <?php else: ?>
                    ...
                    <?php if($musteriKullanicilari->hasPages()): ?>
                        <div class="px-6 py-3 border-t border-gray-200 bg-gray-50">
                            <?php echo e($musteriKullanicilari->appends(['activeTab' => 'musteri'])->links()); ?>
                ...
                <div x-show="activeTab === 'resigned'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" style="display: none;">
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 text-sm">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                <?php $__empty_1 = true; $__currentLoopData = $resignedUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-red-50/30 transition opacity-75">
                                        <td class="px-6 py-3">
                                            <div class="flex items-center gap-3">
                                                 <div class="grayscale">
                                                     <?php if($user->profile_photo_path): ?>
                                                        <img src="<?php echo e(asset('storage/' . $user->profile_photo_path)); ?>" alt="<?php echo e($user->name); ?>" class="h-8 w-8 rounded-full object-cover">
                                                     <?php else: ?>
                                                ...
                                                <div>
                                                    <div class="font-semibold text-gray-700"><?php echo e($user->name); ?></div>
                                        ...
                                        <td class="px-6 py-3 text-right">
                                            <?php if(!Auth::user()->hasRole(['Yonetim', 'Yönetim'])): ?>
                                            <form method="POST" action="<?php echo e(route('admin.users.restore', $user->id)); ?>" class="inline-block">
                                                <?php echo csrf_field(); ?> <?php echo method_field('patch'); ?>
                                                <button type="button" 
                    ...
                    <?php if($resignedUsers->hasPages()): ?>
                        <div class="p-6 bg-gray-50 border-t border-gray-100">
                            <?php echo e($resignedUsers->appends(['activeTab' => 'resigned'])->links()); ?>
            ...
            <div class="inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        ...
                        <div class="mt-4">
                            <form action="<?php echo e(route('admin.users.import_preview')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="mb-4">
...
<?php endif; ?><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/admin/users/index.blade.php ENDPATH**/ ?>