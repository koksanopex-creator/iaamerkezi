<div class="bg-gradient-to-br from-<?php echo e($color); ?>-50 via-white to-<?php echo e($color); ?>-100 overflow-hidden shadow-xl sm:rounded-2xl border border-<?php echo e($color); ?>-200" x-data="tableManager()">
                        ...
                        <tr class="block mb-4 border bg-white border-gray-200 rounded-lg sm:table-row sm:mb-0 sm:border-0 sm:border-b sm:border-gray-100 hover:bg-<?php echo e($color); ?>-50 transition-colors group">
                            ...
                            <td class="flex justify-between items-start p-3 border-t sm:border-0 sm:table-cell sm:p-4 align-middle">
                                ...
                                <div class="text-right sm:text-left">
                                    <p class="text-gray-800 font-medium group-hover:text-<?php echo e($color); ?>-700 transition-colors inline-flex items-center space-x-2">
                                 ...
                                 <td class="flex justify-between items-center p-3 border-t sm:border-0 sm:table-cell sm:p-4 align-middle">
                                    ...
                                    <div class="text-right sm:text-left">
                                        <?php if($iaa->atananTakim): ?>
                                             <div class="inline-flex items-center space-x-2"><div class="w-7 h-7 bg-gradient-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center"><span class="text-xs font-bold text-white"><?php echo e(Str::substr($iaa->atananTakim->ad, 0, 1)); ?></span></div><span class="text-sm font-medium text-gray-700"><?php echo e($iaa->atananTakim->ad); ?></span></div>
                                        <?php else: ?>
                            ...
                            <td class="p-3 border-t sm:border-0 sm:table-cell sm:p-4 align-middle"><div class="flex flex-col sm:flex-row sm:justify-end sm:space-x-2 space-y-2 sm:space-y-0"><?php echo $__env->make('admin.iaa-yonetim.partials.actions', ['type' => $type, 'iaa' => $iaa], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></div></td>
                        </tr>
...
</div><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/admin/iaa-yonetim/partials/table-content.blade.php ENDPATH**/ ?>