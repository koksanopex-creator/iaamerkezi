...
class CustomerProfileController extends Controller
{
    public function show(Request $request, Customer $customer)
    {
        ...
        if (!$yetkisiVarMi) {
            // Müşteri temsilcisi kendi profilini görebilir
        ...
        if (!$yetkisiVarMi) {
            if ($user->customer_id === $customer->id) {
                // Müşteri sadece kendi şikayetlerini görür (baseQuery zaten $customer->sikayetler() olduğu için ek kısıtlamaya gerek yok)
            }
            else {
