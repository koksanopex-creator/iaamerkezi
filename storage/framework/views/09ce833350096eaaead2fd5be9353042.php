...
<?php if($redOdeme && !empty($redOdeme->red_gerekcesi)): ?>
        ...
        <div class="ml-4 w-full">
            ...
            <div class="mt-2 text-sm text-red-700">
                ...
                <div class="mt-2 p-3 bg-white border border-red-200 rounded text-gray-800 font-bold italic shadow-sm">
                    "<?php echo e($redOdeme->red_gerekcesi); ?>"
                </div>
            </div>
            <div class="mt-3">
...
<?php if($case->status == 'odeme_bekliyor' && $case->payments->isEmpty()): ?>
...
<?php endif; ?><?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/admin/arabuluculuk/parcalar/uyarilar-ve-bildirimler.blade.php ENDPATH**/ ?>