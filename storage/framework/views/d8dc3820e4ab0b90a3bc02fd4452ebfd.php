<?php if(isset($isComplaintProject) && $isComplaintProject && $iaa->musteriSikayeti): ?>
    ...
    <?php if($iaa->musteriSikayeti): ?>
        ...
        <div x-data="{ showNotifications: false }" class="mt-8 pt-8 border-t border-gray-200">
                ...
                <div class="flex items-center gap-4">
                    <div class="text-right hidden sm:block">
                        <div class="px-3 py-1 bg-gray-100 rounded-lg text-[10px] font-black text-gray-600 uppercase tracking-widest border border-gray-200 shadow-sm leading-none inline-block">
                            <?php echo e($iaa->musteriSikayeti->notified_snapshot ? 'SNAPSHOT AKTİF' : 'ESKİ KAYIT'); ?>

                        </div>
                        <p class="mt-1 text-[11px] font-bold text-gray-400 tracking-tighter"><?php echo e($iaa->musteriSikayeti->created_at ? \Carbon\Carbon::parse($iaa->musteriSikayeti->created_at)->translatedFormat('d F Y H:i') : '-'); ?></p>
                    </div>
            ...
            <div x-show="showNotifications" x-cloak x-collapse x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0" class="pt-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <?php if($sikayetSnapshot): ?>
                        
                        <?php $__currentLoopData = $sikayetSnapshot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-5 bg-white rounded-2xl border-2 border-gray-100 shadow-sm hover:shadow-xl hover:border-indigo-200 transition-all duration-300 transform hover:-translate-y-1 relative group cursor-help">
                                ...
                                <div class="flex items-center justify-between mb-4">
                                    <span class="text-[10px] font-black text-indigo-500 uppercase tracking-widest bg-indigo-50 px-2 py-0.5 rounded shadow-sm"><?php echo e($item['role_label']); ?></span>
                                ...
                                <span class="text-gray-900 font-bold transition-colors group-hover:text-indigo-600 block"><?php echo e($item['name'] ?? 'İsimsiz'); ?></span>
                                <?php echo renderUserCardTooltip($item, $item['role_label']); ?>
                    ...
                    <?php else: ?>
                        ...
                        <?php if($director): ?>
                            <div class="p-5 bg-white rounded-2xl border-2 border-gray-100 shadow-sm relative group cursor-help transition-all hover:shadow-xl hover:border-blue-200 hover:-translate-y-1">
                                ...
                                <span class="text-gray-900 font-bold transition-colors group-hover:text-blue-600 block"><?php echo e($director->name); ?></span>
                                <?php echo renderUserCardTooltip($director, 'Bölüm Direktörü'); ?>

                            </div>
                        <?php endif; ?>

                        
                        <?php $__currentLoopData = $deptLeaders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dlider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-5 bg-white rounded-2xl border-2 border-gray-100 shadow-sm relative group cursor-help transition-all hover:shadow-xl hover:border-indigo-200 hover:-translate-y-1">
                                ...
                                <span class="text-gray-900 font-bold transition-colors group-hover:text-indigo-600 block"><?php echo e($dlider->name); ?></span>
                                <?php echo renderUserCardTooltip($dlider, 'Bölüm Lideri'); ?>

                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                        
                        <?php $__currentLoopData = $kaliteYoneticileri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kyonetici): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-5 bg-white rounded-2xl border-2 border-gray-100 shadow-sm relative group cursor-help transition-all hover:shadow-xl hover:border-purple-200 hover:-translate-y-1">
                                ...
                                <span class="text-gray-900 font-bold transition-colors group-hover:text-purple-600 block"><?php echo e($kyonetici->name); ?></span>
                                <?php echo renderUserCardTooltip($kyonetici, 'Bölüm Kalite Yöneticisi'); ?>

                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                        
                        <?php $__currentLoopData = $otherReps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-5 bg-white rounded-2xl border-2 border-gray-100 shadow-sm relative group cursor-help transition-all hover:shadow-xl hover:border-green-200 hover:-translate-y-1">
                                ...
                                <span class="text-gray-900 font-bold transition-colors group-hover:text-green-600 block"><?php echo e($orep->name); ?></span>
                                <?php echo renderUserCardTooltip($orep, 'Müşteri Temsilcisi'); ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\Users\celal.karaman\Desktop\Projelerim\iaa_projesi\resources\views/proje-calisma-alani/partials/_technical-details.blade.php ENDPATH**/ ?>