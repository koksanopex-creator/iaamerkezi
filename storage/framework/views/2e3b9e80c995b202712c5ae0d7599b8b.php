            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50/80 transition-colors duration-150 <?php echo e(!$customer->is_active ? 'bg-red-50/40' : ''); ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <?php else: ?>
                                    <div class="flex flex-col items-start gap-1">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($customer->passive_reason): ?>
                                            <div class="text-[10px] leading-tight text-red-500 max-w-[120px] truncate cursor-help border-b border-dotted border-red-300" title="<?php echo e($customer->passive_reason); ?>">
                                                Sebep: <?php echo e($customer->passive_reason); ?>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="flex-shrink-0 h-12 w-12 mr-4 relative group">
                                        <!--[if BLOCK]><![endif]--><?php if($customer->logo_path): ?>
                                            <img class="h-12 w-12 rounded-xl object-cover border border-gray-200 shadow-sm group-hover:scale-105 transition-transform duration-200 <?php echo e(!$customer->is_active ? 'grayscale' : ''); ?>" src="<?php echo e(asset('storage/'.$customer->logo_path)); ?>" alt="">
                                        <?php else: ?>
                                            <div class="h-12 w-12 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-bold text-lg shadow-md group-hover:scale-105 transition-transform duration-200 <?php echo e(!$customer->is_active ? 'grayscale' : ''); ?>">
                                    ...
                                    <div>
                                        <a href="<?php echo e(route('musteri.profil.show', $customer->id)); ?>" 
                                           target="_blank"
                                           class="text-sm font-bold <?php echo e($customer->is_active ? 'text-indigo-600 hover:text-indigo-900' : 'text-gray-500'); ?> hover:underline flex items-center gap-1 transition-colors duration-200"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex flex-col items-center justify-center gap-1">
                                    <div class="flex items-center gap-2 text-sm">
                                        <span class="font-bold text-gray-800" title="Toplam Şikayet"><?php echo e($customer->toplam_sikayet ?? 0); ?></span>
                                        <span class="text-gray-400">/</span>
                                        <span class="font-bold text-emerald-600" title="Çözülen Şikayet"><?php echo e($customer->cozulmus_sikayet ?? 0); ?></span>
                                    </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-col space-y-1">
                                    <div class="flex items-center text-xs font-semibold">
                                        <span class="inline-flex items-center px-2 py-0.5 rounded text-[10px] mr-2 <?php echo e($customer->location_type == 'Yurt İçi' ? 'bg-blue-50 text-blue-700' : 'bg-purple-50 text-purple-700'); ?>">
                                            <?php echo e($customer->location_type); ?>

                                        </span>
                                        <span class="text-gray-700"><?php echo e($customer->phone ?? '-'); ?></span>
                                    </div>
                                    <div class="flex items-start text-xs text-gray-500 truncate max-w-[180px]" title="<?php echo e($customer->address); ?>">
                                        ...
                                        <?php echo e($customer->address ?? 'Adres girilmemiş'); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end items-center gap-2">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if(auth()->user()->hasRole(['Superadmin', 'Yonetim', 'Müşteri Şikayeti Kurulu'])): ?>
                                        <button wire:click="confirmStatusChange(<?php echo e($customer->id); ?>)" 
                                                class="p-2 rounded-lg transition-colors duration-200 <?php echo e($customer->is_active ? 'text-orange-400 hover:bg-orange-50' : 'text-emerald-600 hover:bg-emerald-50'); ?>"
                                            ...
                                            <?php else: ?>
                                                ...
                                                <td class="px-6 py-4 text-right whitespace-nowrap">
                                                    <div class="flex justify-end space-x-2">
                                                        ...
                                                        <button wire:click="deleteRepresentative(<?php echo e($rep->id); ?>)" wire:confirm="Bu yetkiliyi silmek istediğinize emin misiniz?" class="text-rose-600 hover:text-rose-900 p-2 rounded-lg hover:bg-rose-50 transition-colors" title="Sil">
                                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                                                        </button>
                                                    </div>
                                                </td>
                ...
                <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md w-full">
                    <div class="bg-white px-6 py-6">
                        <h3 class="text-lg font-bold text-gray-900 mb-2 flex items-center gap-2">
                            <!--[if BLOCK]><![endif]--><?php if(\App\Models\Customer::find($selectedStatusCustomerId)->is_active): ?>
