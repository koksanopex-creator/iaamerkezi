                        ...
                        <div class="px-6 py-3 bg-slate-50/80 border-t border-slate-100">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    {{-- SİLME BUTONU --}}
                                    <button type="button" onclick="confirmWorkflowDelete('{{ $workflow->id }}', '{{ $workflow->name }}')"
                                    ...
                                    {{-- Gizli Silme Formu --}}
                                    <form id="delete-workflow-form-{{ $workflow->id }}" action="{{ route('admin.workflows.destroy', $workflow) }}" method="POST" class="hidden">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </div>
