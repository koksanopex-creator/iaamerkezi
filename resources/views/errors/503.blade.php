    ...
    <div class="card">
        ...
        <div style="margin-top: 1.5rem; padding-top: 1.5rem; border-top: 1px solid var(--border); text-align: left;">
            ...
            <div style="display: flex; align-items: center; gap: 12px; background: var(--faint); padding: 12px; border-radius: 12px; border: 1px solid var(--border);">
                @if(isset($sistemAdmin) && $sistemAdmin)
                    <img src="{{ $sistemAdmin->profile_photo_url }}" style="width: 44px; height: 44px; border-radius: 10px; object-fit: cover; border: 1px solid var(--border);" alt="Celal KARAMAN">
                @else
                ...
                <div>
                    ...
                    <div style="margin-top: 2px; display: flex; flex-direction: column; gap: 1px;">
                        ...
                        <span style="font-size: 11px; color: var(--muted);">Tel: {{ (isset($sistemAdmin) && $sistemAdmin) ? ($sistemAdmin->telefon ?: '-') : '-' }}</span>
                    </div>
                </div>
            </div>
        </div>
