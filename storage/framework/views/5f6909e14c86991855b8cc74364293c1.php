...
<?php $component->withAttributes([]); ?>
    <?php $__env->startPush('pageTitle'); ?> Bekleyen Başvurular | <?php $__env->stopPush(); ?>
            ...
            <div class="bg-white shadow-sm sm:rounded-2xl border border-slate-200" x-data="paginationComponent()" x-init="initPagination()">
                ...
                <div class="border-b border-slate-200 bg-slate-50/50 px-6 pt-0 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div class="flex border-b border-transparent">
                        ...
                        <button @click="activeTab = 'rejected'" 
                            ...
                            <span class="px-2 py-0.5 rounded-full text-xs font-bold transition-colors"
                                ...
                                <?php echo e($reddedilenler->count()); ?>
                        ...
                        <button @click="activeTab = 'approved'" 
                            ...
                            <span class="px-2 py-0.5 rounded-full text-xs font-bold transition-colors"
                                ...
                                <?php echo e(isset($onaylananlar) ? $onaylananlar->count() : 0); ?>
                        ...
                        <button @click="activeTab = 'central'" 
                            ...
                            <span class="px-2 py-0.5 rounded-full text-xs font-bold transition-colors"
                                ...
                                <?php echo e(isset($merkezBekleyenler) ? $merkezBekleyenler->count() : 0); ?>
                        ...
                        <button @click="activeTab = 'logs'" 
                            ...
                            <span class="px-2 py-0.5 rounded-full text-xs font-bold transition-colors"
                                ...
                                <?php echo e((isset($departmentLogs) ? $departmentLogs->count() : 0) + (isset($actionLogs) ? $actionLogs->count() : 0)); ?>
                    ...
                    <div class="pb-3 md:pb-0 text-xs text-slate-500 italic">
                        Toplam <?php echo e($bekleyenler->count() + $reddedilenler->count() + (isset($merkezBekleyenler) ? $merkezBekleyenler->count() : 0)); ?> adet kayıt başvurusu yönetiliyor.
                    </div>
                </div>
                ...
                <div class="p-6 bg-white">
                    ...
                    <div id="tab-pending" x-show="activeTab === 'pending'" class="space-y-6">
                        <?php if($bekleyenler->count() > 0): ?>
                            <div class="space-y-4">
                                <?php $__currentLoopData = $bekleyenler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                                        ...
                                        <div class="flex items-start gap-4 flex-shrink-0 lg:max-w-xs">
                                            ...
                                            <div class="space-y-1">
                                                ...
                                                <p class="text-xs text-slate-500 break-all leading-none"><?php echo e($user->email); ?></p>
                                                <p class="text-[11px] text-slate-500 font-medium leading-none mt-1.5 flex items-center gap-1">
                                                    <span class="text-slate-400 font-bold uppercase tracking-wider text-[10px]">TC:</span> <?php echo e($user->tc_kimlik_no ?? 'Belirtilmemiş'); ?>
                                                ...
                                                <div class="inline-flex items-center gap-1 bg-slate-100 border border-slate-200 text-slate-600 font-semibold px-2 py-0.5 rounded-md text-[10px] uppercase tracking-wider mt-1.5">
                                                    Talep Edilen: <?php echo e($user->bolum ? $user->bolum->ad : 'Belirtilmemiş'); ?>

                                                </div>
                                                <?php if (\Illuminate\Support\Facades\Blade::check('role', 'Superadmin')): ?>
                                                    <?php if($user->bolum_id): ?>
                                                    <?php
                                                    ...
                                                    <div class="mt-2 text-[10px] text-amber-600 font-medium bg-amber-50 border border-amber-100 px-2 py-1 rounded">
                                                        ⏳ Bölüm lideri <strong><?php echo e($liderler ?: 'Atanmamış'); ?></strong>'nin <?php echo e($user->created_at ? $user->created_at->diffForHumans() : 'bir süredir'); ?> onayını bekliyor.
                                                    </div>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <form action="<?php echo e(route('admin.users.basvuru_onayla', $user->id)); ?>" method="POST" class="flex flex-col md:flex-row items-stretch md:items-end gap-3 flex-1" x-data="{ accountType: '<?php echo e($user->is_mavi_yaka ? 'mavi_yaka' : ($user->customer_id ? 'musteri' : 'personel')); ?>' }">
                                            <?php echo csrf_field(); ?>
                                            ...
                                            <div class="flex-1 min-w-[170px]" x-show="accountType !== 'musteri'">
                                                ...
                                                <?php if(Auth::user()->hasRole('Superadmin') || Auth::user()->hasRole('Yonetim')): ?>
                                                    <select name="bolum_id" class="w-full text-xs border-slate-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-shadow">
                                                        ...
                                                        <?php $__currentLoopData = $bolumler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($b->id); ?>" <?php echo e($user->bolum_id == $b->id ? 'selected' : ''); ?>>
                                                                <?php echo e($b->ad); ?>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <select disabled class="w-full text-xs border-slate-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-shadow bg-slate-50 text-slate-500">
                                                        <?php $__currentLoopData = $bolumler->where('id', Auth::user()->bolum_id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($b->id); ?>" selected>
                                                                <?php echo e($b->ad); ?>

                                                            </option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                    <input type="hidden" name="bolum_id" value="<?php echo e(Auth::user()->bolum_id); ?>">
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="flex-1 min-w-[220px] relative" x-data="{ 
                                                ...
                                                <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" class="absolute z-50 left-0 right-0 mt-1 bg-white border border-slate-200 rounded-xl shadow-lg max-h-56 overflow-y-auto custom-scrollbar p-1.5 space-y-0.5" style="display: none;">
                                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div @click="toggleRole('<?php echo e($r->name); ?>')" class="flex items-center gap-2 px-3 py-2 hover:bg-indigo-50 rounded-lg cursor-pointer transition-colors select-none text-xs">
                                                            <input type="checkbox" :checked="selectedRoles.includes('<?php echo e($r->name); ?>')" class="rounded border-slate-300 text-indigo-600 focus:ring-indigo-500 h-4 w-4 pointer-events-none transition-all">
                                                            <span class="text-slate-700 font-medium"><?php echo e($r->name); ?></span>
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-1 md:flex-initial">
                                                <button type="button" @click="$dispatch('open-reject-modal', { id: '<?php echo e($user->id); ?>', name: '<?php echo e(addslashes($user->name)); ?>' })" class="w-full inline-flex items-center justify-center gap-2 bg-rose-500 hover:bg-rose-600 active:bg-rose-700 text-white text-xs font-bold px-5 py-2.5 rounded-xl shadow-sm hover:shadow transition-all duration-150 h-[38px]">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div id="tab-rejected" x-show="activeTab === 'rejected'" class="space-y-6" style="display: none;">
                        <?php if($reddedilenler->count() > 0): ?>
                            <div class="space-y-4">
                                <?php $__currentLoopData = $reddedilenler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="flex items-start gap-4 flex-shrink-0 lg:max-w-xs">
                                            ...
                                            <div class="space-y-1">
                                                ...
                                                <div class="text-[10px] text-rose-600 font-medium flex items-center gap-1 mt-1">
                                                    ...
                                                    <span class="font-bold"><?php echo e($user->rejected_at ? $user->rejected_at->format('d.m.Y H:i') : 'Belirtilmemiş'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div id="tab-approved" x-show="activeTab === 'approved'" class="space-y-6" style="display: none;">
                        <?php if(isset($onaylananlar) && $onaylananlar->count() > 0): ?>
                            <div class="space-y-4">
                                <?php $__currentLoopData = $onaylananlar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="border border-emerald-100 rounded-2xl p-5 hover:border-emerald-200 hover:shadow-md transition-all duration-200 bg-emerald-50/10 list-item-row">
                                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                                        ...
                                        <div class="flex items-start gap-4 flex-shrink-0 lg:max-w-xs">
                                            ...
                                            <div class="space-y-1">
                                                ...
                                                <div class="text-[10px] text-emerald-600 font-medium flex items-center gap-1 mt-1">
                                                    ...
                                                    <span class="font-bold"><?php echo e($user->updated_at ? $user->updated_at->format('d.m.Y H:i') : 'Belirtilmemiş'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <?php if($canRevoke): ?>
                                            <form action="<?php echo e(route('admin.users.basvuru_gerial', $user->id)); ?>" method="POST" class="flex flex-col md:flex-row items-stretch md:items-end gap-3 flex-1 justify-end">
                                                <?php echo csrf_field(); ?>
                                                <div class="flex-shrink-0 pt-2 md:pt-0">
                                                    <button type="button" @click="$dispatch('open-gerial-modal', { id: '<?php echo e($user->id); ?>', name: '<?php echo e(addslashes($user->name)); ?>' })" class="w-full inline-flex items-center justify-center gap-2 bg-slate-600 hover:bg-slate-700 active:bg-slate-800 text-white text-xs font-bold px-6 py-2.5 rounded-xl shadow-sm hover:shadow transition-all duration-150 h-[38px]">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div id="tab-central" x-show="activeTab === 'central'" class="space-y-6" style="display: none;">
                        <?php if(isset($merkezBekleyenler) && $merkezBekleyenler->count() > 0): ?>
                            <div class="space-y-4">
                                <?php $__currentLoopData = $merkezBekleyenler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $cUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="border border-amber-200 rounded-2xl p-5 hover:border-amber-300 hover:shadow-md transition-all duration-200 bg-amber-50/30 list-item-row">
                                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                                        ...
                                        <div class="flex items-start gap-4 flex-shrink-0 lg:max-w-xs">
                                            ...
                                            <div class="space-y-1">
                                                <p class="text-sm font-bold text-slate-900 leading-snug">
                                                    <?php echo e($cUser['first_name']); ?> <?php echo e($cUser['last_name'] ?? ''); ?>

                                                    <?php if(isset($cUser['is_mavi_yaka']) && $cUser['is_mavi_yaka']): ?>
                                                        <span class="ml-2 inline-flex items-center gap-1 bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full text-[10px] font-bold border border-blue-200">
                                                            👷 Mavi Yaka
                                                        </span>
                                                    <?php endif; ?>
                                                </p>
                                                <p class="text-xs text-slate-500 break-all leading-none"><?php echo e($cUser['email']); ?></p>
                                                ...
                                                <?php if(isset($cUser['app_users']) && count($cUser['app_users']) > 0): ?>
                                                    <div class="mt-2 flex flex-wrap gap-1">
                                                        <?php $__currentLoopData = $cUser['app_users']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if(isset($appUser['application']['name'])): ?>
                                                                <span class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium bg-indigo-100 text-indigo-800 border border-indigo-200">
                                                                    <?php echo e($appUser['application']['name']); ?>
                                        ...
                                        <form action="<?php echo e(route('admin.users.merkezden_cek')); ?>" method="POST" class="flex flex-col md:flex-row items-stretch md:items-end gap-3 flex-1" x-data="{ accountType: '<?php echo e((isset($cUser['is_mavi_yaka']) && $cUser['is_mavi_yaka']) ? 'mavi_yaka' : 'personel'); ?>' }">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="email" value="<?php echo e($cUser['email']); ?>">
                                            <input type="hidden" name="first_name" value="<?php echo e($cUser['first_name']); ?>">
                                            <input type="hidden" name="last_name" value="<?php echo e($cUser['last_name'] ?? ''); ?>">
                                            <input type="hidden" name="tc_no" value="<?php echo e($cUser['tc_no'] ?? ''); ?>">
                    ...
                    <div x-show="activeTab === 'logs'" class="space-y-6" style="display: none;">
                        ...
                        <div class="mb-6">
                            ...
                            <?php if(isset($actionLogs) && $actionLogs->count() > 0): ?>
                                    ...
                                    <table class="min-w-full divide-y divide-slate-200">
                                        ...
                                        <tbody class="divide-y divide-slate-200 bg-white">
                                            ...
                                            <tr class="hover:bg-slate-50 transition-colors">
                                                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                                    <div class="flex items-center">
                                                        <div class="h-8 w-8 flex-shrink-0 rounded-full bg-slate-100 flex items-center justify-center text-slate-700 font-bold text-xs">
                                                            <?php echo e(mb_substr($log->user->name, 0, 1)); ?>

                                                        </div>
                                                        <div class="ml-3">
                                                            <div class="font-medium text-slate-900"><?php echo e($log->user->name); ?></div>
                                                            <div class="text-xs text-slate-500"><?php echo e($log->user->email); ?></div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-slate-500">
                                                    <?php echo e($log->actionBy ? $log->actionBy->name : 'Sistem'); ?>

                                                </td>
                                                <td class="px-3 py-4 text-sm text-slate-500 max-w-xs truncate" title="<?php echo e($log->details); ?>">
                                                    <?php echo e(Str::limit($log->details, 50)); ?>
                        ...
                        <?php if(isset($departmentLogs) && $departmentLogs->count() > 0): ?>
                            <div class="overflow-hidden bg-white shadow-sm ring-1 ring-slate-200 sm:rounded-2xl">
                                <table class="min-w-full divide-y divide-slate-200">
                                    <thead class="bg-slate-50">
                                        <tr>
                                    ...
                                    <tbody class="divide-y divide-slate-200 bg-white">
                                        <?php $__currentLoopData = $departmentLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-slate-50 transition-colors">
                                            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                                <div class="flex items-center">
                                            ...
                                            <td class="whitespace-nowrap px-3 py-4 text-sm text-slate-500">
                                                ...
                                                <div class="text-[10px] text-slate-400 ml-5"><?php echo e($log->created_at->diffForHumans()); ?></div>
                                            </td>
                                        </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
    ...
    >
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg mx-4" @click.away="isOpen = false">
            <form :action="'<?php echo e(url('admin/users')); ?>/' + userId + '/reddet'" method="POST">
                <?php echo csrf_field(); ?>
    ...
    <script>
                    ...
                    window.addEventListener('open-gerial-modal', (e) => {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                form.method = 'POST';
                                form.action = '<?php echo e(url("admin/users")); ?>/' + id + '/geri-al';
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const pullForms = document.querySelectorAll('form[action="<?php echo e(route('admin.users.merkezden_cek')); ?>"]');
...
<?php endif; ?>
<?php /**PATH /var/www/kys_koksan/iaa/resources/views/admin/users/bekleyen_basvurular.blade.php ENDPATH**/ ?>