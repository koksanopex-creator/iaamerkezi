<div x-show="activeTab === 'DigerCalisanlar'" x-transition:enter="transition ease-out duration-300 transform" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" style="display: none;">
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500">Bu bölümde, <?php echo e($user->customer->name ?? 'ilgili firma'); ?> firmasındaki diğer yetkilileri görebilirsiniz.</p>
    </div>

    <?php if($colleagues->isEmpty()): ?>
    ...
    <?php else: ?>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php $__currentLoopData = $colleagues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $colleague): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('profile.show', $colleague->id)); ?>" class="group">
                    <div class="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm hover:shadow-xl hover:border-indigo-100 transition-all duration-300">
                        <div class="flex items-center gap-4">
                            <div class="relative flex-shrink-0">
                                <?php if($colleague->profile_photo_path): ?>
                                    <img src="<?php echo e(asset('storage/' . $colleague->profile_photo_path)); ?>" 
                                         alt="<?php echo e($colleague->name); ?>" 
                                ...
                                <?php else: ?>
                                    <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center text-xl font-bold text-gray-400 border-2 border-gray-50 group-hover:from-indigo-50 group-hover:to-indigo-100 group-hover:text-indigo-600 transition-all uppercase">
                                        <?php echo e(substr($colleague->name, 0, 1)); ?>
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-500 mt-0.5 truncate"><?php echo e($colleague->unvan ?? 'Yetkili'); ?></p>
...
<?php /**PATH /var/www/kys_koksan/iaa/resources/views/profile/partials/show/tab-colleagues.blade.php ENDPATH**/ ?>