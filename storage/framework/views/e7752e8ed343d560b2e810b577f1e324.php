...
?>
                            ...
                            <div class="group md:col-span-2 mb-6">
                                ...
                                <?php if($onlyYurtIci || $onlyYurtDisi): ?>
                                    <input type="hidden" name="konum_tipi" value="<?php echo e($defKonumTipi); ?>">
                                <?php endif; ?>

                                <div class="mt-2 flex flex-wrap items-center gap-4 md:space-x-6">
                                    <label class="inline-flex items-center <?php echo e($onlyYurtDisi ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'); ?>">
                                        <input type="radio" name="konum_tipi" value="Yurt İçi"
                                            class="form-radio w-5 h-5 text-red-600 focus:ring-red-500" 
                                            <?php echo e($defKonumTipi == 'Yurt İçi' ? 'checked' : ''); ?> 
                                            <?php echo e(($onlyYurtIci || $onlyYurtDisi) ? 'disabled' : ''); ?>>
                                        <span class="ml-2 text-sm text-gray-700">Yurt İçi</span>
                                    </label>
                                    <label class="inline-flex items-center <?php echo e($onlyYurtIci ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'); ?>">
                                        <input type="radio" name="konum_tipi" value="Yurt Dışı"
                                            class="form-radio w-5 h-5 text-red-600 focus:ring-red-500" 
                                            <?php echo e($defKonumTipi == 'Yurt Dışı' ? 'checked' : ''); ?>
